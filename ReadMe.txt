XDev
====
XDev is a set of compilers, utilities, libraries, and design patterns for cross-platform and embedded development in different programming languages.
...
XDev/ZXDev
==========
ZXDev is a part of the project XDev. It's a subsystem of XDev for target platform Sinclair ZX Spectrum (based on CPU Z80).
...
I'm sorry, but mainly project documentation is in Russian. I hope, if you really interested in this project, it's will not be a problem. You can read it into multi-language Google translator.

I am interested in supporting other platforms in various ways, in adding new libraries, tools and compilers for these platforms. Therefore the project needs maintainers of the new platforms. Also the project XDev needs a maintainer of the project's branch in English.
