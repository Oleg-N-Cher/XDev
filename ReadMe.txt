XDev
====
XDev is open and free set of compilers, additional tools, libraries and design patterns
for cross-platform and embedded development in modular programming languages.
...
XDev/ZXDev
==========
ZXDev is a XDev subsystem for target platform Sinclair ZX Spectrum 48K (based on CPU Z80).
