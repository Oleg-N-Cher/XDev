...
/*----------------------------------------------------------------------------*/
__TDESC(KolXXSocket_TObj__desc, 6, 2) = {__TDFLDS("TObj", 24), {8, 16, -24}};
__TDESC(KolXXSocket_TBaseSocket__desc, 7, 3) = {__TDFLDS("TBaseSocket", 40), {8, 16, 32, -32}};
__TDESC(KolXXSocket_TReceive__desc, 6, 2) = {__TDFLDS("TReceive", 32), {8, 16, -24}};
__TDESC(KolXXSocket_TClient__desc, 7, 3) = {__TDFLDS("TClient", 40), {8, 16, 32, -32}};
__TDESC(KolXXSocket_TServer__desc, 6, 2) = {__TDFLDS("TServer", 24), {8, 16, -24}};
__TDESC(KolXXSocket_TAccept__desc, 6, 2) = {__TDFLDS("TAccept", 24), {8, 16, -24}};
__TDESC(KolXXSocket_TServerClient__desc, 7, 3) = {__TDFLDS("TServerClient", 40), {8, 16, 32, -32}};
