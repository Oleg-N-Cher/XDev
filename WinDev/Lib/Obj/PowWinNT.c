...
__TDESC(PowWinNT_LIST_ENTRY__desc, 1, 0) = {__TDFLDS("LIST_ENTRY", 8), {-8}};
__TDESC(PowWinNT_SINGLE_LIST_ENTRY__desc, 1, 0) = {__TDFLDS("SINGLE_LIST_ENTRY", 4), {-8}};
...
__TDESC(PowWinNT_EXCEPTION_RECORD__desc, 1, 0) = {__TDFLDS("EXCEPTION_RECORD", 24), {-8}};
__TDESC(PowWinNT_EXCEPTION_POINTERS__desc, 1, 0) = {__TDFLDS("EXCEPTION_POINTERS", 8), {-8}};
__TDESC(PowWinNT_winnt_Union0__desc, 1, 0) = {__TDFLDS("winnt_Union0", 4), {-8}};
__TDESC(PowWinNT_NT_TIB__desc, 1, 0) = {__TDFLDS("NT_TIB", 28), {-8}};
...
__TDESC(PowWinNT_SECURITY_DESCRIPTOR__desc, 1, 0) = {__TDFLDS("SECURITY_DESCRIPTOR", 20), {-8}};
...
__TDESC(PowWinNT_TOKEN_DEFAULT_DACL__desc, 1, 0) = {__TDFLDS("TOKEN_DEFAULT_DACL", 4), {-8}};
...
__TDESC(PowWinNT_IMAGE_IMPORT_DESCRIPTOR__desc, 1, 0) = {__TDFLDS("IMAGE_IMPORT_DESCRIPTOR", 20), {-8}};
...
__TDESC(PowWinNT_RTL_CRITICAL_SECTION__desc, 1, 0) = {__TDFLDS("RTL_CRITICAL_SECTION", 24), {-8}};
__TDESC(PowWinNT_RTL_CRITICAL_SECTION_DEBUG__desc, 1, 0) = {__TDFLDS("RTL_CRITICAL_SECTION_DEBUG", 32), {-8}};
