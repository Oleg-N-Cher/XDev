...
typedef
	INTEGER (__STDCALL *WinAPI_ENHMFENUMPROC)(INTEGER, WinAPI_HANDLETABLE*, SYSTEM_ADRINT *, WinAPI_ENHMETARECORD*, SYSTEM_ADRINT *, INTEGER, INTEGER);
...
typedef
	INTEGER (__STDCALL *WinAPI_FNDEVCAPS)(INTEGER, INTEGER, INTEGER, INTEGER, WinAPI_DEVMODEA*, SYSTEM_ADRINT *);

typedef
	INTEGER (__STDCALL *WinAPI_FNDEVMODE)(INTEGER, INTEGER, WinAPI_DEVMODEA*, SYSTEM_ADRINT *, INTEGER, INTEGER, WinAPI_DEVMODEA*, SYSTEM_ADRINT *, INTEGER, INTEGER);
...
typedef
	INTEGER (__STDCALL *WinAPI_MFENUMPROC)(INTEGER, WinAPI_HANDLETABLE*, SYSTEM_ADRINT *, WinAPI_METARECORD*, SYSTEM_ADRINT *, INTEGER, INTEGER);
...
typedef
	void (__STDCALL *WinAPI_MSGBOXCALLBACK)(WinAPI_HELPINFO*, SYSTEM_ADRINT *);
...
typedef
	void (__STDCALL *WinAPI_OVERLAPPED_COMPLETION_ROUTINE)(INTEGER, INTEGER, WinAPI_OVERLAPPED*, SYSTEM_ADRINT *);
...
typedef
	INTEGER (__STDCALL *WinAPI_QUERYHANDLER)(INTEGER, WinAPI_val_context*, SYSTEM_ADRINT *, INTEGER, INTEGER, INTEGER*, INTEGER);
...
typedef
	INTEGER (__STDCALL *WinAPI_TOP_LEVEL_EXCEPTION_FILTER)(WinAPI_EXCEPTION_POINTERS*, SYSTEM_ADRINT *);
...
__EXTERN INTEGER __STDCALL AngleArc(INTEGER p0, INTEGER p1, INTEGER p2, INTEGER p3, REAL p4, REAL p5);
...
__EXTERN INTEGER __STDCALL GetCharWidthFloatA(INTEGER p0, INTEGER p1, INTEGER p2, REAL *p3);
#define WinAPI_GetCharWidthFloatA(p0, p1, p2, p3)	GetCharWidthFloatA(p0, p1, p2, p3)
__EXTERN INTEGER __STDCALL GetCharWidthFloatW(INTEGER p0, INTEGER p1, INTEGER p2, REAL *p3);
...
__EXTERN INTEGER __STDCALL GetMiterLimit(INTEGER p0, REAL *p1);
...
__EXTERN INTEGER __STDCALL SetMiterLimit(INTEGER p0, REAL p1, REAL *p2);
...
#define WinAPI_SystemTimeToTzSpecificLoc__2059(lpTimeZoneInformation, lpTimeZoneInformation__typ, lpUniversalTime, lpUniversalTime__typ, lpLocalTime, lpLocalTime__typ)	SystemTimeToTzSpecificLoc__2059(lpTimeZoneInformation, lpUniversalTime, lpLocalTime)
...
__EXTERN INTEGER __STDCALL wglUseFontOutlinesA(INTEGER p0, INTEGER p1, INTEGER p2, INTEGER p3, REAL p4, REAL p5, INTEGER p6, WinAPI_GLYPHMETRICSFLOAT *p7);
#define WinAPI_wglUseFontOutlinesA(p0, p1, p2, p3, p4, p5, p6, p7, p7__typ)	wglUseFontOutlinesA(p0, p1, p2, p3, p4, p5, p6, p7)
__EXTERN INTEGER __STDCALL wglUseFontOutlinesW(INTEGER p0, INTEGER p1, INTEGER p2, INTEGER p3, REAL p4, REAL p5, INTEGER p6, WinAPI_GLYPHMETRICSFLOAT *p7);
