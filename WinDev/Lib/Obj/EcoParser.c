...
/*----------------------------------------------------------------------------*/
__TDESC(EcoParser_Tree__desc, 7, 3) = {__TDFLDS("Tree", 12), {0, 4, 8, -32}};
__TDESC(EcoParser_Parser__desc, 6, 4) = {__TDFLDS("Parser", 28), {0, 12, 16, 24, -40}};
__TDESC(EcoParser_Node__desc, 1, 2) = {__TDFLDS("Node", 20), {0, 12, -24}};
__TDESC(EcoParser_CtxNode__desc, 2, 3) = {__TDFLDS("CtxNode", 28), {0, 12, 20, -32}};
__TDESC(EcoParser_MethodNode__desc, 1, 2) = {__TDFLDS("MethodNode", 20), {0, 12, -24}};
__TDESC(EcoParser_SetCtxNode__desc, 1, 3) = {__TDFLDS("SetCtxNode", 24), {0, 12, 20, -32}};
