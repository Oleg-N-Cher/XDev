...
__EXTERN INTEGER __CALL_1 AcceptEx(INTEGER sListenSocket, INTEGER sAcceptSocket, SYSTEM_PTR lpOutputBuffer, INTEGER dwReceiveDataLength, INTEGER dwLocalAddressLength, INTEGER dwRemoteAddressLength, INTEGER *lpdwBytesReceived, WinApi_OVERLAPPED *lpOverlapped);
...
__EXTERN INTEGER __CALL_1 TransmitFile(INTEGER hSocket, SYSTEM_PTR hFile, INTEGER nNumberOfBytesToWrite, INTEGER nNumberOfBytesPerSend, WinApi_OVERLAPPED *lpOverlapped, WinNet_TRANSMIT_FILE_BUFFERS *lpTransmitBuffers, INTEGER dwReserved);
...
__EXTERN INTEGER __CALL_1 WSAAccept(INTEGER s, WinNet_sockaddr *addr, INTEGER *addrlen, WinNet_CONDITIONPROC lpfnCondition, INTEGER dwCallbackData);
...
__EXTERN INTEGER __CALL_1 WSAAsyncSelect(INTEGER s, SYSTEM_PTR hWnd, INTEGER wMsg, INTEGER lEvent);
...
__EXTERN INTEGER __CALL_1 WSAConnect(INTEGER s, WinNet_sockaddr *name, INTEGER namelen, WinNet_WSABUF *lpCallerData, WinNet_WSABUF *lpCalleeData, WinNet_QOS *lpSQOS, WinNet_QOS *lpGQOS);
...
__EXTERN INTEGER __CALL_1 WSADuplicateSocketA(INTEGER s, INTEGER dwProcessId, WinNet_WSAPROTOCOL_INFOA *lpProtocolInfo);
...
__EXTERN INTEGER __CALL_1 WSADuplicateSocketW(INTEGER s, INTEGER dwProcessId, WinNet_WSAPROTOCOL_INFOW *lpProtocolInfo);
...
__EXTERN INTEGER __CALL_1 WSAEnumNetworkEvents(INTEGER s, INTEGER hEventObject, WinNet_WSANETWORKEVENTS *lpNetworkEvents);
...
__EXTERN INTEGER __CALL_1 WSAEventSelect(INTEGER s, INTEGER hEventObject, INTEGER lNetworkEvents);
...
__EXTERN INTEGER __CALL_1 WSAGetOverlappedResult(INTEGER s, WinNet_WSAOVERLAPPED *lpOverlapped, INTEGER *lpcbTransfer, INTEGER fWait, SET *lpdwFlags);
#define WinNet_WSAGetQOSByName(s, lpQOSName, lpQOSName__typ, lpQOS, lpQOS__typ)	WSAGetQOSByName(s, lpQOSName, lpQOS)
__EXTERN INTEGER __CALL_1 WSAGetQOSByName(INTEGER s, WinNet_WSABUF *lpQOSName, WinNet_QOS *lpQOS);
#define WinNet_WSAHtonl(s, hostlong, lpnetlong)	WSAHtonl(s, hostlong, lpnetlong)
__EXTERN INTEGER __CALL_1 WSAHtonl(INTEGER s, INTEGER hostlong, INTEGER *lpnetlong);
#define WinNet_WSAHtons(s, hostshort, lpnetshort)	WSAHtons(s, hostshort, lpnetshort)
__EXTERN INTEGER __CALL_1 WSAHtons(INTEGER s, SHORTINT hostshort, SHORTINT *lpnetshort);
...
__EXTERN INTEGER __CALL_1 WSAIoctl(INTEGER s, INTEGER dwIoControlCode, SYSTEM_PTR lpvInBuffer, INTEGER cbInBuffer, SYSTEM_PTR lpvOutBuffer, INTEGER cbOutBuffer, INTEGER *lpcbBytesReturned, WinNet_WSAOVERLAPPED *lpOverlapped, WinNet_WSAOVERLAPPED_COMPLETION_ROUTINE lpCompletionRoutine);
...
__EXTERN INTEGER __CALL_1 WSAJoinLeaf(INTEGER s, WinNet_sockaddr *name, INTEGER namelen, WinNet_WSABUF *lpCallerData, WinNet_WSABUF *lpCalleeData, WinNet_QOS *lpSQOS, WinNet_QOS *lpGQOS, SET dwFlags);
#define WinNet_WSANtohl(s, netlong, lphostlong)	WSANtohl(s, netlong, lphostlong)
__EXTERN INTEGER __CALL_1 WSANtohl(INTEGER s, INTEGER netlong, INTEGER *lphostlong);
#define WinNet_WSANtohs(s, netshort, lphostshort)	WSANtohs(s, netshort, lphostshort)
__EXTERN INTEGER __CALL_1 WSANtohs(INTEGER s, SHORTINT netshort, SHORTINT *lphostshort);
...
__EXTERN INTEGER __CALL_1 WSARecv(INTEGER s, WinNet_WSABUF *lpBuffers, INTEGER dwBufferCount, INTEGER *lpNumberOfBytesRecvd, INTEGER *lpFlags, WinNet_WSAOVERLAPPED *lpOverlapped, WinNet_WSAOVERLAPPED_COMPLETION_ROUTINE lpCompletionRoutine);
...
__EXTERN INTEGER __CALL_1 WSARecvDisconnect(INTEGER s, WinNet_WSABUF *lpInboundDisconnectData);
#define WinNet_WSARecvEx(s, buf, len, flags)	WSARecvEx(s, buf, len, flags)
__EXTERN INTEGER __CALL_1 WSARecvEx(INTEGER s, SYSTEM_PTR buf, INTEGER len, SET *flags);
...
__EXTERN INTEGER __CALL_1 WSARecvFrom(INTEGER s, WinNet_WSABUF *lpBuffers, INTEGER dwBufferCount, INTEGER *lpNumberOfBytesRecvd, INTEGER *lpFlags, WinNet_sockaddr *lpFrom, INTEGER *lpFromlen, WinNet_WSAOVERLAPPED *lpOverlapped, WinNet_WSAOVERLAPPED_COMPLETION_ROUTINE lpCompletionRoutine);
...
__EXTERN INTEGER __CALL_1 WSASend(INTEGER s, WinNet_WSABUF *lpBuffers, INTEGER dwBufferCount, INTEGER *lpNumberOfBytesSent, SET dwFlags, WinNet_WSAOVERLAPPED *lpOverlapped, WinNet_WSAOVERLAPPED_COMPLETION_ROUTINE lpCompletionRoutine);
...
__EXTERN INTEGER __CALL_1 WSASendDisconnect(INTEGER s, WinNet_WSABUF *lpOutboundDisconnectData);
...
__EXTERN INTEGER __CALL_1 WSASendTo(INTEGER s, WinNet_WSABUF *lpBuffers, INTEGER dwBufferCount, INTEGER *lpNumberOfBytesSent, SET dwFlags, WinNet_sockaddr *lpTo, INTEGER iTolen, WinNet_WSAOVERLAPPED *lpOverlapped, WinNet_WSAOVERLAPPED_COMPLETION_ROUTINE lpCompletionRoutine);
...
__EXTERN INTEGER __CALL_1 WSASocketA(INTEGER af, INTEGER type, INTEGER protocol, WinNet_WSAPROTOCOL_INFOA *lpProtocolInfo, INTEGER g, SET dwFlags);
...
__EXTERN INTEGER __CALL_1 WSASocketW(INTEGER af, INTEGER type, INTEGER protocol, WinNet_WSAPROTOCOL_INFOW *lpProtocolInfo, INTEGER g, SET dwFlags);
...
__EXTERN INTEGER __CALL_1 __WSAFDIsSet(INTEGER p0, WinNet_fd_set *p1);
#define WinNet__init()	/*-noinit*/
#define WinNet_accept(s, addr, addr__typ, addrlen)	accept(s, addr, addrlen)
__EXTERN INTEGER __CALL_1 accept(INTEGER s, WinNet_sockaddr *addr, INTEGER *addrlen);
#define WinNet_bind(s, name, name__typ, namelen)	bind(s, name, namelen)
__EXTERN INTEGER __CALL_1 bind(INTEGER s, WinNet_sockaddr *name, INTEGER namelen);
#define WinNet_closesocket(s)	closesocket(s)
__EXTERN INTEGER __CALL_1 closesocket(INTEGER s);
#define WinNet_connect(s, name, name__typ, namelen)	connect(s, name, namelen)
__EXTERN INTEGER __CALL_1 connect(INTEGER s, WinNet_sockaddr *name, INTEGER namelen);
...
__EXTERN INTEGER __CALL_1 getpeername(INTEGER s, WinNet_sockaddr *name, INTEGER *namelen);
...
__EXTERN INTEGER __CALL_1 getsockname(INTEGER s, WinNet_sockaddr *name, INTEGER *namelen);
#define WinNet_getsockopt(s, level, optname, optval, optlen)	getsockopt(s, level, optname, optval, optlen)
__EXTERN INTEGER __CALL_1 getsockopt(INTEGER s, INTEGER level, INTEGER optname, SYSTEM_PTR optval, INTEGER *optlen);
...
__EXTERN INTEGER __CALL_1 ioctlsocket(INTEGER s, INTEGER cmd, INTEGER *argp);
#define WinNet_listen(s, backlog)	listen(s, backlog)
__EXTERN INTEGER __CALL_1 listen(INTEGER s, INTEGER backlog);
...
__EXTERN INTEGER __CALL_1 recv(INTEGER s, SYSTEM_PTR buf, INTEGER len, SET flags);
#define WinNet_recvfrom(s, buf, len, flags, from, from__typ, fromlen)	recvfrom(s, buf, len, flags, from, fromlen)
__EXTERN INTEGER __CALL_1 recvfrom(INTEGER s, SYSTEM_PTR buf, INTEGER len, SET flags, WinNet_sockaddr *from, INTEGER *fromlen);
...
__EXTERN INTEGER __CALL_1 send(INTEGER s, SYSTEM_PTR buf, INTEGER len, SET flags);
#define WinNet_sendto(s, buf, len, flags, to, to__typ, tolen)	sendto(s, buf, len, flags, to, tolen)
__EXTERN INTEGER __CALL_1 sendto(INTEGER s, SYSTEM_PTR buf, INTEGER len, SET flags, WinNet_sockaddr *to, INTEGER tolen);
#define WinNet_setsockopt(s, level, optname, optval, optlen)	setsockopt(s, level, optname, optval, optlen)
__EXTERN INTEGER __CALL_1 setsockopt(INTEGER s, INTEGER level, INTEGER optname, SYSTEM_PTR optval, INTEGER optlen);
#define WinNet_shutdown(s, how)	shutdown(s, how)
__EXTERN INTEGER __CALL_1 shutdown(INTEGER s, INTEGER how);
#define WinNet_socket(af, type, protocol)	socket(af, type, protocol)
__EXTERN INTEGER __CALL_1 socket(INTEGER af, INTEGER type, INTEGER protocol);
