...
typedef
	struct WinApi_EXCEPTION_RECORD {
		...
		WinApi_PtrVoid ExceptionAddress;
...
typedef
	INTEGER (__CALL_1 *WinApi_ABORTPROC)(WinApi_PtrVoid, INTEGER);
...
typedef
	struct WinApi_CBT_CREATEWNDA {
		...
		WinApi_PtrVoid hwndInsertAfter;
...
typedef
	struct WinApi_CONVINFO {
		INTEGER cb, hUser;
		WinApi_PtrVoid hConvPartner, hszSvcPartner, hszServiceReq, hszTopic, hszItem;
		INTEGER wFmt, wType;
		SET wStatus;
		INTEGER wConvst, wLastError;
		WinApi_PtrVoid hConvList;
		WinApi_CONVCONTEXT ConvCtxt;
		WinApi_PtrVoid hwnd, hwndPartner;
	} WinApi_CONVINFO;

typedef
	struct WinApi_COPYDATASTRUCT {
		INTEGER dwData, cbData;
		WinApi_PtrVoid lpData;
...
typedef
	struct WinApi_CREATESTRUCTA {
		WinApi_PtrVoid lpCreateParams, hInstance, hMenu, hwndParent;
		INTEGER cy, cx, y, x;
		SET style;
...
typedef
	INTEGER (__CALL_1 *WinApi_THREAD_START_ROUTINE)(WinApi_PtrVoid);

typedef
	struct WinApi_CREATE_PROCESS_DEBUG_INFO {
		WinApi_PtrVoid hFile, hProcess, hThread, lpBaseOfImage;
		INTEGER dwDebugInfoFileOffset, nDebugInfoSize;
		WinApi_PtrVoid lpThreadLocalBase;
		WinApi_THREAD_START_ROUTINE lpStartAddress;
		WinApi_PtrVoid lpImageName;
		SHORTINT fUnicode;
	} WinApi_CREATE_PROCESS_DEBUG_INFO;

typedef
	struct WinApi_CREATE_THREAD_DEBUG_INFO {
		WinApi_PtrVoid hThread, lpThreadLocalBase;
		WinApi_THREAD_START_ROUTINE lpStartAddress;
...
typedef
	struct WinApi_RTL_CRITICAL_SECTION {
		...
		WinApi_PtrVoid OwningThread, LockSemaphore;
		INTEGER Reserved;
...
typedef
	struct WinApi_CWPRETSTRUCT {
		WinApi_PtrVoid lResult, lParam, wParam;
		INTEGER message;
		WinApi_PtrVoid hwnd;
	} WinApi_CWPRETSTRUCT;
...
typedef
	WinApi_PtrVoid (__CALL_1 *WinApi_DLGPROC)(WinApi_PtrVoid, INTEGER, WinApi_PtrVoid, WinApi_PtrVoid);
...
typedef
	struct WinApi_DROPSTRUCT {
		WinApi_PtrVoid hwndSource, hwndSink;
		INTEGER wFmt, dwData;
		WinApi_POINT ptDrop;
...
typedef
	struct WinApi_HANDLETABLE {
		WinApi_PtrVoid objectHandle[1];
	} WinApi_HANDLETABLE;

typedef
	INTEGER (__CALL_1 *WinApi_ENHMFENUMPROC)(WinApi_PtrVoid, WinApi_HANDLETABLE*, LONGINT *, WinApi_ENHMETARECORD*, LONGINT *, INTEGER, WinApi_PtrVoid);
...
typedef
	void (__CALL_1 *WinApi_FIBER_START_ROUTINE)(WinApi_PtrVoid);
...
typedef
	INTEGER (__CALL_1 *WinApi_FNADDPROPSHEETPAGE)(WinApi_Ptr_PSP, WinApi_PtrVoid);

typedef
	INTEGER (__CALL_1 *WinApi_FNADDPROPSHEETPAGES)(WinApi_PtrVoid, WinApi_FNADDPROPSHEETPAGE, WinApi_PtrVoid);

typedef
	WinApi_PtrVoid (__CALL_1 *WinApi_FNCALLBACK)(INTEGER, INTEGER, WinApi_PtrVoid, WinApi_PtrVoid, WinApi_PtrVoid, WinApi_PtrVoid, INTEGER, INTEGER);

typedef
	INTEGER (__CALL_1 *WinApi_FNDEVCAPS)(WinApi_PtrSTR, WinApi_PtrSTR, INTEGER, WinApi_PtrSTR, WinApi_DEVMODEA*, LONGINT *);

typedef
	INTEGER (__CALL_1 *WinApi_FNDEVMODE)(WinApi_PtrVoid, WinApi_PtrVoid, WinApi_DEVMODEA*, LONGINT *, WinApi_PtrSTR, WinApi_PtrSTR, WinApi_DEVMODEA*, LONGINT *, WinApi_PtrSTR, INTEGER);

typedef
	INTEGER (__CALL_1 *WinApi_FNPROPSHEETCALLBACK)(WinApi_PtrVoid, INTEGER, WinApi_PtrVoid);

typedef
	INTEGER (__CALL_1 *WinApi_FNPSPCALLBACKA)(WinApi_PtrVoid, INTEGER, WinApi_PtrPROPSHEETPAGEA);

typedef
	INTEGER (__CALL_1 *WinApi_FNPSPCALLBACKW)(WinApi_PtrVoid, INTEGER, WinApi_PtrPROPSHEETPAGEW);
...
typedef
	INTEGER (__CALL_1 *WinApi_FONTENUMPROC)(WinApi_PtrVoid, WinApi_PtrVoid, INTEGER, WinApi_PtrVoid);

typedef
	INTEGER (__CALL_1 *WinApi_FONTENUMPROCA)(WinApi_PtrVoid, WinApi_PtrVoid, INTEGER, WinApi_PtrVoid);

typedef
	INTEGER (__CALL_1 *WinApi_FONTENUMPROCEX)(WinApi_PtrVoid, WinApi_PtrVoid, INTEGER, WinApi_PtrVoid);

typedef
	INTEGER (__CALL_1 *WinApi_FONTENUMPROCEXA)(WinApi_PtrVoid, WinApi_PtrVoid, INTEGER, WinApi_PtrVoid);

typedef
	INTEGER (__CALL_1 *WinApi_FONTENUMPROCEXW)(WinApi_PtrVoid, WinApi_PtrVoid, INTEGER, WinApi_PtrVoid);

typedef
	INTEGER (__CALL_1 *WinApi_FONTENUMPROCW)(WinApi_PtrVoid, WinApi_PtrVoid, INTEGER, WinApi_PtrVoid);
...
typedef
	struct WinApi_HSZPAIR {
		WinApi_PtrVoid hszSvc, hszTopic;
	} WinApi_HSZPAIR;
...
typedef
	INTEGER (__CALL_1 *WinApi_ICMENUMPROCA)(WinApi_PtrSTR, WinApi_PtrVoid);

typedef
	INTEGER (__CALL_1 *WinApi_ICMENUMPROCW)(WinApi_PtrWSTR, WinApi_PtrVoid);

typedef
	struct WinApi_ICONINFO {
		INTEGER fIcon, xHotspot, yHotspot;
		WinApi_PtrVoid hbmMask, hbmColor;
	} WinApi_ICONINFO;
...
typedef
	struct WinApi_IMAGE_LOAD_CONFIG_DIRECTORY {
		...
		WinApi_PtrVoid LockPrefixTable;
...
typedef
	struct WinApi_IMAGE_RUNTIME_FUNCTION_ENTRY {
		...
		WinApi_PtrVoid ExceptionHandler, HandlerData;
...
typedef
	void (__CALL_1 *WinApi_IMAGE_TLS_CALLBACK)(WinApi_PtrVoid, INTEGER, WinApi_PtrVoid);
...
typedef
	struct WinApi_JOB_INFO_2A {
		...
		WinApi_PtrVoid pSecurityDescriptor;
		SET Status;
...
typedef
	struct WinApi_LOAD_DLL_DEBUG_INFO {
		WinApi_PtrVoid hFile, lpBaseOfDll;
		INTEGER dwDebugInfoFileOffset, nDebugInfoSize;
		WinApi_PtrVoid lpImageName;
		SHORTINT fUnicode;
...
typedef
	struct WinApi_MDINEXTMENU {
		WinApi_PtrVoid hmenuIn, hmenuNext, hwndNext;
	} WinApi_MDINEXTMENU;
...
typedef
	struct WinApi_MEMORY_BASIC_INFORMATION {
		WinApi_PtrVoid BaseAddress, AllocationBase;
...
typedef
	struct WinApi_MENUITEMINFOA {
		...
		INTEGER wID;
		WinApi_PtrVoid hSubMenu, hbmpChecked, hbmpUnchecked;
		INTEGER dwItemData;
...
typedef
	INTEGER (__CALL_1 *WinApi_MFENUMPROC)(WinApi_PtrVoid, WinApi_HANDLETABLE*, LONGINT *, WinApi_METARECORD*, LONGINT *, INTEGER, WinApi_PtrVoid);
...
typedef
	struct WinApi_MONCBSTRUCT {
		INTEGER cb, dwTime;
		WinApi_PtrVoid hTask;
		INTEGER dwRet, wType, wFmt;
		WinApi_PtrVoid hConv, hsz1, hsz2, hData;
...
typedef
	struct WinApi_MONCONVSTRUCT {
		...
		WinApi_PtrVoid hTask, hszSvc, hszTopic, hConvClient, hConvServer;
...
typedef
	struct WinApi_MONLINKSTRUCT {
		...
		WinApi_PtrVoid hszSvc, hszTopic, hszItem;
		INTEGER wFmt, fServer;
		WinApi_PtrVoid hConvServer, hConvClient;
	} WinApi_MONLINKSTRUCT;

typedef
	struct WinApi_MONMSGSTRUCT {
		INTEGER cb;
		WinApi_PtrVoid hwndTo;
		INTEGER dwTime;
		WinApi_PtrVoid hTask;
		INTEGER wMsg;
		WinApi_PtrVoid wParam, lParam;
...
typedef
	struct WinApi_MSGBOXPARAMSA {
		INTEGER cbSize;
		WinApi_PtrVoid hwndOwner, hInstance;
...
typedef
	INTEGER (__CALL_1 *WinApi_NEWFONTENUMPROC)(WinApi_PtrVoid, WinApi_PtrVoid, INTEGER, WinApi_PtrVoid);

typedef
	INTEGER (__CALL_1 *WinApi_NEWFONTENUMPROCA)(WinApi_PtrVoid, WinApi_PtrVoid, INTEGER, WinApi_PtrVoid);

typedef
	INTEGER (__CALL_1 *WinApi_NEWFONTENUMPROCW)(WinApi_PtrVoid, WinApi_PtrVoid, INTEGER, WinApi_PtrVoid);
...
typedef
	struct WinApi_NT_TIB {
		...
		WinApi_PtrVoid StackBase, StackLimit, SubSystemTib;
		struct WinApi__20 u;
		WinApi_PtrVoid ArbitraryUserPointer;
...
typedef
	struct WinApi_PROCESS_INFORMATION {
		WinApi_PtrVoid hProcess, hThread;
		INTEGER dwProcessId, dwThreadId;
	} WinApi_PROCESS_INFORMATION;

typedef
	INTEGER (__CALL_1 *WinApi_PROGRESS_ROUTINE)(LONGINT, LONGINT, LONGINT, LONGINT, INTEGER, INTEGER, WinApi_PtrVoid, WinApi_PtrVoid, WinApi_PtrVoid);

typedef
	struct WinApi_PROPSHEETHEADERA {
		INTEGER dwSize;
		SET dwFlags;
		WinApi_PtrVoid hwndParent, hInstance;
		struct WinApi__25 u;
...
typedef
	struct WinApi_PVALUEA {
		...
		INTEGER pv_valuelen;
		WinApi_PtrVoid pv_value_context;
		INTEGER pv_type;
	} WinApi_PVALUEA;
...
typedef
	struct WinApi_val_context {
		INTEGER valuelen;
		WinApi_PtrVoid value_context, val_buff_ptr;
	} WinApi_val_context;

typedef
	INTEGER (__CALL_1 *WinApi_QUERYHANDLER)(WinApi_PtrVoid, WinApi_val_context*, LONGINT *, INTEGER, WinApi_PtrVoid, INTEGER*, INTEGER);
...
typedef
	struct WinApi_SHELLEXECUTEINFOA {
		...
		INTEGER nShow;
		WinApi_PtrVoid hInstApp, lpIDList;
		WinApi_PtrSTR lpClass;
		WinApi_PtrVoid hkeyClass;
		INTEGER dwHotKey;
		WinApi_PtrVoid hIcon, hProcess;
...
typedef
	struct WinApi_STARTUPINFOA {
		...
		WinApi_PtrVoid hStdInput, hStdOutput, hStdError;
	} WinApi_STARTUPINFOA;
...
typedef
	struct WinApi_SYSTEM_INFO {
		struct WinApi__35 u;
		INTEGER dwPageSize;
		WinApi_PtrVoid lpMinimumApplicationAddress, lpMaximumApplicationAddress;
...
typedef
	void (__CALL_1 *WinApi_TIMERAPCROUTINE)(WinApi_PtrVoid, INTEGER, INTEGER);
...
typedef
	struct WinApi_TOKEN_OWNER {
		WinApi_PtrVoid Owner;
	} WinApi_TOKEN_OWNER;

typedef
	struct WinApi_TOKEN_PRIMARY_GROUP {
		WinApi_PtrVoid PrimaryGroup;
...
typedef
	struct WinApi_WINDOWPOS {
		WinApi_PtrVoid hwnd, hwndInsertAfter;
		INTEGER x, y, cx, cy;
		SET flags;
	} WinApi_WINDOWPOS;
...
typedef
	struct WinApi_WIN_TRUST_SUBJECT_FILE {
		WinApi_PtrVoid hFile;
		WinApi_PtrWSTR lpPath;
	} WinApi_WIN_TRUST_SUBJECT_FILE;

typedef
	WinApi_PtrVoid (__CALL_1 *WinApi_WNDPROC)(WinApi_PtrVoid, INTEGER, WinApi_PtrVoid, WinApi_PtrVoid);
...
typedef
	struct WinApi_WNDCLASSA {
		...
		WinApi_PtrVoid hInstance, hIcon, hCursor, hbrBackground;
...
__EXTERN INTEGER __CALL_1 AbortDoc(WinApi_PtrVoid p0);
#define WinApi_AbortPath(p0)	AbortPath(p0)
__EXTERN INTEGER __CALL_1 AbortPath(WinApi_PtrVoid p0);
#define WinApi_AbortPrinter(hPrinter)	AbortPrinter(hPrinter)
__EXTERN INTEGER __CALL_1 AbortPrinter(WinApi_PtrVoid hPrinter);
...
__EXTERN INTEGER __CALL_1 AccessCheck(WinApi_PtrVoid pSecurityDescriptor, WinApi_PtrVoid ClientToken, SET DesiredAccess, WinApi_GENERIC_MAPPING *GenericMapping, WinApi_PRIVILEGE_SET *PrivilegeSet, INTEGER *PrivilegeSetLength, INTEGER *GrantedAccess, INTEGER *AccessStatus);
...
__EXTERN INTEGER __CALL_1 AccessCheckAndAuditAlarmA(WinApi_PtrSTR SubsystemName, WinApi_PtrVoid HandleId, WinApi_PtrSTR ObjectTypeName, WinApi_PtrSTR ObjectName, WinApi_PtrVoid SecurityDescriptor, SET DesiredAccess, WinApi_GENERIC_MAPPING *GenericMapping, INTEGER ObjectCreation, INTEGER *GrantedAccess, INTEGER *AccessStatus, INTEGER *pfGenerateOnClose);
...
__EXTERN INTEGER __CALL_1 AccessCheckAndAuditAlarmW(WinApi_PtrWSTR SubsystemName, WinApi_PtrVoid HandleId, WinApi_PtrWSTR ObjectTypeName, WinApi_PtrWSTR ObjectName, WinApi_PtrVoid SecurityDescriptor, SET DesiredAccess, WinApi_GENERIC_MAPPING *GenericMapping, INTEGER ObjectCreation, INTEGER *GrantedAccess, INTEGER *AccessStatus, INTEGER *pfGenerateOnClose);
#define WinApi_ActivateKeyboardLayout(hkl, Flags)	ActivateKeyboardLayout(hkl, Flags)
__EXTERN WinApi_PtrVoid __CALL_1 ActivateKeyboardLayout(WinApi_PtrVoid hkl, SET Flags);
...
__EXTERN INTEGER __CALL_1 AddAccessAllowedAce(WinApi_ACL *pAcl, INTEGER dwAceRevision, INTEGER AccessMask, WinApi_PtrVoid pSid);
...
__EXTERN INTEGER __CALL_1 AddAccessDeniedAce(WinApi_ACL *pAcl, INTEGER dwAceRevision, INTEGER AccessMask, WinApi_PtrVoid pSid);
...
__EXTERN INTEGER __CALL_1 AddAce(WinApi_ACL *pAcl, INTEGER dwAceRevision, INTEGER dwStartingAceIndex, WinApi_PtrVoid pAceList, INTEGER nAceListLength);
...
__EXTERN INTEGER __CALL_1 AddAuditAccessAce(WinApi_ACL *pAcl, INTEGER dwAceRevision, INTEGER dwAccessMask, WinApi_PtrVoid pSid, INTEGER bAuditSuccess, INTEGER bAuditFailure);
...
__EXTERN INTEGER __CALL_1 AddFormA(WinApi_PtrVoid hPrinter, INTEGER Level, CHAR *pForm);
#define WinApi_AddFormW(hPrinter, Level, pForm)	AddFormW(hPrinter, Level, pForm)
__EXTERN INTEGER __CALL_1 AddFormW(WinApi_PtrVoid hPrinter, INTEGER Level, CHAR *pForm);
...
__EXTERN INTEGER __CALL_1 AddJobA(WinApi_PtrVoid hPrinter, INTEGER Level, CHAR *pData, INTEGER cbBuf, INTEGER *pcbNeeded);
#define WinApi_AddJobW(hPrinter, Level, pData, cbBuf, pcbNeeded)	AddJobW(hPrinter, Level, pData, cbBuf, pcbNeeded)
__EXTERN INTEGER __CALL_1 AddJobW(WinApi_PtrVoid hPrinter, INTEGER Level, CHAR *pData, INTEGER cbBuf, INTEGER *pcbNeeded);
...
__EXTERN INTEGER __CALL_1 AddPortA(WinApi_PtrSTR pName, WinApi_PtrVoid hWnd, WinApi_PtrSTR pMonitorName);
#define WinApi_AddPortW(pName, hWnd, pMonitorName)	AddPortW(pName, hWnd, pMonitorName)
__EXTERN INTEGER __CALL_1 AddPortW(WinApi_PtrWSTR pName, WinApi_PtrVoid hWnd, WinApi_PtrWSTR pMonitorName);
...
__EXTERN WinApi_PtrVoid __CALL_1 AddPrinterA(WinApi_PtrSTR pName, INTEGER Level, CHAR *pPrinter);
...
__EXTERN WinApi_PtrVoid __CALL_1 AddPrinterW(WinApi_PtrWSTR pName, INTEGER Level, CHAR *pPrinter);
...
__EXTERN INTEGER __CALL_1 AdjustTokenGroups(WinApi_PtrVoid TokenHandle, INTEGER ResetToDefault, WinApi_TOKEN_GROUPS *NewState, INTEGER BufferLength, WinApi_TOKEN_GROUPS *PreviousState, INTEGER *ReturnLength);
...
__EXTERN INTEGER __CALL_1 AdjustTokenPrivileges(WinApi_PtrVoid TokenHandle, INTEGER DisableAllPrivileges, WinApi_TOKEN_PRIVILEGES *NewState, INTEGER BufferLength, WinApi_TOKEN_PRIVILEGES *PreviousState, INTEGER *ReturnLength);
...
__EXTERN INTEGER __CALL_1 AdvancedDocumentPropertiesA(WinApi_PtrVoid hWnd, WinApi_PtrVoid hPrinter, WinApi_PtrSTR pDeviceName, WinApi_DEVMODEA *pDevModeOutput, WinApi_DEVMODEA *pDevModeInput);
...
__EXTERN INTEGER __CALL_1 AdvancedDocumentPropertiesW(WinApi_PtrVoid hWnd, WinApi_PtrVoid hPrinter, WinApi_PtrWSTR pDeviceName, WinApi_DEVMODEW *pDevModeOutput, WinApi_DEVMODEW *pDevModeInput);
...
__EXTERN INTEGER __CALL_1 AngleArc(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, REAL p4, REAL p5);
#define WinApi_AnimatePalette(p0, p1, p2, p3, p3__typ)	AnimatePalette(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 AnimatePalette(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_PALETTEENTRY *p3);
...
__EXTERN INTEGER __CALL_1 AppendMenuA(WinApi_PtrVoid hMenu, SET uFlags, INTEGER uIDNewItem, WinApi_PtrSTR lpNewItem);
#define WinApi_AppendMenuW(hMenu, uFlags, uIDNewItem, lpNewItem)	AppendMenuW(hMenu, uFlags, uIDNewItem, lpNewItem)
__EXTERN INTEGER __CALL_1 AppendMenuW(WinApi_PtrVoid hMenu, SET uFlags, INTEGER uIDNewItem, WinApi_PtrWSTR lpNewItem);
#define WinApi_Arc(p0, p1, p2, p3, p4, p5, p6, p7, p8)	Arc(p0, p1, p2, p3, p4, p5, p6, p7, p8)
__EXTERN INTEGER __CALL_1 Arc(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4, INTEGER p5, INTEGER p6, INTEGER p7, INTEGER p8);
#define WinApi_ArcTo(p0, p1, p2, p3, p4, p5, p6, p7, p8)	ArcTo(p0, p1, p2, p3, p4, p5, p6, p7, p8)
__EXTERN INTEGER __CALL_1 ArcTo(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4, INTEGER p5, INTEGER p6, INTEGER p7, INTEGER p8);
...
__EXTERN INTEGER __CALL_1 ArrangeIconicWindows(WinApi_PtrVoid hWnd);
...
__EXTERN INTEGER __CALL_1 BackupEventLogA(WinApi_PtrVoid hEventLog, WinApi_PtrSTR lpBackupFileName);
#define WinApi_BackupEventLogW(hEventLog, lpBackupFileName)	BackupEventLogW(hEventLog, lpBackupFileName)
__EXTERN INTEGER __CALL_1 BackupEventLogW(WinApi_PtrVoid hEventLog, WinApi_PtrWSTR lpBackupFileName);
...
__EXTERN INTEGER __CALL_1 BackupRead(WinApi_PtrVoid hFile, CHAR *lpBuffer, INTEGER nNumberOfBytesToRead, INTEGER *lpNumberOfBytesRead, INTEGER bAbort, INTEGER bProcessSecurity, struct {
	LONGINT len[1];
	WinApi_PtrVoid data[1];
} *lpContext);
...
__EXTERN INTEGER __CALL_1 BackupSeek(WinApi_PtrVoid hFile, INTEGER dwLowBytesToSeek, INTEGER dwHighBytesToSeek, INTEGER *lpdwLowByteSeeked, INTEGER *lpdwHighByteSeeked, struct {
	LONGINT len[1];
	WinApi_PtrVoid data[1];
} *lpContext);
...
__EXTERN INTEGER __CALL_1 BackupWrite(WinApi_PtrVoid hFile, CHAR *lpBuffer, INTEGER nNumberOfBytesToWrite, INTEGER *lpNumberOfBytesWritten, INTEGER bAbort, INTEGER bProcessSecurity, struct {
	LONGINT len[1];
	WinApi_PtrVoid data[1];
} *lpContext);
...
__EXTERN WinApi_PtrVoid __CALL_1 BeginDeferWindowPos(INTEGER nNumWindows);
#define WinApi_BeginPaint(hWnd, lpPaint, lpPaint__typ)	BeginPaint(hWnd, lpPaint)
__EXTERN WinApi_PtrVoid __CALL_1 BeginPaint(WinApi_PtrVoid hWnd, WinApi_PAINTSTRUCT *lpPaint);
#define WinApi_BeginPath(p0)	BeginPath(p0)
__EXTERN INTEGER __CALL_1 BeginPath(WinApi_PtrVoid p0);
...
__EXTERN WinApi_PtrVoid __CALL_1 BeginUpdateResourceA(WinApi_PtrSTR pFileName, INTEGER bDeleteExistingResources);
...
__EXTERN WinApi_PtrVoid __CALL_1 BeginUpdateResourceW(WinApi_PtrWSTR pFileName, INTEGER bDeleteExistingResources);
#define WinApi_BitBlt(p0, p1, p2, p3, p4, p5, p6, p7, p8)	BitBlt(p0, p1, p2, p3, p4, p5, p6, p7, p8)
__EXTERN INTEGER __CALL_1 BitBlt(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4, WinApi_PtrVoid p5, INTEGER p6, INTEGER p7, INTEGER p8);
#define WinApi_BringWindowToTop(hWnd)	BringWindowToTop(hWnd)
__EXTERN INTEGER __CALL_1 BringWindowToTop(WinApi_PtrVoid hWnd);
...
__EXTERN INTEGER __CALL_1 BroadcastSystemMessageA(SET p0, SET *p1, INTEGER p2, WinApi_PtrVoid p3, WinApi_PtrVoid p4);
#define WinApi_BroadcastSystemMessageW(p0, p1, p2, p3, p4)	BroadcastSystemMessageW(p0, p1, p2, p3, p4)
__EXTERN INTEGER __CALL_1 BroadcastSystemMessageW(SET p0, SET *p1, INTEGER p2, WinApi_PtrVoid p3, WinApi_PtrVoid p4);
...
__EXTERN INTEGER __CALL_1 CallNamedPipeA(WinApi_PtrSTR lpNamedPipeName, WinApi_PtrVoid lpInBuffer, INTEGER nInBufferSize, WinApi_PtrVoid lpOutBuffer, INTEGER nOutBufferSize, INTEGER *lpBytesRead, INTEGER nTimeOut);
...
__EXTERN INTEGER __CALL_1 CallNamedPipeW(WinApi_PtrWSTR lpNamedPipeName, WinApi_PtrVoid lpInBuffer, INTEGER nInBufferSize, WinApi_PtrVoid lpOutBuffer, INTEGER nOutBufferSize, INTEGER *lpBytesRead, INTEGER nTimeOut);
#define WinApi_CallNextHookEx(hhk, nCode, wParam, lParam)	CallNextHookEx(hhk, nCode, wParam, lParam)
__EXTERN WinApi_PtrVoid __CALL_1 CallNextHookEx(WinApi_PtrVoid hhk, INTEGER nCode, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
...
__EXTERN WinApi_PtrVoid __CALL_1 CallWindowProcA(WinApi_FARPROC lpPrevWndFunc, WinApi_PtrVoid hWnd, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
#define WinApi_CallWindowProcW(lpPrevWndFunc, hWnd, Msg, wParam, lParam)	CallWindowProcW(lpPrevWndFunc, hWnd, Msg, wParam, lParam)
__EXTERN WinApi_PtrVoid __CALL_1 CallWindowProcW(WinApi_FARPROC lpPrevWndFunc, WinApi_PtrVoid hWnd, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
#define WinApi_CancelDC(p0)	CancelDC(p0)
__EXTERN INTEGER __CALL_1 CancelDC(WinApi_PtrVoid p0);
#define WinApi_CancelWaitableTimer(hTimer)	CancelWaitableTimer(hTimer)
__EXTERN INTEGER __CALL_1 CancelWaitableTimer(WinApi_PtrVoid hTimer);
...
__EXTERN SHORTINT __CALL_1 CascadeWindows(WinApi_PtrVoid hwndParent, INTEGER wHow, WinApi_RECT *lpRect, INTEGER cKids, WinApi_PtrVoid *lpKids);
#define WinApi_ChangeClipboardChain(hWndRemove, hWndNewNext)	ChangeClipboardChain(hWndRemove, hWndNewNext)
__EXTERN INTEGER __CALL_1 ChangeClipboardChain(WinApi_PtrVoid hWndRemove, WinApi_PtrVoid hWndNewNext);
...
__EXTERN INTEGER __CALL_1 ChangeMenuA(WinApi_PtrVoid hMenu, INTEGER cmd, WinApi_PtrSTR lpszNewItem, INTEGER cmdInsert, SET flags);
#define WinApi_ChangeMenuW(hMenu, cmd, lpszNewItem, cmdInsert, flags)	ChangeMenuW(hMenu, cmd, lpszNewItem, cmdInsert, flags)
__EXTERN INTEGER __CALL_1 ChangeMenuW(WinApi_PtrVoid hMenu, INTEGER cmd, WinApi_PtrWSTR lpszNewItem, INTEGER cmdInsert, SET flags);
...
__EXTERN INTEGER __CALL_1 ChangeServiceConfigW(WinApi_PtrVoid hService, SET dwServiceType, INTEGER dwStartType, INTEGER dwErrorControl, WinApi_PtrWSTR lpBinaryPathName, WinApi_PtrWSTR lpLoadOrderGroup, INTEGER *lpdwTagId, WinApi_PtrWSTR lpDependencies, WinApi_PtrWSTR lpServiceStartName, WinApi_PtrWSTR lpPassword, WinApi_PtrWSTR lpDisplayName);
...
__EXTERN INTEGER __CALL_1 CheckColorsInGamut(WinApi_PtrVoid p0, WinApi_PtrVoid p1, WinApi_PtrVoid p2, INTEGER p3);
#define WinApi_CheckDlgButton(hDlg, nIDButton, uCheck)	CheckDlgButton(hDlg, nIDButton, uCheck)
__EXTERN INTEGER __CALL_1 CheckDlgButton(WinApi_PtrVoid hDlg, INTEGER nIDButton, SET uCheck);
#define WinApi_CheckMenuItem(hMenu, uIDCheckItem, uCheck)	CheckMenuItem(hMenu, uIDCheckItem, uCheck)
__EXTERN INTEGER __CALL_1 CheckMenuItem(WinApi_PtrVoid hMenu, INTEGER uIDCheckItem, SET uCheck);
#define WinApi_CheckMenuRadioItem(p0, p1, p2, p3, p4)	CheckMenuRadioItem(p0, p1, p2, p3, p4)
__EXTERN INTEGER __CALL_1 CheckMenuRadioItem(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4);
...
__EXTERN INTEGER __CALL_1 CheckRadioButton(WinApi_PtrVoid hDlg, INTEGER nIDFirstButton, INTEGER nIDLastButton, INTEGER nIDCheckButton);
#define WinApi_ChildWindowFromPoint(hWndParent, Point)	ChildWindowFromPoint(hWndParent, Point)
__EXTERN WinApi_PtrVoid __CALL_1 ChildWindowFromPoint(WinApi_PtrVoid hWndParent, WinApi_POINT Point);
#define WinApi_ChildWindowFromPointEx(p0, p1, p2)	ChildWindowFromPointEx(p0, p1, p2)
__EXTERN WinApi_PtrVoid __CALL_1 ChildWindowFromPointEx(WinApi_PtrVoid p0, WinApi_POINT p1, SET p2);
#define WinApi_ChoosePixelFormat(p0, p1, p1__typ)	ChoosePixelFormat(p0, p1)
__EXTERN INTEGER __CALL_1 ChoosePixelFormat(WinApi_PtrVoid p0, WinApi_PIXELFORMATDESCRIPTOR *p1);
#define WinApi_Chord(p0, p1, p2, p3, p4, p5, p6, p7, p8)	Chord(p0, p1, p2, p3, p4, p5, p6, p7, p8)
__EXTERN INTEGER __CALL_1 Chord(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4, INTEGER p5, INTEGER p6, INTEGER p7, INTEGER p8);
#define WinApi_ClearCommBreak(hFile)	ClearCommBreak(hFile)
__EXTERN INTEGER __CALL_1 ClearCommBreak(WinApi_PtrVoid hFile);
#define WinApi_ClearCommError(hFile, lpErrors, lpStat, lpStat__typ)	ClearCommError(hFile, lpErrors, lpStat)
__EXTERN INTEGER __CALL_1 ClearCommError(WinApi_PtrVoid hFile, SET *lpErrors, WinApi_COMSTAT *lpStat);
...
__EXTERN INTEGER __CALL_1 ClearEventLogA(WinApi_PtrVoid hEventLog, WinApi_PtrSTR lpBackupFileName);
#define WinApi_ClearEventLogW(hEventLog, lpBackupFileName)	ClearEventLogW(hEventLog, lpBackupFileName)
__EXTERN INTEGER __CALL_1 ClearEventLogW(WinApi_PtrVoid hEventLog, WinApi_PtrWSTR lpBackupFileName);
#define WinApi_ClientToScreen(hWnd, lpPoint, lpPoint__typ)	ClientToScreen(hWnd, lpPoint)
__EXTERN INTEGER __CALL_1 ClientToScreen(WinApi_PtrVoid hWnd, WinApi_POINT *lpPoint);
...
__EXTERN INTEGER __CALL_1 CloseDesktop(WinApi_PtrVoid hDesktop);
#define WinApi_CloseEnhMetaFile(p0)	CloseEnhMetaFile(p0)
__EXTERN WinApi_PtrVoid __CALL_1 CloseEnhMetaFile(WinApi_PtrVoid p0);
#define WinApi_CloseEventLog(hEventLog)	CloseEventLog(hEventLog)
__EXTERN INTEGER __CALL_1 CloseEventLog(WinApi_PtrVoid hEventLog);
#define WinApi_CloseFigure(p0)	CloseFigure(p0)
__EXTERN INTEGER __CALL_1 CloseFigure(WinApi_PtrVoid p0);
...
__EXTERN WinApi_PtrVoid __CALL_1 CloseMetaFile(WinApi_PtrVoid p0);
#define WinApi_ClosePrinter(hPrinter)	ClosePrinter(hPrinter)
__EXTERN INTEGER __CALL_1 ClosePrinter(WinApi_PtrVoid hPrinter);
#define WinApi_CloseServiceHandle(hSCObject)	CloseServiceHandle(hSCObject)
__EXTERN INTEGER __CALL_1 CloseServiceHandle(WinApi_PtrVoid hSCObject);
#define WinApi_CloseWindow(hWnd)	CloseWindow(hWnd)
__EXTERN INTEGER __CALL_1 CloseWindow(WinApi_PtrVoid hWnd);
#define WinApi_CloseWindowStation(hWinSta)	CloseWindowStation(hWinSta)
__EXTERN INTEGER __CALL_1 CloseWindowStation(WinApi_PtrVoid hWinSta);
...
__EXTERN INTEGER __CALL_1 ColorMatchToTarget(WinApi_PtrVoid p0, WinApi_PtrVoid p1, INTEGER p2);
#define WinApi_CombineRgn(p0, p1, p2, p3)	CombineRgn(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 CombineRgn(WinApi_PtrVoid p0, WinApi_PtrVoid p1, WinApi_PtrVoid p2, INTEGER p3);
...
__EXTERN INTEGER __CALL_1 CommConfigDialogA(WinApi_PtrSTR lpszName, WinApi_PtrVoid hWnd, WinApi_COMMCONFIG *lpCC);
#define WinApi_CommConfigDialogW(lpszName, hWnd, lpCC, lpCC__typ)	CommConfigDialogW(lpszName, hWnd, lpCC)
__EXTERN INTEGER __CALL_1 CommConfigDialogW(WinApi_PtrWSTR lpszName, WinApi_PtrVoid hWnd, WinApi_COMMCONFIG *lpCC);
...
__EXTERN INTEGER __CALL_1 ConfigurePortA(WinApi_PtrSTR pName, WinApi_PtrVoid hWnd, WinApi_PtrSTR pPortName);
#define WinApi_ConfigurePortW(pName, hWnd, pPortName)	ConfigurePortW(pName, hWnd, pPortName)
__EXTERN INTEGER __CALL_1 ConfigurePortW(WinApi_PtrWSTR pName, WinApi_PtrVoid hWnd, WinApi_PtrWSTR pPortName);
#define WinApi_ConnectNamedPipe(hNamedPipe, lpOverlapped, lpOverlapped__typ)	ConnectNamedPipe(hNamedPipe, lpOverlapped)
__EXTERN INTEGER __CALL_1 ConnectNamedPipe(WinApi_PtrVoid hNamedPipe, WinApi_OVERLAPPED *lpOverlapped);
#define WinApi_ConnectToPrinterDlg(hwnd, Flags)	ConnectToPrinterDlg(hwnd, Flags)
__EXTERN WinApi_PtrVoid __CALL_1 ConnectToPrinterDlg(WinApi_PtrVoid hwnd, SET Flags);
...
__EXTERN INTEGER __CALL_1 ControlService(WinApi_PtrVoid hService, INTEGER dwControl, WinApi_SERVICE_STATUS *lpServiceStatus);
...
__EXTERN WinApi_PtrVoid __CALL_1 ConvertThreadToFiber(WinApi_PtrVoid lpParameter);
...
__EXTERN INTEGER __CALL_1 CopyAcceleratorTableA(WinApi_PtrVoid hAccelSrc, WinApi_ACCEL *lpAccelDst, INTEGER cAccelEntries);
...
__EXTERN INTEGER __CALL_1 CopyAcceleratorTableW(WinApi_PtrVoid hAccelSrc, WinApi_ACCEL *lpAccelDst, INTEGER cAccelEntries);
#define WinApi_CopyEnhMetaFile(p0, p1)	CopyEnhMetaFileA(p0, p1)
#define WinApi_CopyEnhMetaFileA(p0, p1)	CopyEnhMetaFileA(p0, p1)
__EXTERN WinApi_PtrVoid __CALL_1 CopyEnhMetaFileA(WinApi_PtrVoid p0, WinApi_PtrSTR p1);
#define WinApi_CopyEnhMetaFileW(p0, p1)	CopyEnhMetaFileW(p0, p1)
__EXTERN WinApi_PtrVoid __CALL_1 CopyEnhMetaFileW(WinApi_PtrVoid p0, WinApi_PtrWSTR p1);
...
__EXTERN INTEGER __CALL_1 CopyFileExA(WinApi_PtrSTR lpExistingFileName, WinApi_PtrSTR lpNewFileName, WinApi_PROGRESS_ROUTINE lpProgressRoutine, WinApi_PtrVoid lpData, INTEGER *pbCancel, INTEGER dwCopyFlags);
...
__EXTERN INTEGER __CALL_1 CopyFileExW(WinApi_PtrWSTR lpExistingFileName, WinApi_PtrWSTR lpNewFileName, WinApi_PROGRESS_ROUTINE lpProgressRoutine, WinApi_PtrVoid lpData, INTEGER *pbCancel, INTEGER dwCopyFlags);
...
__EXTERN WinApi_PtrVoid __CALL_1 CopyIcon(WinApi_PtrVoid hIcon);
#define WinApi_CopyImage(p0, p1, p2, p3, p4)	CopyImage(p0, p1, p2, p3, p4)
__EXTERN WinApi_PtrVoid __CALL_1 CopyImage(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4);
...
__EXTERN WinApi_PtrVoid __CALL_1 CopyMetaFileA(WinApi_PtrVoid p0, WinApi_PtrSTR p1);
#define WinApi_CopyMetaFileW(p0, p1)	CopyMetaFileW(p0, p1)
__EXTERN WinApi_PtrVoid __CALL_1 CopyMetaFileW(WinApi_PtrVoid p0, WinApi_PtrWSTR p1);
...
__EXTERN INTEGER __CALL_1 CopySid(INTEGER nDestinationSidLength, WinApi_PtrVoid pDestinationSid, WinApi_PtrVoid pSourceSid);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateAcceleratorTableA(WinApi_ACCEL *p0, INTEGER p1);
#define WinApi_CreateAcceleratorTableW(p0, p0__typ, p1)	CreateAcceleratorTableW(p0, p1)
__EXTERN WinApi_PtrVoid __CALL_1 CreateAcceleratorTableW(WinApi_ACCEL *p0, INTEGER p1);
#define WinApi_CreateBitmap(p0, p1, p2, p3, p4)	CreateBitmap(p0, p1, p2, p3, p4)
__EXTERN WinApi_PtrVoid __CALL_1 CreateBitmap(INTEGER p0, INTEGER p1, INTEGER p2, INTEGER p3, WinApi_PtrVoid p4);
#define WinApi_CreateBitmapIndirect(p0, p0__typ)	CreateBitmapIndirect(p0)
__EXTERN WinApi_PtrVoid __CALL_1 CreateBitmapIndirect(WinApi_BITMAP *p0);
#define WinApi_CreateBrushIndirect(p0, p0__typ)	CreateBrushIndirect(p0)
__EXTERN WinApi_PtrVoid __CALL_1 CreateBrushIndirect(WinApi_LOGBRUSH *p0);
#define WinApi_CreateCaret(hWnd, hBitmap, nWidth, nHeight)	CreateCaret(hWnd, hBitmap, nWidth, nHeight)
__EXTERN INTEGER __CALL_1 CreateCaret(WinApi_PtrVoid hWnd, WinApi_PtrVoid hBitmap, INTEGER nWidth, INTEGER nHeight);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateColorSpaceA(WinApi_LOGCOLORSPACEA *p0);
#define WinApi_CreateColorSpaceW(p0, p0__typ)	CreateColorSpaceW(p0)
__EXTERN WinApi_PtrVoid __CALL_1 CreateColorSpaceW(WinApi_LOGCOLORSPACEW *p0);
#define WinApi_CreateCompatibleBitmap(p0, p1, p2)	CreateCompatibleBitmap(p0, p1, p2)
__EXTERN WinApi_PtrVoid __CALL_1 CreateCompatibleBitmap(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2);
#define WinApi_CreateCompatibleDC(p0)	CreateCompatibleDC(p0)
__EXTERN WinApi_PtrVoid __CALL_1 CreateCompatibleDC(WinApi_PtrVoid p0);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateConsoleScreenBuffer(SET dwDesiredAccess, SET dwShareMode, WinApi_SECURITY_ATTRIBUTES *lpSecurityAttributes, SET dwFlags, WinApi_PtrVoid lpScreenBufferData);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateCursor(WinApi_PtrVoid hInst, INTEGER xHotSpot, INTEGER yHotSpot, INTEGER nWidth, INTEGER nHeight, WinApi_PtrVoid pvANDPlane, WinApi_PtrVoid pvXORPlane);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateDCA(WinApi_PtrSTR p0, WinApi_PtrSTR p1, WinApi_PtrSTR p2, WinApi_DEVMODEA *p3);
#define WinApi_CreateDCW(p0, p1, p2, p3, p3__typ)	CreateDCW(p0, p1, p2, p3)
__EXTERN WinApi_PtrVoid __CALL_1 CreateDCW(WinApi_PtrWSTR p0, WinApi_PtrWSTR p1, WinApi_PtrWSTR p2, WinApi_DEVMODEW *p3);
#define WinApi_CreateDIBPatternBrush(p0, p1)	CreateDIBPatternBrush(p0, p1)
__EXTERN WinApi_PtrVoid __CALL_1 CreateDIBPatternBrush(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_CreateDIBPatternBrushPt(p0, p1)	CreateDIBPatternBrushPt(p0, p1)
__EXTERN WinApi_PtrVoid __CALL_1 CreateDIBPatternBrushPt(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_CreateDIBSection(p0, p1, p1__typ, p2, p3, p4, p5)	CreateDIBSection(p0, p1, p2, p3, p4, p5)
__EXTERN WinApi_PtrVoid __CALL_1 CreateDIBSection(WinApi_PtrVoid p0, WinApi_BITMAPINFO *p1, INTEGER p2, WinApi_PtrVoid *p3, WinApi_PtrVoid p4, INTEGER p5);
#define WinApi_CreateDIBitmap(p0, p1, p1__typ, p2, p3, p4, p4__typ, p5)	CreateDIBitmap(p0, p1, p2, p3, p4, p5)
__EXTERN WinApi_PtrVoid __CALL_1 CreateDIBitmap(WinApi_PtrVoid p0, WinApi_BITMAPINFOHEADER *p1, INTEGER p2, WinApi_PtrVoid p3, WinApi_BITMAPINFO *p4, INTEGER p5);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateDesktopA(WinApi_PtrSTR lpszDesktop, WinApi_PtrSTR lpszDevice, WinApi_DEVMODEA *pDevmode, SET dwFlags, SET dwDesiredAccess, WinApi_SECURITY_ATTRIBUTES *lpsa);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateDesktopW(WinApi_PtrWSTR lpszDesktop, WinApi_PtrWSTR lpszDevice, WinApi_DEVMODEW *pDevmode, SET dwFlags, SET dwDesiredAccess, WinApi_SECURITY_ATTRIBUTES *lpsa);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateDialogIndirectParamA(WinApi_PtrVoid hInstance, WinApi_DLGTEMPLATE *lpTemplate, WinApi_PtrVoid hWndParent, WinApi_DLGPROC lpDialogFunc, WinApi_PtrVoid dwInitParam);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateDialogIndirectParamW(WinApi_PtrVoid hInstance, WinApi_DLGTEMPLATE *lpTemplate, WinApi_PtrVoid hWndParent, WinApi_DLGPROC lpDialogFunc, WinApi_PtrVoid dwInitParam);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateDialogParamA(WinApi_PtrVoid hInstance, WinApi_PtrSTR lpTemplateName, WinApi_PtrVoid hWndParent, WinApi_DLGPROC lpDialogFunc, WinApi_PtrVoid dwInitParam);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateDialogParamW(WinApi_PtrVoid hInstance, WinApi_PtrWSTR lpTemplateName, WinApi_PtrVoid hWndParent, WinApi_DLGPROC lpDialogFunc, WinApi_PtrVoid dwInitParam);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateDiscardableBitmap(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2);
#define WinApi_CreateEllipticRgn(p0, p1, p2, p3)	CreateEllipticRgn(p0, p1, p2, p3)
__EXTERN WinApi_PtrVoid __CALL_1 CreateEllipticRgn(INTEGER p0, INTEGER p1, INTEGER p2, INTEGER p3);
#define WinApi_CreateEllipticRgnIndirect(p0, p0__typ)	CreateEllipticRgnIndirect(p0)
__EXTERN WinApi_PtrVoid __CALL_1 CreateEllipticRgnIndirect(WinApi_RECT *p0);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateEnhMetaFileA(WinApi_PtrVoid p0, WinApi_PtrSTR p1, WinApi_RECT *p2, WinApi_PtrSTR p3);
#define WinApi_CreateEnhMetaFileW(p0, p1, p2, p2__typ, p3)	CreateEnhMetaFileW(p0, p1, p2, p3)
__EXTERN WinApi_PtrVoid __CALL_1 CreateEnhMetaFileW(WinApi_PtrVoid p0, WinApi_PtrWSTR p1, WinApi_RECT *p2, WinApi_PtrWSTR p3);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateEventA(WinApi_SECURITY_ATTRIBUTES *lpEventAttributes, INTEGER bManualReset, INTEGER bInitialState, WinApi_PtrSTR lpName);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateEventW(WinApi_SECURITY_ATTRIBUTES *lpEventAttributes, INTEGER bManualReset, INTEGER bInitialState, WinApi_PtrWSTR lpName);
#define WinApi_CreateFiber(dwStackSize, lpStartAddress, lpParameter)	CreateFiber(dwStackSize, lpStartAddress, lpParameter)
__EXTERN WinApi_PtrVoid __CALL_1 CreateFiber(INTEGER dwStackSize, WinApi_FIBER_START_ROUTINE lpStartAddress, WinApi_PtrVoid lpParameter);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateFileMappingA(WinApi_PtrVoid hFile, WinApi_SECURITY_ATTRIBUTES *lpFileMappingAttributes, SET flProtect, INTEGER dwMaximumSizeHigh, INTEGER dwMaximumSizeLow, WinApi_PtrSTR lpName);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateFileMappingW(WinApi_PtrVoid hFile, WinApi_SECURITY_ATTRIBUTES *lpFileMappingAttributes, SET flProtect, INTEGER dwMaximumSizeHigh, INTEGER dwMaximumSizeLow, WinApi_PtrWSTR lpName);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateFileW(WinApi_PtrWSTR lpFileName, SET dwDesiredAccess, SET dwShareMode, WinApi_SECURITY_ATTRIBUTES *lpSecurityAttributes, INTEGER dwCreationDisposition, SET dwFlagsAndAttributes, WinApi_PtrVoid hTemplateFile);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateFontA(INTEGER p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4, INTEGER p5, INTEGER p6, INTEGER p7, INTEGER p8, INTEGER p9, INTEGER p10, INTEGER p11, INTEGER p12, WinApi_PtrSTR p13);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateFontIndirectA(WinApi_LOGFONTA *p0);
#define WinApi_CreateFontIndirectW(p0, p0__typ)	CreateFontIndirectW(p0)
__EXTERN WinApi_PtrVoid __CALL_1 CreateFontIndirectW(WinApi_LOGFONTW *p0);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateFontW(INTEGER p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4, INTEGER p5, INTEGER p6, INTEGER p7, INTEGER p8, INTEGER p9, INTEGER p10, INTEGER p11, INTEGER p12, WinApi_PtrWSTR p13);
#define WinApi_CreateHalftonePalette(p0)	CreateHalftonePalette(p0)
__EXTERN WinApi_PtrVoid __CALL_1 CreateHalftonePalette(WinApi_PtrVoid p0);
#define WinApi_CreateHatchBrush(p0, p1)	CreateHatchBrush(p0, p1)
__EXTERN WinApi_PtrVoid __CALL_1 CreateHatchBrush(INTEGER p0, INTEGER p1);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateICA(WinApi_PtrSTR p0, WinApi_PtrSTR p1, WinApi_PtrSTR p2, WinApi_DEVMODEA *p3);
#define WinApi_CreateICW(p0, p1, p2, p3, p3__typ)	CreateICW(p0, p1, p2, p3)
__EXTERN WinApi_PtrVoid __CALL_1 CreateICW(WinApi_PtrWSTR p0, WinApi_PtrWSTR p1, WinApi_PtrWSTR p2, WinApi_DEVMODEW *p3);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateIcon(WinApi_PtrVoid hInstance, INTEGER nWidth, INTEGER nHeight, CHAR cPlanes, CHAR cBitsPixel, CHAR *lpbANDbits, CHAR *lpbXORbits);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateIconFromResource(CHAR *presbits, INTEGER dwResSize, INTEGER fIcon, INTEGER dwVer);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateIconFromResourceEx(CHAR *presbits, INTEGER dwResSize, INTEGER fIcon, INTEGER dwVer, INTEGER cxDesired, INTEGER cyDesired, SET Flags);
#define WinApi_CreateIconIndirect(piconinfo, piconinfo__typ)	CreateIconIndirect(piconinfo)
__EXTERN WinApi_PtrVoid __CALL_1 CreateIconIndirect(WinApi_ICONINFO *piconinfo);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateIoCompletionPort(WinApi_PtrVoid FileHandle, WinApi_PtrVoid ExistingCompletionPort, INTEGER CompletionKey, INTEGER NumberOfConcurrentThreads);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateMDIWindowA(WinApi_PtrSTR lpClassName, WinApi_PtrSTR lpWindowName, SET dwStyle, INTEGER X, INTEGER Y, INTEGER nWidth, INTEGER nHeight, WinApi_PtrVoid hWndParent, WinApi_PtrVoid hInstance, WinApi_PtrVoid lParam);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateMDIWindowW(WinApi_PtrWSTR lpClassName, WinApi_PtrWSTR lpWindowName, SET dwStyle, INTEGER X, INTEGER Y, INTEGER nWidth, INTEGER nHeight, WinApi_PtrVoid hWndParent, WinApi_PtrVoid hInstance, WinApi_PtrVoid lParam);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateMailslotA(WinApi_PtrSTR lpName, INTEGER nMaxMessageSize, INTEGER lReadTimeout, WinApi_SECURITY_ATTRIBUTES *lpSecurityAttributes);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateMailslotW(WinApi_PtrWSTR lpName, INTEGER nMaxMessageSize, INTEGER lReadTimeout, WinApi_SECURITY_ATTRIBUTES *lpSecurityAttributes);
#define WinApi_CreateMenu()	CreateMenu()
__EXTERN WinApi_PtrVoid __CALL_1 CreateMenu(void);
#define WinApi_CreateMetaFile(p0)	CreateMetaFileA(p0)
#define WinApi_CreateMetaFileA(p0)	CreateMetaFileA(p0)
__EXTERN WinApi_PtrVoid __CALL_1 CreateMetaFileA(WinApi_PtrSTR p0);
#define WinApi_CreateMetaFileW(p0)	CreateMetaFileW(p0)
__EXTERN WinApi_PtrVoid __CALL_1 CreateMetaFileW(WinApi_PtrWSTR p0);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateMutexA(WinApi_SECURITY_ATTRIBUTES *lpMutexAttributes, INTEGER bInitialOwner, WinApi_PtrSTR lpName);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateMutexW(WinApi_SECURITY_ATTRIBUTES *lpMutexAttributes, INTEGER bInitialOwner, WinApi_PtrWSTR lpName);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateNamedPipeA(WinApi_PtrSTR lpName, INTEGER dwOpenMode, INTEGER dwPipeMode, INTEGER nMaxInstances, INTEGER nOutBufferSize, INTEGER nInBufferSize, INTEGER nDefaultTimeOut, WinApi_SECURITY_ATTRIBUTES *lpSecurityAttributes);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateNamedPipeW(WinApi_PtrWSTR lpName, INTEGER dwOpenMode, INTEGER dwPipeMode, INTEGER nMaxInstances, INTEGER nOutBufferSize, INTEGER nInBufferSize, INTEGER nDefaultTimeOut, WinApi_SECURITY_ATTRIBUTES *lpSecurityAttributes);
#define WinApi_CreatePalette(p0, p0__typ)	CreatePalette(p0)
__EXTERN WinApi_PtrVoid __CALL_1 CreatePalette(WinApi_LOGPALETTE *p0);
#define WinApi_CreatePatternBrush(p0)	CreatePatternBrush(p0)
__EXTERN WinApi_PtrVoid __CALL_1 CreatePatternBrush(WinApi_PtrVoid p0);
#define WinApi_CreatePen(p0, p1, p2)	CreatePen(p0, p1, p2)
__EXTERN WinApi_PtrVoid __CALL_1 CreatePen(INTEGER p0, INTEGER p1, INTEGER p2);
#define WinApi_CreatePenIndirect(p0, p0__typ)	CreatePenIndirect(p0)
__EXTERN WinApi_PtrVoid __CALL_1 CreatePenIndirect(WinApi_LOGPEN *p0);
...
__EXTERN INTEGER __CALL_1 CreatePipe(WinApi_PtrVoid *hReadPipe, WinApi_PtrVoid *hWritePipe, WinApi_SECURITY_ATTRIBUTES *lpPipeAttributes, INTEGER nSize);
#define WinApi_CreatePolyPolygonRgn(p0, p0__typ, p1, p2, p3)	CreatePolyPolygonRgn(p0, p1, p2, p3)
__EXTERN WinApi_PtrVoid __CALL_1 CreatePolyPolygonRgn(WinApi_POINT *p0, INTEGER *p1, INTEGER p2, INTEGER p3);
#define WinApi_CreatePolygonRgn(p0, p0__typ, p1, p2)	CreatePolygonRgn(p0, p1, p2)
__EXTERN WinApi_PtrVoid __CALL_1 CreatePolygonRgn(WinApi_POINT *p0, INTEGER p1, INTEGER p2);
#define WinApi_CreatePopupMenu()	CreatePopupMenu()
__EXTERN WinApi_PtrVoid __CALL_1 CreatePopupMenu(void);
...
__EXTERN INTEGER __CALL_1 CreatePrivateObjectSecurity(WinApi_PtrVoid ParentDescriptor, WinApi_PtrVoid CreatorDescriptor, WinApi_PtrVoid *NewDescriptor, INTEGER IsDirectoryObject, WinApi_PtrVoid Token, WinApi_GENERIC_MAPPING *GenericMapping);
...
__EXTERN INTEGER __CALL_1 CreateProcessA(WinApi_PtrSTR lpApplicationName, WinApi_PtrSTR lpCommandLine, WinApi_SECURITY_ATTRIBUTES *lpProcessAttributes, WinApi_SECURITY_ATTRIBUTES *lpThreadAttributes, INTEGER bInheritHandles, SET dwCreationFlags, WinApi_PtrVoid lpEnvironment, WinApi_PtrSTR lpCurrentDirectory, WinApi_STARTUPINFOA *lpStartupInfo, WinApi_PROCESS_INFORMATION *lpProcessInformation);
...
__EXTERN INTEGER __CALL_1 CreateProcessAsUserA(WinApi_PtrVoid hToken, WinApi_PtrSTR lpApplicationName, WinApi_PtrSTR lpCommandLine, WinApi_SECURITY_ATTRIBUTES *lpProcessAttributes, WinApi_SECURITY_ATTRIBUTES *lpThreadAttributes, INTEGER bInheritHandles, SET dwCreationFlags, WinApi_PtrVoid lpEnvironment, WinApi_PtrSTR lpCurrentDirectory, WinApi_STARTUPINFOA *lpStartupInfo, WinApi_PROCESS_INFORMATION *lpProcessInformation);
...
__EXTERN INTEGER __CALL_1 CreateProcessAsUserW(WinApi_PtrVoid hToken, WinApi_PtrWSTR lpApplicationName, WinApi_PtrWSTR lpCommandLine, WinApi_SECURITY_ATTRIBUTES *lpProcessAttributes, WinApi_SECURITY_ATTRIBUTES *lpThreadAttributes, INTEGER bInheritHandles, SET dwCreationFlags, WinApi_PtrVoid lpEnvironment, WinApi_PtrWSTR lpCurrentDirectory, WinApi_STARTUPINFOW *lpStartupInfo, WinApi_PROCESS_INFORMATION *lpProcessInformation);
...
__EXTERN INTEGER __CALL_1 CreateProcessW(WinApi_PtrWSTR lpApplicationName, WinApi_PtrWSTR lpCommandLine, WinApi_SECURITY_ATTRIBUTES *lpProcessAttributes, WinApi_SECURITY_ATTRIBUTES *lpThreadAttributes, INTEGER bInheritHandles, SET dwCreationFlags, WinApi_PtrVoid lpEnvironment, WinApi_PtrWSTR lpCurrentDirectory, WinApi_STARTUPINFOW *lpStartupInfo, WinApi_PROCESS_INFORMATION *lpProcessInformation);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateRectRgn(INTEGER p0, INTEGER p1, INTEGER p2, INTEGER p3);
#define WinApi_CreateRectRgnIndirect(p0, p0__typ)	CreateRectRgnIndirect(p0)
__EXTERN WinApi_PtrVoid __CALL_1 CreateRectRgnIndirect(WinApi_RECT *p0);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateRemoteThread(WinApi_PtrVoid hProcess, WinApi_SECURITY_ATTRIBUTES *lpThreadAttributes, INTEGER dwStackSize, WinApi_THREAD_START_ROUTINE lpStartAddress, WinApi_PtrVoid lpParameter, SET dwCreationFlags, INTEGER *lpThreadId);
#define WinApi_CreateRoundRectRgn(p0, p1, p2, p3, p4, p5)	CreateRoundRectRgn(p0, p1, p2, p3, p4, p5)
__EXTERN WinApi_PtrVoid __CALL_1 CreateRoundRectRgn(INTEGER p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4, INTEGER p5);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateSemaphoreA(WinApi_SECURITY_ATTRIBUTES *lpSemaphoreAttributes, INTEGER lInitialCount, INTEGER lMaximumCount, WinApi_PtrSTR lpName);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateSemaphoreW(WinApi_SECURITY_ATTRIBUTES *lpSemaphoreAttributes, INTEGER lInitialCount, INTEGER lMaximumCount, WinApi_PtrWSTR lpName);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateServiceW(WinApi_PtrVoid hSCManager, WinApi_PtrWSTR lpServiceName, WinApi_PtrWSTR lpDisplayName, SET dwDesiredAccess, SET dwServiceType, INTEGER dwStartType, INTEGER dwErrorControl, WinApi_PtrWSTR lpBinaryPathName, WinApi_PtrWSTR lpLoadOrderGroup, INTEGER *lpdwTagId, WinApi_PtrWSTR lpDependencies, WinApi_PtrWSTR lpServiceStartName, WinApi_PtrWSTR lpPassword);
#define WinApi_CreateSolidBrush(p0)	CreateSolidBrush(p0)
__EXTERN WinApi_PtrVoid __CALL_1 CreateSolidBrush(INTEGER p0);
...
__EXTERN INTEGER __CALL_1 CreateTapePartition(WinApi_PtrVoid hDevice, INTEGER dwPartitionMethod, INTEGER dwCount, INTEGER dwSize);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateThread(WinApi_SECURITY_ATTRIBUTES *lpThreadAttributes, INTEGER dwStackSize, WinApi_THREAD_START_ROUTINE lpStartAddress, WinApi_PtrVoid lpParameter, SET dwCreationFlags, INTEGER *lpThreadId);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateWaitableTimerA(WinApi_SECURITY_ATTRIBUTES *lpTimerAttributes, INTEGER bManualReset, WinApi_PtrSTR lpTimerName);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateWaitableTimerW(WinApi_SECURITY_ATTRIBUTES *lpTimerAttributes, INTEGER bManualReset, WinApi_PtrWSTR lpTimerName);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateWindowExA(SET dwExStyle, WinApi_PtrSTR lpClassName, WinApi_PtrSTR lpWindowName, SET dwStyle, INTEGER X, INTEGER Y, INTEGER nWidth, INTEGER nHeight, WinApi_PtrVoid hWndParent, WinApi_PtrVoid hMenu, WinApi_PtrVoid hInstance, WinApi_PtrVoid lpParam);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateWindowExW(SET dwExStyle, WinApi_PtrWSTR lpClassName, WinApi_PtrWSTR lpWindowName, SET dwStyle, INTEGER X, INTEGER Y, INTEGER nWidth, INTEGER nHeight, WinApi_PtrVoid hWndParent, WinApi_PtrVoid hMenu, WinApi_PtrVoid hInstance, WinApi_PtrVoid lpParam);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateWindowStationA(WinApi_PtrSTR lpwinsta, INTEGER dwReserved, SET dwDesiredAccess, WinApi_SECURITY_ATTRIBUTES *lpsa);
...
__EXTERN WinApi_PtrVoid __CALL_1 CreateWindowStationW(WinApi_PtrWSTR lpwinsta, INTEGER dwReserved, SET dwDesiredAccess, WinApi_SECURITY_ATTRIBUTES *lpsa);
#define WinApi_DPtoLP(p0, p1, p1__typ, p2)	DPtoLP(p0, p1, p2)
__EXTERN INTEGER __CALL_1 DPtoLP(WinApi_PtrVoid p0, WinApi_POINT *p1, INTEGER p2);
#define WinApi_DdeAbandonTransaction(idInst, hConv, idTransaction)	DdeAbandonTransaction(idInst, hConv, idTransaction)
__EXTERN INTEGER __CALL_1 DdeAbandonTransaction(INTEGER idInst, WinApi_PtrVoid hConv, INTEGER idTransaction);
#define WinApi_DdeAccessData(hData, pcbDataSize)	DdeAccessData(hData, pcbDataSize)
__EXTERN WinApi_RetDdeAccessData __CALL_1 DdeAccessData(WinApi_PtrVoid hData, INTEGER *pcbDataSize);
#define WinApi_DdeAddData(hData, pSrc, cb, cbOff)	DdeAddData(hData, pSrc, cb, cbOff)
__EXTERN WinApi_PtrVoid __CALL_1 DdeAddData(WinApi_PtrVoid hData, CHAR *pSrc, INTEGER cb, INTEGER cbOff);
...
__EXTERN WinApi_PtrVoid __CALL_1 DdeClientTransaction(CHAR *pData, INTEGER cbData, WinApi_PtrVoid hConv, WinApi_PtrVoid hszItem, INTEGER wFmt, INTEGER wType, INTEGER dwTimeout, INTEGER *pdwResult);
#define WinApi_DdeCmpStringHandles(hsz1, hsz2)	DdeCmpStringHandles(hsz1, hsz2)
__EXTERN INTEGER __CALL_1 DdeCmpStringHandles(WinApi_PtrVoid hsz1, WinApi_PtrVoid hsz2);
#define WinApi_DdeConnect(idInst, hszService, hszTopic, pCC, pCC__typ)	DdeConnect(idInst, hszService, hszTopic, pCC)
__EXTERN WinApi_PtrVoid __CALL_1 DdeConnect(INTEGER idInst, WinApi_PtrVoid hszService, WinApi_PtrVoid hszTopic, WinApi_CONVCONTEXT *pCC);
...
__EXTERN WinApi_PtrVoid __CALL_1 DdeConnectList(INTEGER idInst, WinApi_PtrVoid hszService, WinApi_PtrVoid hszTopic, WinApi_PtrVoid hConvList, WinApi_CONVCONTEXT *pCC);
...
__EXTERN WinApi_PtrVoid __CALL_1 DdeCreateDataHandle(INTEGER idInst, CHAR *pSrc, INTEGER cb, INTEGER cbOff, WinApi_PtrVoid hszItem, INTEGER wFmt, INTEGER afCmd);
...
__EXTERN WinApi_PtrVoid __CALL_1 DdeCreateStringHandleA(INTEGER idInst, WinApi_PtrSTR psz, INTEGER iCodePage);
#define WinApi_DdeCreateStringHandleW(idInst, psz, iCodePage)	DdeCreateStringHandleW(idInst, psz, iCodePage)
__EXTERN WinApi_PtrVoid __CALL_1 DdeCreateStringHandleW(INTEGER idInst, WinApi_PtrWSTR psz, INTEGER iCodePage);
#define WinApi_DdeDisconnect(hConv)	DdeDisconnect(hConv)
__EXTERN INTEGER __CALL_1 DdeDisconnect(WinApi_PtrVoid hConv);
#define WinApi_DdeDisconnectList(hConvList)	DdeDisconnectList(hConvList)
__EXTERN INTEGER __CALL_1 DdeDisconnectList(WinApi_PtrVoid hConvList);
#define WinApi_DdeEnableCallback(idInst, hConv, wCmd)	DdeEnableCallback(idInst, hConv, wCmd)
__EXTERN INTEGER __CALL_1 DdeEnableCallback(INTEGER idInst, WinApi_PtrVoid hConv, INTEGER wCmd);
#define WinApi_DdeFreeDataHandle(hData)	DdeFreeDataHandle(hData)
__EXTERN INTEGER __CALL_1 DdeFreeDataHandle(WinApi_PtrVoid hData);
#define WinApi_DdeFreeStringHandle(idInst, hsz)	DdeFreeStringHandle(idInst, hsz)
__EXTERN INTEGER __CALL_1 DdeFreeStringHandle(INTEGER idInst, WinApi_PtrVoid hsz);
#define WinApi_DdeGetData(hData, pDst, cbMax, cbOff)	DdeGetData(hData, pDst, cbMax, cbOff)
__EXTERN INTEGER __CALL_1 DdeGetData(WinApi_PtrVoid hData, CHAR *pDst, INTEGER cbMax, INTEGER cbOff);
...
__EXTERN INTEGER __CALL_1 DdeImpersonateClient(WinApi_PtrVoid hConv);
...
__EXTERN INTEGER __CALL_1 DdeKeepStringHandle(INTEGER idInst, WinApi_PtrVoid hsz);
#define WinApi_DdeNameService(idInst, hsz1, hsz2, afCmd)	DdeNameService(idInst, hsz1, hsz2, afCmd)
__EXTERN WinApi_PtrVoid __CALL_1 DdeNameService(INTEGER idInst, WinApi_PtrVoid hsz1, WinApi_PtrVoid hsz2, INTEGER afCmd);
#define WinApi_DdePostAdvise(idInst, hszTopic, hszItem)	DdePostAdvise(idInst, hszTopic, hszItem)
__EXTERN INTEGER __CALL_1 DdePostAdvise(INTEGER idInst, WinApi_PtrVoid hszTopic, WinApi_PtrVoid hszItem);
...
__EXTERN INTEGER __CALL_1 DdeQueryConvInfo(WinApi_PtrVoid hConv, INTEGER idTransaction, WinApi_CONVINFO *pConvInfo);
#define WinApi_DdeQueryNextServer(hConvList, hConvPrev)	DdeQueryNextServer(hConvList, hConvPrev)
__EXTERN WinApi_PtrVoid __CALL_1 DdeQueryNextServer(WinApi_PtrVoid hConvList, WinApi_PtrVoid hConvPrev);
...
__EXTERN INTEGER __CALL_1 DdeQueryStringA(INTEGER idInst, WinApi_PtrVoid hsz, WinApi_PtrSTR psz, INTEGER cchMax, INTEGER iCodePage);
#define WinApi_DdeQueryStringW(idInst, hsz, psz, cchMax, iCodePage)	DdeQueryStringW(idInst, hsz, psz, cchMax, iCodePage)
__EXTERN INTEGER __CALL_1 DdeQueryStringW(INTEGER idInst, WinApi_PtrVoid hsz, WinApi_PtrWSTR psz, INTEGER cchMax, INTEGER iCodePage);
#define WinApi_DdeReconnect(hConv)	DdeReconnect(hConv)
__EXTERN WinApi_PtrVoid __CALL_1 DdeReconnect(WinApi_PtrVoid hConv);
...
__EXTERN INTEGER __CALL_1 DdeSetQualityOfService(WinApi_PtrVoid hwndClient, WinApi_SECURITY_QUALITY_OF_SERVICE *pqosNew, WinApi_SECURITY_QUALITY_OF_SERVICE *pqosPrev);
#define WinApi_DdeSetUserHandle(hConv, id, hUser)	DdeSetUserHandle(hConv, id, hUser)
__EXTERN INTEGER __CALL_1 DdeSetUserHandle(WinApi_PtrVoid hConv, INTEGER id, INTEGER hUser);
#define WinApi_DdeUnaccessData(hData)	DdeUnaccessData(hData)
__EXTERN INTEGER __CALL_1 DdeUnaccessData(WinApi_PtrVoid hData);
...
__EXTERN WinApi_PtrVoid __CALL_1 DefDlgProcA(WinApi_PtrVoid hDlg, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
#define WinApi_DefDlgProcW(hDlg, Msg, wParam, lParam)	DefDlgProcW(hDlg, Msg, wParam, lParam)
__EXTERN WinApi_PtrVoid __CALL_1 DefDlgProcW(WinApi_PtrVoid hDlg, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
...
__EXTERN WinApi_PtrVoid __CALL_1 DefFrameProcA(WinApi_PtrVoid hWnd, WinApi_PtrVoid hWndMDIClient, INTEGER uMsg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
#define WinApi_DefFrameProcW(hWnd, hWndMDIClient, uMsg, wParam, lParam)	DefFrameProcW(hWnd, hWndMDIClient, uMsg, wParam, lParam)
__EXTERN WinApi_PtrVoid __CALL_1 DefFrameProcW(WinApi_PtrVoid hWnd, WinApi_PtrVoid hWndMDIClient, INTEGER uMsg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
...
__EXTERN WinApi_PtrVoid __CALL_1 DefMDIChildProcA(WinApi_PtrVoid hWnd, INTEGER uMsg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
#define WinApi_DefMDIChildProcW(hWnd, uMsg, wParam, lParam)	DefMDIChildProcW(hWnd, uMsg, wParam, lParam)
__EXTERN WinApi_PtrVoid __CALL_1 DefMDIChildProcW(WinApi_PtrVoid hWnd, INTEGER uMsg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
...
__EXTERN WinApi_PtrVoid __CALL_1 DefWindowProcA(WinApi_PtrVoid hWnd, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
#define WinApi_DefWindowProcW(hWnd, Msg, wParam, lParam)	DefWindowProcW(hWnd, Msg, wParam, lParam)
__EXTERN WinApi_PtrVoid __CALL_1 DefWindowProcW(WinApi_PtrVoid hWnd, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
...
__EXTERN WinApi_PtrVoid __CALL_1 DeferWindowPos(WinApi_PtrVoid hWinPosInfo, WinApi_PtrVoid hWnd, WinApi_PtrVoid hWndInsertAfter, INTEGER x, INTEGER y, INTEGER cx, INTEGER cy, SET uFlags);
...
__EXTERN INTEGER __CALL_1 DeleteColorSpace(WinApi_PtrVoid p0);
...
__EXTERN INTEGER __CALL_1 DeleteDC(WinApi_PtrVoid p0);
#define WinApi_DeleteEnhMetaFile(p0)	DeleteEnhMetaFile(p0)
__EXTERN INTEGER __CALL_1 DeleteEnhMetaFile(WinApi_PtrVoid p0);
#define WinApi_DeleteFiber(lpFiber)	DeleteFiber(lpFiber)
__EXTERN void __CALL_1 DeleteFiber(WinApi_PtrVoid lpFiber);
...
__EXTERN INTEGER __CALL_1 DeleteFormA(WinApi_PtrVoid hPrinter, WinApi_PtrSTR pFormName);
#define WinApi_DeleteFormW(hPrinter, pFormName)	DeleteFormW(hPrinter, pFormName)
__EXTERN INTEGER __CALL_1 DeleteFormW(WinApi_PtrVoid hPrinter, WinApi_PtrWSTR pFormName);
#define WinApi_DeleteMenu(hMenu, uPosition, uFlags)	DeleteMenu(hMenu, uPosition, uFlags)
__EXTERN INTEGER __CALL_1 DeleteMenu(WinApi_PtrVoid hMenu, INTEGER uPosition, SET uFlags);
#define WinApi_DeleteMetaFile(p0)	DeleteMetaFile(p0)
__EXTERN INTEGER __CALL_1 DeleteMetaFile(WinApi_PtrVoid p0);
...
__EXTERN INTEGER __CALL_1 DeleteObject(WinApi_PtrVoid p0);
...
__EXTERN INTEGER __CALL_1 DeletePortA(WinApi_PtrSTR pName, WinApi_PtrVoid hWnd, WinApi_PtrSTR pPortName);
#define WinApi_DeletePortW(pName, hWnd, pPortName)	DeletePortW(pName, hWnd, pPortName)
__EXTERN INTEGER __CALL_1 DeletePortW(WinApi_PtrWSTR pName, WinApi_PtrVoid hWnd, WinApi_PtrWSTR pPortName);
...
__EXTERN INTEGER __CALL_1 DeletePrinter(WinApi_PtrVoid hPrinter);
...
__EXTERN INTEGER __CALL_1 DeleteService(WinApi_PtrVoid hService);
#define WinApi_DeregisterEventSource(hEventLog)	DeregisterEventSource(hEventLog)
__EXTERN INTEGER __CALL_1 DeregisterEventSource(WinApi_PtrVoid hEventLog);
#define WinApi_DescribePixelFormat(p0, p1, p2, p3, p3__typ)	DescribePixelFormat(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 DescribePixelFormat(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_PIXELFORMATDESCRIPTOR *p3);
#define WinApi_DestroyAcceleratorTable(hAccel)	DestroyAcceleratorTable(hAccel)
__EXTERN INTEGER __CALL_1 DestroyAcceleratorTable(WinApi_PtrVoid hAccel);
...
__EXTERN INTEGER __CALL_1 DestroyCursor(WinApi_PtrVoid hCursor);
#define WinApi_DestroyIcon(hIcon)	DestroyIcon(hIcon)
__EXTERN INTEGER __CALL_1 DestroyIcon(WinApi_PtrVoid hIcon);
#define WinApi_DestroyMenu(hMenu)	DestroyMenu(hMenu)
__EXTERN INTEGER __CALL_1 DestroyMenu(WinApi_PtrVoid hMenu);
#define WinApi_DestroyPrivateObjectSecurity(ObjectDescriptor)	DestroyPrivateObjectSecurity(ObjectDescriptor)
__EXTERN INTEGER __CALL_1 DestroyPrivateObjectSecurity(WinApi_PtrVoid *ObjectDescriptor);
...
__EXTERN INTEGER __CALL_1 DestroyWindow(WinApi_PtrVoid hWnd);
...
__EXTERN INTEGER __CALL_1 DeviceIoControl(WinApi_PtrVoid hDevice, INTEGER dwIoControlCode, WinApi_PtrVoid lpInBuffer, INTEGER nInBufferSize, WinApi_PtrVoid lpOutBuffer, INTEGER nOutBufferSize, INTEGER *lpBytesReturned, WinApi_OVERLAPPED *lpOverlapped);
...
__EXTERN INTEGER __CALL_1 DialogBoxIndirectParamA(WinApi_PtrVoid hInstance, WinApi_DLGTEMPLATE *hDialogTemplate, WinApi_PtrVoid hWndParent, WinApi_DLGPROC lpDialogFunc, WinApi_PtrVoid dwInitParam);
...
__EXTERN INTEGER __CALL_1 DialogBoxIndirectParamW(WinApi_PtrVoid hInstance, WinApi_DLGTEMPLATE *hDialogTemplate, WinApi_PtrVoid hWndParent, WinApi_DLGPROC lpDialogFunc, WinApi_PtrVoid dwInitParam);
...
__EXTERN INTEGER __CALL_1 DialogBoxParamA(WinApi_PtrVoid hInstance, WinApi_PtrSTR lpTemplateName, WinApi_PtrVoid hWndParent, WinApi_DLGPROC lpDialogFunc, WinApi_PtrVoid dwInitParam);
...
__EXTERN INTEGER __CALL_1 DialogBoxParamW(WinApi_PtrVoid hInstance, WinApi_PtrWSTR lpTemplateName, WinApi_PtrVoid hWndParent, WinApi_DLGPROC lpDialogFunc, WinApi_PtrVoid dwInitParam);
#define WinApi_DisableThreadLibraryCalls(hLibModule)	DisableThreadLibraryCalls(hLibModule)
__EXTERN INTEGER __CALL_1 DisableThreadLibraryCalls(WinApi_PtrVoid hLibModule);
#define WinApi_DisconnectNamedPipe(hNamedPipe)	DisconnectNamedPipe(hNamedPipe)
__EXTERN INTEGER __CALL_1 DisconnectNamedPipe(WinApi_PtrVoid hNamedPipe);
...
__EXTERN INTEGER __CALL_1 DlgDirListA(WinApi_PtrVoid hDlg, WinApi_PtrSTR lpPathSpec, INTEGER nIDListBox, INTEGER nIDStaticPath, SET uFileType);
...
__EXTERN INTEGER __CALL_1 DlgDirListComboBoxA(WinApi_PtrVoid hDlg, WinApi_PtrSTR lpPathSpec, INTEGER nIDComboBox, INTEGER nIDStaticPath, INTEGER uFiletype);
...
__EXTERN INTEGER __CALL_1 DlgDirListComboBoxW(WinApi_PtrVoid hDlg, WinApi_PtrWSTR lpPathSpec, INTEGER nIDComboBox, INTEGER nIDStaticPath, INTEGER uFiletype);
...
__EXTERN INTEGER __CALL_1 DlgDirListW(WinApi_PtrVoid hDlg, WinApi_PtrWSTR lpPathSpec, INTEGER nIDListBox, INTEGER nIDStaticPath, SET uFileType);
...
__EXTERN INTEGER __CALL_1 DlgDirSelectComboBoxExA(WinApi_PtrVoid hDlg, WinApi_PtrSTR lpString, INTEGER nCount, INTEGER nIDComboBox);
...
__EXTERN INTEGER __CALL_1 DlgDirSelectComboBoxExW(WinApi_PtrVoid hDlg, WinApi_PtrWSTR lpString, INTEGER nCount, INTEGER nIDComboBox);
...
__EXTERN INTEGER __CALL_1 DlgDirSelectExA(WinApi_PtrVoid hDlg, WinApi_PtrSTR lpString, INTEGER nCount, INTEGER nIDListBox);
#define WinApi_DlgDirSelectExW(hDlg, lpString, nCount, nIDListBox)	DlgDirSelectExW(hDlg, lpString, nCount, nIDListBox)
__EXTERN INTEGER __CALL_1 DlgDirSelectExW(WinApi_PtrVoid hDlg, WinApi_PtrWSTR lpString, INTEGER nCount, INTEGER nIDListBox);
...
__EXTERN INTEGER __CALL_1 DocumentPropertiesA(WinApi_PtrVoid hWnd, WinApi_PtrVoid hPrinter, WinApi_PtrSTR pDeviceName, WinApi_DEVMODEA *pDevModeOutput, WinApi_DEVMODEA *pDevModeInput, SET fMode);
...
__EXTERN INTEGER __CALL_1 DocumentPropertiesW(WinApi_PtrVoid hWnd, WinApi_PtrVoid hPrinter, WinApi_PtrWSTR pDeviceName, WinApi_DEVMODEW *pDevModeOutput, WinApi_DEVMODEW *pDevModeInput, SET fMode);
...
__EXTERN void __CALL_1 DragAcceptFiles(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_DragDetect(p0, p1)	DragDetect(p0, p1)
__EXTERN INTEGER __CALL_1 DragDetect(WinApi_PtrVoid p0, WinApi_POINT p1);
#define WinApi_DragFinish(p0)	DragFinish(p0)
__EXTERN void __CALL_1 DragFinish(WinApi_PtrVoid p0);
#define WinApi_DragObject(p0, p1, p2, p3, p4)	DragObject(p0, p1, p2, p3, p4)
__EXTERN INTEGER __CALL_1 DragObject(WinApi_PtrVoid p0, WinApi_PtrVoid p1, INTEGER p2, INTEGER p3, WinApi_PtrVoid p4);
...
__EXTERN INTEGER __CALL_1 DragQueryFileA(WinApi_PtrVoid p0, INTEGER p1, WinApi_PtrSTR p2, INTEGER p3);
#define WinApi_DragQueryFileW(p0, p1, p2, p3)	DragQueryFileW(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 DragQueryFileW(WinApi_PtrVoid p0, INTEGER p1, WinApi_PtrWSTR p2, INTEGER p3);
#define WinApi_DragQueryPoint(p0, p1, p1__typ)	DragQueryPoint(p0, p1)
__EXTERN INTEGER __CALL_1 DragQueryPoint(WinApi_PtrVoid p0, WinApi_POINT *p1);
...
__EXTERN INTEGER __CALL_1 DrawAnimatedRects(WinApi_PtrVoid hwnd, INTEGER idAni, WinApi_RECT *lprcFrom, WinApi_RECT *lprcTo);
#define WinApi_DrawCaption(p0, p1, p2, p2__typ, p3)	DrawCaption(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 DrawCaption(WinApi_PtrVoid p0, WinApi_PtrVoid p1, WinApi_RECT *p2, INTEGER p3);
#define WinApi_DrawEdge(hdc, qrc, qrc__typ, edge, grfFlags)	DrawEdge(hdc, qrc, edge, grfFlags)
__EXTERN INTEGER __CALL_1 DrawEdge(WinApi_PtrVoid hdc, WinApi_RECT *qrc, SET edge, SET grfFlags);
#define WinApi_DrawEscape(p0, p1, p2, p3)	DrawEscape(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 DrawEscape(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_PtrSTR p3);
#define WinApi_DrawFocusRect(hDC, lprc, lprc__typ)	DrawFocusRect(hDC, lprc)
__EXTERN INTEGER __CALL_1 DrawFocusRect(WinApi_PtrVoid hDC, WinApi_RECT *lprc);
#define WinApi_DrawFrameControl(p0, p1, p1__typ, p2, p3)	DrawFrameControl(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 DrawFrameControl(WinApi_PtrVoid p0, WinApi_RECT *p1, INTEGER p2, SET p3);
#define WinApi_DrawIcon(hDC, X, Y, hIcon)	DrawIcon(hDC, X, Y, hIcon)
__EXTERN INTEGER __CALL_1 DrawIcon(WinApi_PtrVoid hDC, INTEGER X, INTEGER Y, WinApi_PtrVoid hIcon);
...
__EXTERN INTEGER __CALL_1 DrawIconEx(WinApi_PtrVoid hdc, INTEGER xLeft, INTEGER yTop, WinApi_PtrVoid hIcon, INTEGER cxWidth, INTEGER cyWidth, INTEGER istepIfAniCur, WinApi_PtrVoid hbrFlickerFreeDraw, SET diFlags);
#define WinApi_DrawMenuBar(hWnd)	DrawMenuBar(hWnd)
__EXTERN INTEGER __CALL_1 DrawMenuBar(WinApi_PtrVoid hWnd);
...
__EXTERN INTEGER __CALL_1 DrawStateA(WinApi_PtrVoid p0, WinApi_PtrVoid p1, WinApi_DRAWSTATEPROC p2, WinApi_PtrVoid p3, WinApi_PtrVoid p4, INTEGER p5, INTEGER p6, INTEGER p7, INTEGER p8, SET p9);
#define WinApi_DrawStateW(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9)	DrawStateW(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9)
__EXTERN INTEGER __CALL_1 DrawStateW(WinApi_PtrVoid p0, WinApi_PtrVoid p1, WinApi_DRAWSTATEPROC p2, WinApi_PtrVoid p3, WinApi_PtrVoid p4, INTEGER p5, INTEGER p6, INTEGER p7, INTEGER p8, SET p9);
...
__EXTERN INTEGER __CALL_1 DrawTextA(WinApi_PtrVoid hDC, WinApi_PtrSTR lpString, INTEGER nCount, WinApi_RECT *lpRect, SET uFormat);
...
__EXTERN INTEGER __CALL_1 DrawTextExA(WinApi_PtrVoid p0, WinApi_PtrSTR p1, INTEGER p2, WinApi_RECT *p3, INTEGER p4, WinApi_DRAWTEXTPARAMS *p5);
#define WinApi_DrawTextExW(p0, p1, p2, p3, p3__typ, p4, p5, p5__typ)	DrawTextExW(p0, p1, p2, p3, p4, p5)
__EXTERN INTEGER __CALL_1 DrawTextExW(WinApi_PtrVoid p0, WinApi_PtrWSTR p1, INTEGER p2, WinApi_RECT *p3, INTEGER p4, WinApi_DRAWTEXTPARAMS *p5);
#define WinApi_DrawTextW(hDC, lpString, nCount, lpRect, lpRect__typ, uFormat)	DrawTextW(hDC, lpString, nCount, lpRect, uFormat)
__EXTERN INTEGER __CALL_1 DrawTextW(WinApi_PtrVoid hDC, WinApi_PtrWSTR lpString, INTEGER nCount, WinApi_RECT *lpRect, SET uFormat);
...
__EXTERN INTEGER __CALL_1 DuplicateHandle(WinApi_PtrVoid hSourceProcessHandle, WinApi_PtrVoid hSourceHandle, WinApi_PtrVoid hTargetProcessHandle, WinApi_PtrVoid *lpTargetHandle, SET dwDesiredAccess, INTEGER bInheritHandle, SET dwOptions);
#define WinApi_DuplicateIcon(hInst, hIcon)	DuplicateIcon(hInst, hIcon)
__EXTERN WinApi_PtrVoid __CALL_1 DuplicateIcon(WinApi_PtrVoid hInst, WinApi_PtrVoid hIcon);
...
__EXTERN INTEGER __CALL_1 DuplicateToken(WinApi_PtrVoid ExistingTokenHandle, INTEGER ImpersonationLevel, WinApi_PtrVoid *DuplicateTokenHandle);
#define WinApi_Ellipse(p0, p1, p2, p3, p4)	Ellipse(p0, p1, p2, p3, p4)
__EXTERN INTEGER __CALL_1 Ellipse(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4);
...
__EXTERN INTEGER __CALL_1 EnableMenuItem(WinApi_PtrVoid hMenu, INTEGER uIDEnableItem, SET uEnable);
#define WinApi_EnableScrollBar(hWnd, wSBflags, wArrows)	EnableScrollBar(hWnd, wSBflags, wArrows)
__EXTERN INTEGER __CALL_1 EnableScrollBar(WinApi_PtrVoid hWnd, INTEGER wSBflags, INTEGER wArrows);
#define WinApi_EnableWindow(hWnd, bEnable)	EnableWindow(hWnd, bEnable)
__EXTERN INTEGER __CALL_1 EnableWindow(WinApi_PtrVoid hWnd, INTEGER bEnable);
#define WinApi_EndDeferWindowPos(hWinPosInfo)	EndDeferWindowPos(hWinPosInfo)
__EXTERN INTEGER __CALL_1 EndDeferWindowPos(WinApi_PtrVoid hWinPosInfo);
#define WinApi_EndDialog(hDlg, nResult)	EndDialog(hDlg, nResult)
__EXTERN INTEGER __CALL_1 EndDialog(WinApi_PtrVoid hDlg, INTEGER nResult);
#define WinApi_EndDoc(p0)	EndDoc(p0)
__EXTERN INTEGER __CALL_1 EndDoc(WinApi_PtrVoid p0);
#define WinApi_EndDocPrinter(hPrinter)	EndDocPrinter(hPrinter)
__EXTERN INTEGER __CALL_1 EndDocPrinter(WinApi_PtrVoid hPrinter);
#define WinApi_EndPage(p0)	EndPage(p0)
__EXTERN INTEGER __CALL_1 EndPage(WinApi_PtrVoid p0);
#define WinApi_EndPagePrinter(hPrinter)	EndPagePrinter(hPrinter)
__EXTERN INTEGER __CALL_1 EndPagePrinter(WinApi_PtrVoid hPrinter);
#define WinApi_EndPaint(hWnd, lpPaint, lpPaint__typ)	EndPaint(hWnd, lpPaint)
__EXTERN INTEGER __CALL_1 EndPaint(WinApi_PtrVoid hWnd, WinApi_PAINTSTRUCT *lpPaint);
#define WinApi_EndPath(p0)	EndPath(p0)
__EXTERN INTEGER __CALL_1 EndPath(WinApi_PtrVoid p0);
...
__EXTERN INTEGER __CALL_1 EndUpdateResourceA(WinApi_PtrVoid hUpdate, INTEGER fDiscard);
#define WinApi_EndUpdateResourceW(hUpdate, fDiscard)	EndUpdateResourceW(hUpdate, fDiscard)
__EXTERN INTEGER __CALL_1 EndUpdateResourceW(WinApi_PtrVoid hUpdate, INTEGER fDiscard);
...
__EXTERN INTEGER __CALL_1 EnumChildWindows(WinApi_PtrVoid hWndParent, WinApi_WNDENUMPROC lpEnumFunc, WinApi_PtrVoid lParam);
...
__EXTERN INTEGER __CALL_1 EnumDependentServicesA(WinApi_PtrVoid hService, INTEGER dwServiceState, WinApi_ENUM_SERVICE_STATUSA *lpServices, INTEGER cbBufSize, INTEGER *pcbBytesNeeded, INTEGER *lpServicesReturned);
...
__EXTERN INTEGER __CALL_1 EnumDependentServicesW(WinApi_PtrVoid hService, INTEGER dwServiceState, WinApi_ENUM_SERVICE_STATUSW *lpServices, INTEGER cbBufSize, INTEGER *pcbBytesNeeded, INTEGER *lpServicesReturned);
#define WinApi_EnumDesktopWindows(hDesktop, lpfn, lParam)	EnumDesktopWindows(hDesktop, lpfn, lParam)
__EXTERN INTEGER __CALL_1 EnumDesktopWindows(WinApi_PtrVoid hDesktop, WinApi_WNDENUMPROC lpfn, WinApi_PtrVoid lParam);
...
__EXTERN INTEGER __CALL_1 EnumDesktopsA(WinApi_PtrVoid hwinsta, WinApi_DESKTOPENUMPROCA lpEnumFunc, WinApi_PtrVoid lParam);
#define WinApi_EnumDesktopsW(hwinsta, lpEnumFunc, lParam)	EnumDesktopsW(hwinsta, lpEnumFunc, lParam)
__EXTERN INTEGER __CALL_1 EnumDesktopsW(WinApi_PtrVoid hwinsta, WinApi_DESKTOPENUMPROCW lpEnumFunc, WinApi_PtrVoid lParam);
...
__EXTERN INTEGER __CALL_1 EnumEnhMetaFile(WinApi_PtrVoid p0, WinApi_PtrVoid p1, WinApi_ENHMFENUMPROC p2, WinApi_PtrVoid p3, WinApi_RECT *p4);
...
__EXTERN INTEGER __CALL_1 EnumFontFamiliesA(WinApi_PtrVoid p0, WinApi_PtrSTR p1, WinApi_NEWFONTENUMPROCA p2, WinApi_PtrVoid p3);
...
__EXTERN INTEGER __CALL_1 EnumFontFamiliesExA(WinApi_PtrVoid p0, WinApi_LOGFONTA *p1, WinApi_FONTENUMPROCEXA p2, WinApi_PtrVoid p3, INTEGER p4);
#define WinApi_EnumFontFamiliesExW(p0, p1, p1__typ, p2, p3, p4)	EnumFontFamiliesExW(p0, p1, p2, p3, p4)
__EXTERN INTEGER __CALL_1 EnumFontFamiliesExW(WinApi_PtrVoid p0, WinApi_LOGFONTW *p1, WinApi_FONTENUMPROCEXW p2, WinApi_PtrVoid p3, INTEGER p4);
#define WinApi_EnumFontFamiliesW(p0, p1, p2, p3)	EnumFontFamiliesW(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 EnumFontFamiliesW(WinApi_PtrVoid p0, WinApi_PtrWSTR p1, WinApi_NEWFONTENUMPROCW p2, WinApi_PtrVoid p3);
#define WinApi_EnumFonts(p0, p1, p2, p3)	EnumFontsA(p0, p1, p2, p3)
#define WinApi_EnumFontsA(p0, p1, p2, p3)	EnumFontsA(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 EnumFontsA(WinApi_PtrVoid p0, WinApi_PtrSTR p1, WinApi_FONTENUMPROCA p2, WinApi_PtrVoid p3);
#define WinApi_EnumFontsW(p0, p1, p2, p3)	EnumFontsW(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 EnumFontsW(WinApi_PtrVoid p0, WinApi_PtrWSTR p1, WinApi_FONTENUMPROCW p2, WinApi_PtrVoid p3);
...
__EXTERN INTEGER __CALL_1 EnumFormsA(WinApi_PtrVoid hPrinter, INTEGER Level, CHAR *pForm, INTEGER cbBuf, INTEGER *pcbNeeded, INTEGER *pcReturned);
...
__EXTERN INTEGER __CALL_1 EnumFormsW(WinApi_PtrVoid hPrinter, INTEGER Level, CHAR *pForm, INTEGER cbBuf, INTEGER *pcbNeeded, INTEGER *pcReturned);
...
__EXTERN INTEGER __CALL_1 EnumICMProfilesA(WinApi_PtrVoid p0, WinApi_ICMENUMPROCA p1, WinApi_PtrVoid p2);
#define WinApi_EnumICMProfilesW(p0, p1, p2)	EnumICMProfilesW(p0, p1, p2)
__EXTERN INTEGER __CALL_1 EnumICMProfilesW(WinApi_PtrVoid p0, WinApi_ICMENUMPROCW p1, WinApi_PtrVoid p2);
...
__EXTERN INTEGER __CALL_1 EnumJobsA(WinApi_PtrVoid hPrinter, INTEGER FirstJob, INTEGER NoJobs, INTEGER Level, CHAR *pJob, INTEGER cbBuf, INTEGER *pcbNeeded, INTEGER *pcReturned);
...
__EXTERN INTEGER __CALL_1 EnumJobsW(WinApi_PtrVoid hPrinter, INTEGER FirstJob, INTEGER NoJobs, INTEGER Level, CHAR *pJob, INTEGER cbBuf, INTEGER *pcbNeeded, INTEGER *pcReturned);
#define WinApi_EnumMetaFile(p0, p1, p2, p3)	EnumMetaFile(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 EnumMetaFile(WinApi_PtrVoid p0, WinApi_PtrVoid p1, WinApi_MFENUMPROC p2, WinApi_PtrVoid p3);
...
__EXTERN INTEGER __CALL_1 EnumObjects(WinApi_PtrVoid p0, INTEGER p1, WinApi_GOBJENUMPROC p2, WinApi_PtrVoid p3);
...
__EXTERN INTEGER __CALL_1 EnumPropsA(WinApi_PtrVoid hWnd, WinApi_ROPENUMPROCA lpEnumFunc);
...
__EXTERN INTEGER __CALL_1 EnumPropsExA(WinApi_PtrVoid hWnd, WinApi_ROPENUMPROCEXA lpEnumFunc, WinApi_PtrVoid lParam);
#define WinApi_EnumPropsExW(hWnd, lpEnumFunc, lParam)	EnumPropsExW(hWnd, lpEnumFunc, lParam)
__EXTERN INTEGER __CALL_1 EnumPropsExW(WinApi_PtrVoid hWnd, WinApi_ROPENUMPROCEXW lpEnumFunc, WinApi_PtrVoid lParam);
#define WinApi_EnumPropsW(hWnd, lpEnumFunc)	EnumPropsW(hWnd, lpEnumFunc)
__EXTERN INTEGER __CALL_1 EnumPropsW(WinApi_PtrVoid hWnd, WinApi_ROPENUMPROCW lpEnumFunc);
...
__EXTERN INTEGER __CALL_1 EnumResourceLanguagesA(WinApi_PtrVoid hModule, WinApi_PtrSTR lpType, WinApi_PtrSTR lpName, WinApi_ENUMRESLANGPROC lpEnumFunc, INTEGER lParam);
...
__EXTERN INTEGER __CALL_1 EnumResourceLanguagesW(WinApi_PtrVoid hModule, WinApi_PtrWSTR lpType, WinApi_PtrWSTR lpName, WinApi_ENUMRESLANGPROC lpEnumFunc, INTEGER lParam);
...
__EXTERN INTEGER __CALL_1 EnumResourceNamesA(WinApi_PtrVoid hModule, WinApi_PtrSTR lpType, WinApi_ENUMRESNAMEPROC lpEnumFunc, INTEGER lParam);
#define WinApi_EnumResourceNamesW(hModule, lpType, lpEnumFunc, lParam)	EnumResourceNamesW(hModule, lpType, lpEnumFunc, lParam)
__EXTERN INTEGER __CALL_1 EnumResourceNamesW(WinApi_PtrVoid hModule, WinApi_PtrWSTR lpType, WinApi_ENUMRESNAMEPROC lpEnumFunc, INTEGER lParam);
...
__EXTERN INTEGER __CALL_1 EnumResourceTypesA(WinApi_PtrVoid hModule, WinApi_ENUMRESTYPEPROC lpEnumFunc, INTEGER lParam);
#define WinApi_EnumResourceTypesW(hModule, lpEnumFunc, lParam)	EnumResourceTypesW(hModule, lpEnumFunc, lParam)
__EXTERN INTEGER __CALL_1 EnumResourceTypesW(WinApi_PtrVoid hModule, WinApi_ENUMRESTYPEPROC lpEnumFunc, INTEGER lParam);
...
__EXTERN INTEGER __CALL_1 EnumServicesStatusA(WinApi_PtrVoid hSCManager, SET dwServiceType, INTEGER dwServiceState, WinApi_ENUM_SERVICE_STATUSA *lpServices, INTEGER cbBufSize, INTEGER *pcbBytesNeeded, INTEGER *lpServicesReturned, INTEGER *lpResumeHandle);
...
__EXTERN INTEGER __CALL_1 EnumServicesStatusW(WinApi_PtrVoid hSCManager, SET dwServiceType, INTEGER dwServiceState, WinApi_ENUM_SERVICE_STATUSW *lpServices, INTEGER cbBufSize, INTEGER *pcbBytesNeeded, INTEGER *lpServicesReturned, INTEGER *lpResumeHandle);
...
__EXTERN INTEGER __CALL_1 EnumThreadWindows(INTEGER dwThreadId, WinApi_WNDENUMPROC lpfn, WinApi_PtrVoid lParam);
...
__EXTERN INTEGER __CALL_1 EnumWindowStationsA(WinApi_WINSTAENUMPROCA lpEnumFunc, WinApi_PtrVoid lParam);
#define WinApi_EnumWindowStationsW(lpEnumFunc, lParam)	EnumWindowStationsW(lpEnumFunc, lParam)
__EXTERN INTEGER __CALL_1 EnumWindowStationsW(WinApi_WINSTAENUMPROCW lpEnumFunc, WinApi_PtrVoid lParam);
#define WinApi_EnumWindows(lpEnumFunc, lParam)	EnumWindows(lpEnumFunc, lParam)
__EXTERN INTEGER __CALL_1 EnumWindows(WinApi_WNDENUMPROC lpEnumFunc, WinApi_PtrVoid lParam);
#define WinApi_EqualPrefixSid(pSid1, pSid2)	EqualPrefixSid(pSid1, pSid2)
__EXTERN INTEGER __CALL_1 EqualPrefixSid(WinApi_PtrVoid pSid1, WinApi_PtrVoid pSid2);
...
__EXTERN INTEGER __CALL_1 EqualRgn(WinApi_PtrVoid p0, WinApi_PtrVoid p1);
#define WinApi_EqualSid(pSid1, pSid2)	EqualSid(pSid1, pSid2)
__EXTERN INTEGER __CALL_1 EqualSid(WinApi_PtrVoid pSid1, WinApi_PtrVoid pSid2);
#define WinApi_EraseTape(hDevice, dwEraseType, bImmediate)	EraseTape(hDevice, dwEraseType, bImmediate)
__EXTERN INTEGER __CALL_1 EraseTape(WinApi_PtrVoid hDevice, INTEGER dwEraseType, INTEGER bImmediate);
#define WinApi_Escape(p0, p1, p2, p3, p4)	Escape(p0, p1, p2, p3, p4)
__EXTERN INTEGER __CALL_1 Escape(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_PtrSTR p3, WinApi_PtrVoid p4);
#define WinApi_EscapeCommFunction(hFile, dwFunc)	EscapeCommFunction(hFile, dwFunc)
__EXTERN INTEGER __CALL_1 EscapeCommFunction(WinApi_PtrVoid hFile, INTEGER dwFunc);
#define WinApi_ExcludeClipRect(p0, p1, p2, p3, p4)	ExcludeClipRect(p0, p1, p2, p3, p4)
__EXTERN INTEGER __CALL_1 ExcludeClipRect(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4);
#define WinApi_ExcludeUpdateRgn(hDC, hWnd)	ExcludeUpdateRgn(hDC, hWnd)
__EXTERN INTEGER __CALL_1 ExcludeUpdateRgn(WinApi_PtrVoid hDC, WinApi_PtrVoid hWnd);
...
__EXTERN WinApi_PtrVoid __CALL_1 ExtCreatePen(INTEGER p0, INTEGER p1, WinApi_LOGBRUSH *p2, INTEGER p3, INTEGER *p4);
#define WinApi_ExtCreateRegion(p0, p0__typ, p1, p2, p2__typ)	ExtCreateRegion(p0, p1, p2)
__EXTERN WinApi_PtrVoid __CALL_1 ExtCreateRegion(WinApi_XFORM *p0, INTEGER p1, WinApi_RGNDATA *p2);
#define WinApi_ExtEscape(p0, p1, p2, p3, p4, p5)	ExtEscape(p0, p1, p2, p3, p4, p5)
__EXTERN INTEGER __CALL_1 ExtEscape(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_PtrSTR p3, INTEGER p4, WinApi_PtrSTR p5);
#define WinApi_ExtFloodFill(p0, p1, p2, p3, p4)	ExtFloodFill(p0, p1, p2, p3, p4)
__EXTERN INTEGER __CALL_1 ExtFloodFill(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4);
#define WinApi_ExtSelectClipRgn(p0, p1, p2)	ExtSelectClipRgn(p0, p1, p2)
__EXTERN INTEGER __CALL_1 ExtSelectClipRgn(WinApi_PtrVoid p0, WinApi_PtrVoid p1, INTEGER p2);
...
__EXTERN INTEGER __CALL_1 ExtTextOutA(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, WinApi_RECT *p4, WinApi_PtrSTR p5, INTEGER p6, INTEGER *p7);
#define WinApi_ExtTextOutW(p0, p1, p2, p3, p4, p4__typ, p5, p6, p7)	ExtTextOutW(p0, p1, p2, p3, p4, p5, p6, p7)
__EXTERN INTEGER __CALL_1 ExtTextOutW(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, WinApi_RECT *p4, WinApi_PtrWSTR p5, INTEGER p6, INTEGER *p7);
...
__EXTERN WinApi_PtrVoid __CALL_1 ExtractAssociatedIconA(WinApi_PtrVoid hInst, WinApi_PtrSTR lpIconPath, SHORTINT *lpiIcon);
#define WinApi_ExtractAssociatedIconW(hInst, lpIconPath, lpiIcon)	ExtractAssociatedIconW(hInst, lpIconPath, lpiIcon)
__EXTERN WinApi_PtrVoid __CALL_1 ExtractAssociatedIconW(WinApi_PtrVoid hInst, WinApi_PtrWSTR lpIconPath, SHORTINT *lpiIcon);
...
__EXTERN WinApi_PtrVoid __CALL_1 ExtractIconA(WinApi_PtrVoid hInst, WinApi_PtrSTR lpszExeFileName, INTEGER nIconIndex);
...
__EXTERN INTEGER __CALL_1 ExtractIconExA(WinApi_PtrSTR lpszFile, INTEGER nIconIndex, WinApi_PtrVoid *phiconLarge, WinApi_PtrVoid *phiconSmall, INTEGER nIcons);
...
__EXTERN INTEGER __CALL_1 ExtractIconExW(WinApi_PtrWSTR lpszFile, INTEGER nIconIndex, WinApi_PtrVoid *phiconLarge, WinApi_PtrVoid *phiconSmall, INTEGER nIcons);
#define WinApi_ExtractIconW(hInst, lpszExeFileName, nIconIndex)	ExtractIconW(hInst, lpszExeFileName, nIconIndex)
__EXTERN WinApi_PtrVoid __CALL_1 ExtractIconW(WinApi_PtrVoid hInst, WinApi_PtrWSTR lpszExeFileName, INTEGER nIconIndex);
...
__EXTERN INTEGER __CALL_1 FillConsoleOutputAttribute(WinApi_PtrVoid hConsoleOutput, SHORTINT wAttribute, INTEGER nLength, WinApi_COORD dwWriteCoord, INTEGER *lpNumberOfAttrsWritten);
...
__EXTERN INTEGER __CALL_1 FillConsoleOutputCharacterA(WinApi_PtrVoid hConsoleOutput, CHAR cCharacter, INTEGER nLength, WinApi_COORD dwWriteCoord, INTEGER *lpNumberOfCharsWritten);
...
__EXTERN INTEGER __CALL_1 FillConsoleOutputCharacterW(WinApi_PtrVoid hConsoleOutput, SHORTINT cCharacter, INTEGER nLength, WinApi_COORD dwWriteCoord, INTEGER *lpNumberOfCharsWritten);
#define WinApi_FillPath(p0)	FillPath(p0)
__EXTERN INTEGER __CALL_1 FillPath(WinApi_PtrVoid p0);
#define WinApi_FillRect(hDC, lprc, lprc__typ, hbr)	FillRect(hDC, lprc, hbr)
__EXTERN INTEGER __CALL_1 FillRect(WinApi_PtrVoid hDC, WinApi_RECT *lprc, WinApi_PtrVoid hbr);
#define WinApi_FillRgn(p0, p1, p2)	FillRgn(p0, p1, p2)
__EXTERN INTEGER __CALL_1 FillRgn(WinApi_PtrVoid p0, WinApi_PtrVoid p1, WinApi_PtrVoid p2);
...
__EXTERN INTEGER __CALL_1 FindClose(WinApi_PtrVoid hFindFile);
#define WinApi_FindCloseChangeNotification(hChangeHandle)	FindCloseChangeNotification(hChangeHandle)
__EXTERN INTEGER __CALL_1 FindCloseChangeNotification(WinApi_PtrVoid hChangeHandle);
#define WinApi_FindClosePrinterChangeNotification(hChange)	FindClosePrinterChangeNotification(hChange)
__EXTERN INTEGER __CALL_1 FindClosePrinterChangeNotification(WinApi_PtrVoid hChange);
...
__EXTERN WinApi_PtrVoid __CALL_1 FindExecutableA(WinApi_PtrSTR lpFile, WinApi_PtrSTR lpDirectory, WinApi_PtrSTR lpResult);
#define WinApi_FindExecutableW(lpFile, lpDirectory, lpResult)	FindExecutableW(lpFile, lpDirectory, lpResult)
__EXTERN WinApi_PtrVoid __CALL_1 FindExecutableW(WinApi_PtrWSTR lpFile, WinApi_PtrWSTR lpDirectory, WinApi_PtrWSTR lpResult);
...
__EXTERN WinApi_PtrVoid __CALL_1 FindFirstChangeNotificationA(WinApi_PtrSTR lpPathName, INTEGER bWatchSubtree, SET dwNotifyFilter);
...
__EXTERN WinApi_PtrVoid __CALL_1 FindFirstChangeNotificationW(WinApi_PtrWSTR lpPathName, INTEGER bWatchSubtree, SET dwNotifyFilter);
...
__EXTERN WinApi_PtrVoid __CALL_1 FindFirstFileA(WinApi_PtrSTR lpFileName, WinApi_WIN32_FIND_DATAA *lpFindFileData);
...
__EXTERN WinApi_PtrVoid __CALL_1 FindFirstFileExA(WinApi_PtrSTR lpFileName, INTEGER fInfoLevelId, WinApi_PtrVoid lpFindFileData, INTEGER fSearchOp, WinApi_PtrVoid lpSearchFilter, INTEGER dwAdditionalFlags);
...
__EXTERN WinApi_PtrVoid __CALL_1 FindFirstFileExW(WinApi_PtrWSTR lpFileName, INTEGER fInfoLevelId, WinApi_PtrVoid lpFindFileData, INTEGER fSearchOp, WinApi_PtrVoid lpSearchFilter, INTEGER dwAdditionalFlags);
#define WinApi_FindFirstFileW(lpFileName, lpFindFileData, lpFindFileData__typ)	FindFirstFileW(lpFileName, lpFindFileData)
__EXTERN WinApi_PtrVoid __CALL_1 FindFirstFileW(WinApi_PtrWSTR lpFileName, WinApi_WIN32_FIND_DATAW *lpFindFileData);
...
__EXTERN WinApi_PtrVoid __CALL_1 FindFirstPrinterChangeNotification(WinApi_PtrVoid hPrinter, SET fdwFlags, INTEGER fdwOptions, WinApi_PtrVoid pPrinterNotifyOptions);
#define WinApi_FindNextChangeNotification(hChangeHandle)	FindNextChangeNotification(hChangeHandle)
__EXTERN INTEGER __CALL_1 FindNextChangeNotification(WinApi_PtrVoid hChangeHandle);
...
__EXTERN INTEGER __CALL_1 FindNextFileA(WinApi_PtrVoid hFindFile, WinApi_WIN32_FIND_DATAA *lpFindFileData);
#define WinApi_FindNextFileW(hFindFile, lpFindFileData, lpFindFileData__typ)	FindNextFileW(hFindFile, lpFindFileData)
__EXTERN INTEGER __CALL_1 FindNextFileW(WinApi_PtrVoid hFindFile, WinApi_WIN32_FIND_DATAW *lpFindFileData);
...
__EXTERN INTEGER __CALL_1 FindNextPrinterChangeNotification(WinApi_PtrVoid hChange, INTEGER *pdwChange, WinApi_PtrVoid pvReserved, struct {
	LONGINT len[1];
	WinApi_PtrVoid data[1];
} *ppPrinterNotifyInfo);
...
__EXTERN WinApi_PtrVoid __CALL_1 FindResourceA(WinApi_PtrVoid hModule, WinApi_PtrSTR lpName, WinApi_PtrSTR lpType);
...
__EXTERN WinApi_PtrVoid __CALL_1 FindResourceExA(WinApi_PtrVoid hModule, WinApi_PtrSTR lpType, WinApi_PtrSTR lpName, SHORTINT wLanguage);
#define WinApi_FindResourceExW(hModule, lpType, lpName, wLanguage)	FindResourceExW(hModule, lpType, lpName, wLanguage)
__EXTERN WinApi_PtrVoid __CALL_1 FindResourceExW(WinApi_PtrVoid hModule, WinApi_PtrWSTR lpType, WinApi_PtrWSTR lpName, SHORTINT wLanguage);
#define WinApi_FindResourceW(hModule, lpName, lpType)	FindResourceW(hModule, lpName, lpType)
__EXTERN WinApi_PtrVoid __CALL_1 FindResourceW(WinApi_PtrVoid hModule, WinApi_PtrWSTR lpName, WinApi_PtrWSTR lpType);
...
__EXTERN WinApi_PtrVoid __CALL_1 FindWindowA(WinApi_PtrSTR lpClassName, WinApi_PtrSTR lpWindowName);
...
__EXTERN WinApi_PtrVoid __CALL_1 FindWindowExA(WinApi_PtrVoid p0, WinApi_PtrVoid p1, WinApi_PtrSTR p2, WinApi_PtrSTR p3);
#define WinApi_FindWindowExW(p0, p1, p2, p3)	FindWindowExW(p0, p1, p2, p3)
__EXTERN WinApi_PtrVoid __CALL_1 FindWindowExW(WinApi_PtrVoid p0, WinApi_PtrVoid p1, WinApi_PtrWSTR p2, WinApi_PtrWSTR p3);
#define WinApi_FindWindowW(lpClassName, lpWindowName)	FindWindowW(lpClassName, lpWindowName)
__EXTERN WinApi_PtrVoid __CALL_1 FindWindowW(WinApi_PtrWSTR lpClassName, WinApi_PtrWSTR lpWindowName);
#define WinApi_FixBrushOrgEx(p0, p1, p2, p3, p3__typ)	FixBrushOrgEx(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 FixBrushOrgEx(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_POINT *p3);
#define WinApi_FlashWindow(hWnd, bInvert)	FlashWindow(hWnd, bInvert)
__EXTERN INTEGER __CALL_1 FlashWindow(WinApi_PtrVoid hWnd, INTEGER bInvert);
#define WinApi_FlattenPath(p0)	FlattenPath(p0)
__EXTERN INTEGER __CALL_1 FlattenPath(WinApi_PtrVoid p0);
#define WinApi_FloodFill(p0, p1, p2, p3)	FloodFill(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 FloodFill(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3);
#define WinApi_FlushConsoleInputBuffer(hConsoleInput)	FlushConsoleInputBuffer(hConsoleInput)
__EXTERN INTEGER __CALL_1 FlushConsoleInputBuffer(WinApi_PtrVoid hConsoleInput);
#define WinApi_FlushFileBuffers(hFile)	FlushFileBuffers(hFile)
__EXTERN INTEGER __CALL_1 FlushFileBuffers(WinApi_PtrVoid hFile);
#define WinApi_FlushInstructionCache(hProcess, lpBaseAddress, dwSize)	FlushInstructionCache(hProcess, lpBaseAddress, dwSize)
__EXTERN INTEGER __CALL_1 FlushInstructionCache(WinApi_PtrVoid hProcess, WinApi_PtrVoid lpBaseAddress, INTEGER dwSize);
#define WinApi_FlushViewOfFile(lpBaseAddress, dwNumberOfBytesToFlush)	FlushViewOfFile(lpBaseAddress, dwNumberOfBytesToFlush)
__EXTERN INTEGER __CALL_1 FlushViewOfFile(WinApi_PtrVoid lpBaseAddress, INTEGER dwNumberOfBytesToFlush);
...
__EXTERN INTEGER __CALL_1 FormatMessageA(SET dwFlags, WinApi_PtrVoid lpSource, INTEGER dwMessageId, INTEGER dwLanguageId, WinApi_PtrSTR lpBuffer, INTEGER nSize, WinApi_PtrSTR *Arguments);
...
__EXTERN INTEGER __CALL_1 FormatMessageW(SET dwFlags, WinApi_PtrVoid lpSource, INTEGER dwMessageId, INTEGER dwLanguageId, WinApi_PtrWSTR lpBuffer, INTEGER nSize, WinApi_PtrSTR *Arguments);
#define WinApi_FrameRect(hDC, lprc, lprc__typ, hbr)	FrameRect(hDC, lprc, hbr)
__EXTERN INTEGER __CALL_1 FrameRect(WinApi_PtrVoid hDC, WinApi_RECT *lprc, WinApi_PtrVoid hbr);
#define WinApi_FrameRgn(p0, p1, p2, p3, p4)	FrameRgn(p0, p1, p2, p3, p4)
__EXTERN INTEGER __CALL_1 FrameRgn(WinApi_PtrVoid p0, WinApi_PtrVoid p1, WinApi_PtrVoid p2, INTEGER p3, INTEGER p4);
...
__EXTERN INTEGER __CALL_1 FreeLibrary(WinApi_PtrVoid hLibModule);
#define WinApi_FreeLibraryAndExitThread(hLibModule, dwExitCode)	FreeLibraryAndExitThread(hLibModule, dwExitCode)
__EXTERN void __CALL_1 FreeLibraryAndExitThread(WinApi_PtrVoid hLibModule, INTEGER dwExitCode);
...
__EXTERN INTEGER __CALL_1 FreeResource(WinApi_PtrVoid hResData);
#define WinApi_FreeSid(pSid)	FreeSid(pSid)
__EXTERN WinApi_PtrVoid __CALL_1 FreeSid(WinApi_PtrVoid pSid);
#define WinApi_GdiComment(p0, p1, p2)	GdiComment(p0, p1, p2)
__EXTERN INTEGER __CALL_1 GdiComment(WinApi_PtrVoid p0, INTEGER p1, CHAR *p2);
...
__EXTERN INTEGER __CALL_1 GetAclInformation(WinApi_ACL *pAcl, WinApi_PtrVoid pAclInformation, INTEGER nAclInformationLength, INTEGER dwAclInformationClass);
#define WinApi_GetActiveWindow()	GetActiveWindow()
__EXTERN WinApi_PtrVoid __CALL_1 GetActiveWindow(void);
#define WinApi_GetArcDirection(p0)	GetArcDirection(p0)
__EXTERN INTEGER __CALL_1 GetArcDirection(WinApi_PtrVoid p0);
#define WinApi_GetAspectRatioFilterEx(p0, p1, p1__typ)	GetAspectRatioFilterEx(p0, p1)
__EXTERN INTEGER __CALL_1 GetAspectRatioFilterEx(WinApi_PtrVoid p0, WinApi_SIZE *p1);
...
__EXTERN INTEGER __CALL_1 GetBitmapBits(WinApi_PtrVoid p0, INTEGER p1, WinApi_PtrVoid p2);
#define WinApi_GetBitmapDimensionEx(p0, p1, p1__typ)	GetBitmapDimensionEx(p0, p1)
__EXTERN INTEGER __CALL_1 GetBitmapDimensionEx(WinApi_PtrVoid p0, WinApi_SIZE *p1);
#define WinApi_GetBkColor(p0)	GetBkColor(p0)
__EXTERN INTEGER __CALL_1 GetBkColor(WinApi_PtrVoid p0);
#define WinApi_GetBkMode(p0)	GetBkMode(p0)
__EXTERN INTEGER __CALL_1 GetBkMode(WinApi_PtrVoid p0);
#define WinApi_GetBoundsRect(p0, p1, p1__typ, p2)	GetBoundsRect(p0, p1, p2)
__EXTERN SET __CALL_1 GetBoundsRect(WinApi_PtrVoid p0, WinApi_RECT *p1, SET p2);
#define WinApi_GetBrushOrgEx(p0, p1, p1__typ)	GetBrushOrgEx(p0, p1)
__EXTERN INTEGER __CALL_1 GetBrushOrgEx(WinApi_PtrVoid p0, WinApi_POINT *p1);
...
__EXTERN WinApi_PtrVoid __CALL_1 GetCapture(void);
...
__EXTERN INTEGER __CALL_1 GetCharABCWidthsA(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_ABC *p3);
...
__EXTERN INTEGER __CALL_1 GetCharABCWidthsFloatA(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_ABCFLOAT *p3);
#define WinApi_GetCharABCWidthsFloatW(p0, p1, p2, p3, p3__typ)	GetCharABCWidthsFloatW(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 GetCharABCWidthsFloatW(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_ABCFLOAT *p3);
#define WinApi_GetCharABCWidthsW(p0, p1, p2, p3, p3__typ)	GetCharABCWidthsW(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 GetCharABCWidthsW(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_ABC *p3);
...
__EXTERN INTEGER __CALL_1 GetCharWidth32A(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER *p3);
#define WinApi_GetCharWidth32W(p0, p1, p2, p3)	GetCharWidth32W(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 GetCharWidth32W(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER *p3);
#define WinApi_GetCharWidthA(p0, p1, p2, p3)	GetCharWidthA(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 GetCharWidthA(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER *p3);
...
__EXTERN INTEGER __CALL_1 GetCharWidthFloatA(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, REAL *p3);
#define WinApi_GetCharWidthFloatW(p0, p1, p2, p3)	GetCharWidthFloatW(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 GetCharWidthFloatW(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, REAL *p3);
#define WinApi_GetCharWidthW(p0, p1, p2, p3)	GetCharWidthW(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 GetCharWidthW(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER *p3);
...
__EXTERN INTEGER __CALL_1 GetCharacterPlacementA(WinApi_PtrVoid p0, WinApi_PtrSTR p1, INTEGER p2, INTEGER p3, WinApi_GCP_RESULTSA *p4, INTEGER p5);
#define WinApi_GetCharacterPlacementW(p0, p1, p2, p3, p4, p4__typ, p5)	GetCharacterPlacementW(p0, p1, p2, p3, p4, p5)
__EXTERN INTEGER __CALL_1 GetCharacterPlacementW(WinApi_PtrVoid p0, WinApi_PtrWSTR p1, INTEGER p2, INTEGER p3, WinApi_GCP_RESULTSW *p4, INTEGER p5);
...
__EXTERN INTEGER __CALL_1 GetClassInfoA(WinApi_PtrVoid hInstance, WinApi_PtrSTR lpClassName, WinApi_WNDCLASSA *lpWndClass);
...
__EXTERN INTEGER __CALL_1 GetClassInfoExA(WinApi_PtrVoid p0, WinApi_PtrSTR p1, WinApi_WNDCLASSEXA *p2);
#define WinApi_GetClassInfoExW(p0, p1, p2, p2__typ)	GetClassInfoExW(p0, p1, p2)
__EXTERN INTEGER __CALL_1 GetClassInfoExW(WinApi_PtrVoid p0, WinApi_PtrWSTR p1, WinApi_WNDCLASSEXW *p2);
...
__EXTERN INTEGER __CALL_1 GetClassInfoW(WinApi_PtrVoid hInstance, WinApi_PtrWSTR lpClassName, WinApi_WNDCLASSW *lpWndClass);
...
__EXTERN INTEGER __CALL_1 GetClassLongA(WinApi_PtrVoid hWnd, INTEGER nIndex);
#define WinApi_GetClassLongW(hWnd, nIndex)	GetClassLongW(hWnd, nIndex)
__EXTERN INTEGER __CALL_1 GetClassLongW(WinApi_PtrVoid hWnd, INTEGER nIndex);
...
__EXTERN INTEGER __CALL_1 GetClassNameA(WinApi_PtrVoid hWnd, WinApi_PtrSTR lpClassName, INTEGER nMaxCount);
#define WinApi_GetClassNameW(hWnd, lpClassName, nMaxCount)	GetClassNameW(hWnd, lpClassName, nMaxCount)
__EXTERN INTEGER __CALL_1 GetClassNameW(WinApi_PtrVoid hWnd, WinApi_PtrWSTR lpClassName, INTEGER nMaxCount);
#define WinApi_GetClassWord(hWnd, nIndex)	GetClassWord(hWnd, nIndex)
__EXTERN SHORTINT __CALL_1 GetClassWord(WinApi_PtrVoid hWnd, INTEGER nIndex);
#define WinApi_GetClientRect(hWnd, lpRect, lpRect__typ)	GetClientRect(hWnd, lpRect)
__EXTERN INTEGER __CALL_1 GetClientRect(WinApi_PtrVoid hWnd, WinApi_RECT *lpRect);
#define WinApi_GetClipBox(p0, p1, p1__typ)	GetClipBox(p0, p1)
__EXTERN INTEGER __CALL_1 GetClipBox(WinApi_PtrVoid p0, WinApi_RECT *p1);
...
__EXTERN INTEGER __CALL_1 GetClipRgn(WinApi_PtrVoid p0, WinApi_PtrVoid p1);
#define WinApi_GetClipboardData(uFormat)	GetClipboardData(uFormat)
__EXTERN WinApi_PtrVoid __CALL_1 GetClipboardData(INTEGER uFormat);
...
__EXTERN WinApi_PtrVoid __CALL_1 GetClipboardOwner(void);
#define WinApi_GetClipboardViewer()	GetClipboardViewer()
__EXTERN WinApi_PtrVoid __CALL_1 GetClipboardViewer(void);
#define WinApi_GetColorAdjustment(p0, p1, p1__typ)	GetColorAdjustment(p0, p1)
__EXTERN INTEGER __CALL_1 GetColorAdjustment(WinApi_PtrVoid p0, WinApi_COLORADJUSTMENT *p1);
#define WinApi_GetColorSpace(p0)	GetColorSpace(p0)
__EXTERN WinApi_PtrVoid __CALL_1 GetColorSpace(WinApi_PtrVoid p0);
#define WinApi_GetCommConfig(hCommDev, lpCC, lpCC__typ, lpdwSize)	GetCommConfig(hCommDev, lpCC, lpdwSize)
__EXTERN INTEGER __CALL_1 GetCommConfig(WinApi_PtrVoid hCommDev, WinApi_COMMCONFIG *lpCC, INTEGER *lpdwSize);
#define WinApi_GetCommMask(hFile, lpEvtMask)	GetCommMask(hFile, lpEvtMask)
__EXTERN INTEGER __CALL_1 GetCommMask(WinApi_PtrVoid hFile, SET *lpEvtMask);
#define WinApi_GetCommModemStatus(hFile, lpModemStat)	GetCommModemStatus(hFile, lpModemStat)
__EXTERN INTEGER __CALL_1 GetCommModemStatus(WinApi_PtrVoid hFile, SET *lpModemStat);
#define WinApi_GetCommProperties(hFile, lpCommProp, lpCommProp__typ)	GetCommProperties(hFile, lpCommProp)
__EXTERN INTEGER __CALL_1 GetCommProperties(WinApi_PtrVoid hFile, WinApi_COMMPROP *lpCommProp);
#define WinApi_GetCommState(hFile, lpDCB, lpDCB__typ)	GetCommState(hFile, lpDCB)
__EXTERN INTEGER __CALL_1 GetCommState(WinApi_PtrVoid hFile, WinApi_DCB *lpDCB);
#define WinApi_GetCommTimeouts(hFile, lpCommTimeouts, lpCommTimeouts__typ)	GetCommTimeouts(hFile, lpCommTimeouts)
__EXTERN INTEGER __CALL_1 GetCommTimeouts(WinApi_PtrVoid hFile, WinApi_COMMTIMEOUTS *lpCommTimeouts);
...
__EXTERN INTEGER __CALL_1 GetConsoleCursorInfo(WinApi_PtrVoid hConsoleOutput, WinApi_CONSOLE_CURSOR_INFO *lpConsoleCursorInfo);
#define WinApi_GetConsoleMode(hConsoleHandle, lpMode)	GetConsoleMode(hConsoleHandle, lpMode)
__EXTERN INTEGER __CALL_1 GetConsoleMode(WinApi_PtrVoid hConsoleHandle, SET *lpMode);
...
__EXTERN INTEGER __CALL_1 GetConsoleScreenBufferInfo(WinApi_PtrVoid hConsoleOutput, WinApi_CONSOLE_SCREEN_BUFFER_INFO *lpConsoleScreenBufferInfo);
...
__EXTERN WinApi_PtrVoid __CALL_1 GetCurrentObject(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_GetCurrentPositionEx(p0, p1, p1__typ)	GetCurrentPositionEx(p0, p1)
__EXTERN INTEGER __CALL_1 GetCurrentPositionEx(WinApi_PtrVoid p0, WinApi_POINT *p1);
#define WinApi_GetCurrentProcess()	GetCurrentProcess()
__EXTERN WinApi_PtrVoid __CALL_1 GetCurrentProcess(void);
...
__EXTERN WinApi_PtrVoid __CALL_1 GetCurrentThread(void);
...
__EXTERN WinApi_PtrVoid __CALL_1 GetCursor(void);
...
__EXTERN WinApi_PtrVoid __CALL_1 GetDC(WinApi_PtrVoid hWnd);
#define WinApi_GetDCEx(hWnd, hrgnClip, flags)	GetDCEx(hWnd, hrgnClip, flags)
__EXTERN WinApi_PtrVoid __CALL_1 GetDCEx(WinApi_PtrVoid hWnd, WinApi_PtrVoid hrgnClip, SET flags);
#define WinApi_GetDCOrgEx(p0, p1, p1__typ)	GetDCOrgEx(p0, p1)
__EXTERN INTEGER __CALL_1 GetDCOrgEx(WinApi_PtrVoid p0, WinApi_POINT *p1);
#define WinApi_GetDIBColorTable(p0, p1, p2, p3, p3__typ)	GetDIBColorTable(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 GetDIBColorTable(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_RGBQUAD *p3);
#define WinApi_GetDIBits(p0, p1, p2, p3, p4, p5, p5__typ, p6)	GetDIBits(p0, p1, p2, p3, p4, p5, p6)
__EXTERN INTEGER __CALL_1 GetDIBits(WinApi_PtrVoid p0, WinApi_PtrVoid p1, INTEGER p2, INTEGER p3, WinApi_PtrVoid p4, WinApi_BITMAPINFO *p5, INTEGER p6);
...
__EXTERN WinApi_PtrVoid __CALL_1 GetDesktopWindow(void);
#define WinApi_GetDeviceCaps(p0, p1)	GetDeviceCaps(p0, p1)
__EXTERN INTEGER __CALL_1 GetDeviceCaps(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_GetDeviceGammaRamp(p0, p1)	GetDeviceGammaRamp(p0, p1)
__EXTERN INTEGER __CALL_1 GetDeviceGammaRamp(WinApi_PtrVoid p0, WinApi_PtrVoid p1);
...
__EXTERN INTEGER __CALL_1 GetDlgCtrlID(WinApi_PtrVoid hWnd);
#define WinApi_GetDlgItem(hDlg, nIDDlgItem)	GetDlgItem(hDlg, nIDDlgItem)
__EXTERN WinApi_PtrVoid __CALL_1 GetDlgItem(WinApi_PtrVoid hDlg, INTEGER nIDDlgItem);
#define WinApi_GetDlgItemInt(hDlg, nIDDlgItem, lpTranslated, bSigned)	GetDlgItemInt(hDlg, nIDDlgItem, lpTranslated, bSigned)
__EXTERN INTEGER __CALL_1 GetDlgItemInt(WinApi_PtrVoid hDlg, INTEGER nIDDlgItem, INTEGER *lpTranslated, INTEGER bSigned);
...
__EXTERN INTEGER __CALL_1 GetDlgItemTextA(WinApi_PtrVoid hDlg, INTEGER nIDDlgItem, WinApi_PtrSTR lpString, INTEGER nMaxCount);
#define WinApi_GetDlgItemTextW(hDlg, nIDDlgItem, lpString, nMaxCount)	GetDlgItemTextW(hDlg, nIDDlgItem, lpString, nMaxCount)
__EXTERN INTEGER __CALL_1 GetDlgItemTextW(WinApi_PtrVoid hDlg, INTEGER nIDDlgItem, WinApi_PtrWSTR lpString, INTEGER nMaxCount);
...
__EXTERN WinApi_PtrVoid __CALL_1 GetEnhMetaFileA(WinApi_PtrSTR p0);
#define WinApi_GetEnhMetaFileBits(p0, p1, p2)	GetEnhMetaFileBits(p0, p1, p2)
__EXTERN INTEGER __CALL_1 GetEnhMetaFileBits(WinApi_PtrVoid p0, INTEGER p1, CHAR *p2);
...
__EXTERN INTEGER __CALL_1 GetEnhMetaFileDescriptionA(WinApi_PtrVoid p0, INTEGER p1, WinApi_PtrSTR p2);
#define WinApi_GetEnhMetaFileDescriptionW(p0, p1, p2)	GetEnhMetaFileDescriptionW(p0, p1, p2)
__EXTERN INTEGER __CALL_1 GetEnhMetaFileDescriptionW(WinApi_PtrVoid p0, INTEGER p1, WinApi_PtrWSTR p2);
#define WinApi_GetEnhMetaFileHeader(p0, p1, p2, p2__typ)	GetEnhMetaFileHeader(p0, p1, p2)
__EXTERN INTEGER __CALL_1 GetEnhMetaFileHeader(WinApi_PtrVoid p0, INTEGER p1, WinApi_ENHMETAHEADER *p2);
#define WinApi_GetEnhMetaFilePaletteEntries(p0, p1, p2, p2__typ)	GetEnhMetaFilePaletteEntries(p0, p1, p2)
__EXTERN INTEGER __CALL_1 GetEnhMetaFilePaletteEntries(WinApi_PtrVoid p0, INTEGER p1, WinApi_PALETTEENTRY *p2);
#define WinApi_GetEnhMetaFilePixelFormat(p0, p1, p2, p2__typ)	GetEnhMetaFilePixelFormat(p0, p1, p2)
__EXTERN INTEGER __CALL_1 GetEnhMetaFilePixelFormat(WinApi_PtrVoid p0, INTEGER p1, WinApi_PIXELFORMATDESCRIPTOR *p2);
#define WinApi_GetEnhMetaFileW(p0)	GetEnhMetaFileW(p0)
__EXTERN WinApi_PtrVoid __CALL_1 GetEnhMetaFileW(WinApi_PtrWSTR p0);
...
__EXTERN INTEGER __CALL_1 GetExitCodeProcess(WinApi_PtrVoid hProcess, INTEGER *lpExitCode);
#define WinApi_GetExitCodeThread(hThread, lpExitCode)	GetExitCodeThread(hThread, lpExitCode)
__EXTERN INTEGER __CALL_1 GetExitCodeThread(WinApi_PtrVoid hThread, INTEGER *lpExitCode);
...
__EXTERN INTEGER __CALL_1 GetFileSecurityA(WinApi_PtrSTR lpFileName, SET RequestedInformation, WinApi_PtrVoid pSecurityDescriptor, INTEGER nLength, INTEGER *lpnLengthNeeded);
...
__EXTERN INTEGER __CALL_1 GetFileSecurityW(WinApi_PtrWSTR lpFileName, SET RequestedInformation, WinApi_PtrVoid pSecurityDescriptor, INTEGER nLength, INTEGER *lpnLengthNeeded);
#define WinApi_GetFileSize(hFile, lpFileSizeHigh)	GetFileSize(hFile, lpFileSizeHigh)
__EXTERN INTEGER __CALL_1 GetFileSize(WinApi_PtrVoid hFile, INTEGER *lpFileSizeHigh);
#define WinApi_GetFileSizeEx(hFile, lpFileSizeHigh)	GetFileSizeEx(hFile, lpFileSizeHigh)
__EXTERN INTEGER __CALL_1 GetFileSizeEx(WinApi_PtrVoid hFile, LONGINT *lpFileSizeHigh);
...
__EXTERN INTEGER __CALL_1 GetFileTime(WinApi_PtrVoid hFile, WinApi_FILETIME *lpCreationTime, WinApi_FILETIME *lpLastAccessTime, WinApi_FILETIME *lpLastWriteTime);
#define WinApi_GetFileType(hFile)	GetFileType(hFile)
__EXTERN INTEGER __CALL_1 GetFileType(WinApi_PtrVoid hFile);
...
__EXTERN INTEGER __CALL_1 GetFileVersionInfoA(WinApi_PtrSTR lptstrFilename, INTEGER dwHandle, INTEGER dwLen, WinApi_PtrVoid lpData);
...
__EXTERN INTEGER __CALL_1 GetFileVersionInfoW(WinApi_PtrWSTR lptstrFilename, INTEGER dwHandle, INTEGER dwLen, WinApi_PtrVoid lpData);
#define WinApi_GetFocus()	GetFocus()
__EXTERN WinApi_PtrVoid __CALL_1 GetFocus(void);
#define WinApi_GetFontData(p0, p1, p2, p3, p4)	GetFontData(p0, p1, p2, p3, p4)
__EXTERN INTEGER __CALL_1 GetFontData(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_PtrVoid p3, INTEGER p4);
#define WinApi_GetFontLanguageInfo(p0)	GetFontLanguageInfo(p0)
__EXTERN SET __CALL_1 GetFontLanguageInfo(WinApi_PtrVoid p0);
#define WinApi_GetForegroundWindow()	GetForegroundWindow()
__EXTERN WinApi_PtrVoid __CALL_1 GetForegroundWindow(void);
...
__EXTERN INTEGER __CALL_1 GetFormA(WinApi_PtrVoid hPrinter, WinApi_PtrSTR pFormName, INTEGER Level, CHAR *pForm, INTEGER cbBuf, INTEGER *pcbNeeded);
...
__EXTERN INTEGER __CALL_1 GetFormW(WinApi_PtrVoid hPrinter, WinApi_PtrWSTR pFormName, INTEGER Level, CHAR *pForm, INTEGER cbBuf, INTEGER *pcbNeeded);
...
__EXTERN INTEGER __CALL_1 GetGlyphOutlineA(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_GLYPHMETRICS *p3, INTEGER p4, WinApi_PtrVoid p5, WinApi_MAT2 *p6);
#define WinApi_GetGlyphOutlineW(p0, p1, p2, p3, p3__typ, p4, p5, p6, p6__typ)	GetGlyphOutlineW(p0, p1, p2, p3, p4, p5, p6)
__EXTERN INTEGER __CALL_1 GetGlyphOutlineW(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_GLYPHMETRICS *p3, INTEGER p4, WinApi_PtrVoid p5, WinApi_MAT2 *p6);
#define WinApi_GetGraphicsMode(p0)	GetGraphicsMode(p0)
__EXTERN INTEGER __CALL_1 GetGraphicsMode(WinApi_PtrVoid p0);
#define WinApi_GetHandleInformation(hObject, lpdwFlags)	GetHandleInformation(hObject, lpdwFlags)
__EXTERN INTEGER __CALL_1 GetHandleInformation(WinApi_PtrVoid hObject, SET *lpdwFlags);
...
__EXTERN INTEGER __CALL_1 GetICMProfileA(WinApi_PtrVoid p0, INTEGER *p1, WinApi_PtrSTR p2);
#define WinApi_GetICMProfileW(p0, p1, p2)	GetICMProfileW(p0, p1, p2)
__EXTERN INTEGER __CALL_1 GetICMProfileW(WinApi_PtrVoid p0, INTEGER *p1, WinApi_PtrWSTR p2);
#define WinApi_GetIconInfo(hIcon, piconinfo, piconinfo__typ)	GetIconInfo(hIcon, piconinfo)
__EXTERN INTEGER __CALL_1 GetIconInfo(WinApi_PtrVoid hIcon, WinApi_ICONINFO *piconinfo);
...
__EXTERN INTEGER __CALL_1 GetJobA(WinApi_PtrVoid hPrinter, INTEGER JobId, INTEGER Level, CHAR *pJob, INTEGER cbBuf, INTEGER *pcbNeeded);
#define WinApi_GetJobW(hPrinter, JobId, Level, pJob, cbBuf, pcbNeeded)	GetJobW(hPrinter, JobId, Level, pJob, cbBuf, pcbNeeded)
__EXTERN INTEGER __CALL_1 GetJobW(WinApi_PtrVoid hPrinter, INTEGER JobId, INTEGER Level, CHAR *pJob, INTEGER cbBuf, INTEGER *pcbNeeded);
...
__EXTERN INTEGER __CALL_1 GetKernelObjectSecurity(WinApi_PtrVoid Handle, SET RequestedInformation, WinApi_PtrVoid pSecurityDescriptor, INTEGER nLength, INTEGER *lpnLengthNeeded);
...
__EXTERN INTEGER __CALL_1 GetKerningPairsA(WinApi_PtrVoid p0, INTEGER p1, WinApi_KERNINGPAIR *p2);
#define WinApi_GetKerningPairsW(p0, p1, p2, p2__typ)	GetKerningPairsW(p0, p1, p2)
__EXTERN INTEGER __CALL_1 GetKerningPairsW(WinApi_PtrVoid p0, INTEGER p1, WinApi_KERNINGPAIR *p2);
...
__EXTERN WinApi_PtrVoid __CALL_1 GetKeyboardLayout(INTEGER dwLayout);
#define WinApi_GetKeyboardLayoutList(nBuff, lpList)	GetKeyboardLayoutList(nBuff, lpList)
__EXTERN INTEGER __CALL_1 GetKeyboardLayoutList(INTEGER nBuff, WinApi_PtrVoid *lpList);
...
__EXTERN INTEGER __CALL_1 GetLargestConsoleWindowSize(WinApi_PtrVoid hConsoleOutput);
#define WinApi_GetLastActivePopup(hWnd)	GetLastActivePopup(hWnd)
__EXTERN WinApi_PtrVoid __CALL_1 GetLastActivePopup(WinApi_PtrVoid hWnd);
...
__EXTERN INTEGER __CALL_1 GetLengthSid(WinApi_PtrVoid pSid);
...
__EXTERN INTEGER __CALL_1 GetLogColorSpaceA(WinApi_PtrVoid p0, WinApi_LOGCOLORSPACEA *p1, INTEGER p2);
#define WinApi_GetLogColorSpaceW(p0, p1, p1__typ, p2)	GetLogColorSpaceW(p0, p1, p2)
__EXTERN INTEGER __CALL_1 GetLogColorSpaceW(WinApi_PtrVoid p0, WinApi_LOGCOLORSPACEW *p1, INTEGER p2);
...
__EXTERN INTEGER __CALL_1 GetMailslotInfo(WinApi_PtrVoid hMailslot, INTEGER *lpMaxMessageSize, INTEGER *lpNextSize, INTEGER *lpMessageCount, INTEGER *lpReadTimeout);
#define WinApi_GetMapMode(p0)	GetMapMode(p0)
__EXTERN INTEGER __CALL_1 GetMapMode(WinApi_PtrVoid p0);
#define WinApi_GetMenu(hWnd)	GetMenu(hWnd)
__EXTERN WinApi_PtrVoid __CALL_1 GetMenu(WinApi_PtrVoid hWnd);
...
__EXTERN INTEGER __CALL_1 GetMenuContextHelpId(WinApi_PtrVoid p0);
#define WinApi_GetMenuDefaultItem(hMenu, fByPos, gmdiFlags)	GetMenuDefaultItem(hMenu, fByPos, gmdiFlags)
__EXTERN INTEGER __CALL_1 GetMenuDefaultItem(WinApi_PtrVoid hMenu, INTEGER fByPos, SET gmdiFlags);
#define WinApi_GetMenuItemCount(hMenu)	GetMenuItemCount(hMenu)
__EXTERN INTEGER __CALL_1 GetMenuItemCount(WinApi_PtrVoid hMenu);
#define WinApi_GetMenuItemID(hMenu, nPos)	GetMenuItemID(hMenu, nPos)
__EXTERN INTEGER __CALL_1 GetMenuItemID(WinApi_PtrVoid hMenu, INTEGER nPos);
...
__EXTERN INTEGER __CALL_1 GetMenuItemInfoA(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_MENUITEMINFOA *p3);
#define WinApi_GetMenuItemInfoW(p0, p1, p2, p3, p3__typ)	GetMenuItemInfoW(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 GetMenuItemInfoW(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_MENUITEMINFOW *p3);
#define WinApi_GetMenuItemRect(hWnd, hMenu, uItem, lprcItem, lprcItem__typ)	GetMenuItemRect(hWnd, hMenu, uItem, lprcItem)
__EXTERN INTEGER __CALL_1 GetMenuItemRect(WinApi_PtrVoid hWnd, WinApi_PtrVoid hMenu, INTEGER uItem, WinApi_RECT *lprcItem);
#define WinApi_GetMenuState(hMenu, uId, uFlags)	GetMenuState(hMenu, uId, uFlags)
__EXTERN INTEGER __CALL_1 GetMenuState(WinApi_PtrVoid hMenu, INTEGER uId, SET uFlags);
...
__EXTERN INTEGER __CALL_1 GetMenuStringA(WinApi_PtrVoid hMenu, INTEGER uIDItem, WinApi_PtrSTR lpString, INTEGER nMaxCount, SET uFlag);
...
__EXTERN INTEGER __CALL_1 GetMenuStringW(WinApi_PtrVoid hMenu, INTEGER uIDItem, WinApi_PtrWSTR lpString, INTEGER nMaxCount, SET uFlag);
...
__EXTERN INTEGER __CALL_1 GetMessageA(WinApi_MSG *lpMsg, WinApi_PtrVoid hWnd, INTEGER wMsgFilterMin, INTEGER wMsgFilterMax);
...
__EXTERN INTEGER __CALL_1 GetMessageW(WinApi_MSG *lpMsg, WinApi_PtrVoid hWnd, INTEGER wMsgFilterMin, INTEGER wMsgFilterMax);
#define WinApi_GetMetaFile(p0)	GetMetaFileA(p0)
#define WinApi_GetMetaFileA(p0)	GetMetaFileA(p0)
__EXTERN WinApi_PtrVoid __CALL_1 GetMetaFileA(WinApi_PtrSTR p0);
#define WinApi_GetMetaFileBitsEx(p0, p1, p2, p2__len)	GetMetaFileBitsEx(p0, p1, p2)
__EXTERN INTEGER __CALL_1 GetMetaFileBitsEx(WinApi_PtrVoid p0, INTEGER p1, BYTE *p2);
#define WinApi_GetMetaFileW(p0)	GetMetaFileW(p0)
__EXTERN WinApi_PtrVoid __CALL_1 GetMetaFileW(WinApi_PtrWSTR p0);
#define WinApi_GetMetaRgn(p0, p1)	GetMetaRgn(p0, p1)
__EXTERN INTEGER __CALL_1 GetMetaRgn(WinApi_PtrVoid p0, WinApi_PtrVoid p1);
#define WinApi_GetMiterLimit(p0, p1)	GetMiterLimit(p0, p1)
__EXTERN INTEGER __CALL_1 GetMiterLimit(WinApi_PtrVoid p0, REAL *p1);
...
__EXTERN INTEGER __CALL_1 GetModuleFileNameA(WinApi_PtrVoid hModule, WinApi_PtrSTR lpFilename, INTEGER nSize);
#define WinApi_GetModuleFileNameW(hModule, lpFilename, nSize)	GetModuleFileNameW(hModule, lpFilename, nSize)
__EXTERN INTEGER __CALL_1 GetModuleFileNameW(WinApi_PtrVoid hModule, WinApi_PtrWSTR lpFilename, INTEGER nSize);
...
__EXTERN WinApi_PtrVoid __CALL_1 GetModuleHandleA(WinApi_PtrSTR lpModuleName);
#define WinApi_GetModuleHandleW(lpModuleName)	GetModuleHandleW(lpModuleName)
__EXTERN WinApi_PtrVoid __CALL_1 GetModuleHandleW(WinApi_PtrWSTR lpModuleName);
...
__EXTERN INTEGER __CALL_1 GetNamedPipeHandleStateA(WinApi_PtrVoid hNamedPipe, INTEGER *lpState, INTEGER *lpCurInstances, INTEGER *lpMaxCollectionCount, INTEGER *lpCollectDataTimeout, WinApi_PtrSTR lpUserName, INTEGER nMaxUserNameSize);
...
__EXTERN INTEGER __CALL_1 GetNamedPipeHandleStateW(WinApi_PtrVoid hNamedPipe, INTEGER *lpState, INTEGER *lpCurInstances, INTEGER *lpMaxCollectionCount, INTEGER *lpCollectDataTimeout, WinApi_PtrWSTR lpUserName, INTEGER nMaxUserNameSize);
...
__EXTERN INTEGER __CALL_1 GetNamedPipeInfo(WinApi_PtrVoid hNamedPipe, INTEGER *lpFlags, INTEGER *lpOutBufferSize, INTEGER *lpInBufferSize, INTEGER *lpMaxInstances);
#define WinApi_GetNearestColor(p0, p1)	GetNearestColor(p0, p1)
__EXTERN INTEGER __CALL_1 GetNearestColor(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_GetNearestPaletteIndex(p0, p1)	GetNearestPaletteIndex(p0, p1)
__EXTERN INTEGER __CALL_1 GetNearestPaletteIndex(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_GetNextDlgGroupItem(hDlg, hCtl, bPrevious)	GetNextDlgGroupItem(hDlg, hCtl, bPrevious)
__EXTERN WinApi_PtrVoid __CALL_1 GetNextDlgGroupItem(WinApi_PtrVoid hDlg, WinApi_PtrVoid hCtl, INTEGER bPrevious);
#define WinApi_GetNextDlgTabItem(hDlg, hCtl, bPrevious)	GetNextDlgTabItem(hDlg, hCtl, bPrevious)
__EXTERN WinApi_PtrVoid __CALL_1 GetNextDlgTabItem(WinApi_PtrVoid hDlg, WinApi_PtrVoid hCtl, INTEGER bPrevious);
...
__EXTERN INTEGER __CALL_1 GetNumberOfConsoleInputEvents(WinApi_PtrVoid hConsoleInput, INTEGER *lpNumberOfEvents);
...
__EXTERN INTEGER __CALL_1 GetNumberOfEventLogRecords(WinApi_PtrVoid hEventLog, INTEGER *NumberOfRecords);
...
__EXTERN INTEGER __CALL_1 GetObjectA(WinApi_PtrVoid p0, INTEGER p1, WinApi_PtrVoid p2);
#define WinApi_GetObjectType(h)	GetObjectType(h)
__EXTERN INTEGER __CALL_1 GetObjectType(WinApi_PtrVoid h);
#define WinApi_GetObjectW(p0, p1, p2)	GetObjectW(p0, p1, p2)
__EXTERN INTEGER __CALL_1 GetObjectW(WinApi_PtrVoid p0, INTEGER p1, WinApi_PtrVoid p2);
#define WinApi_GetOldestEventLogRecord(hEventLog, OldestRecord)	GetOldestEventLogRecord(hEventLog, OldestRecord)
__EXTERN INTEGER __CALL_1 GetOldestEventLogRecord(WinApi_PtrVoid hEventLog, INTEGER *OldestRecord);
#define WinApi_GetOpenClipboardWindow()	GetOpenClipboardWindow()
__EXTERN WinApi_PtrVoid __CALL_1 GetOpenClipboardWindow(void);
...
__EXTERN INTEGER __CALL_1 GetOutlineTextMetricsA(WinApi_PtrVoid p0, INTEGER p1, WinApi_OUTLINETEXTMETRICA *p2);
#define WinApi_GetOutlineTextMetricsW(p0, p1, p2, p2__typ)	GetOutlineTextMetricsW(p0, p1, p2)
__EXTERN INTEGER __CALL_1 GetOutlineTextMetricsW(WinApi_PtrVoid p0, INTEGER p1, WinApi_OUTLINETEXTMETRICW *p2);
...
__EXTERN INTEGER __CALL_1 GetOverlappedResult(WinApi_PtrVoid hFile, WinApi_OVERLAPPED *lpOverlapped, INTEGER *lpNumberOfBytesTransferred, INTEGER bWait);
#define WinApi_GetPaletteEntries(p0, p1, p2, p3, p3__typ)	GetPaletteEntries(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 GetPaletteEntries(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_PALETTEENTRY *p3);
#define WinApi_GetParent(hWnd)	GetParent(hWnd)
__EXTERN WinApi_PtrVoid __CALL_1 GetParent(WinApi_PtrVoid hWnd);
#define WinApi_GetPath(p0, p1, p1__typ, p2, p3)	GetPath(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 GetPath(WinApi_PtrVoid p0, WinApi_POINT *p1, CHAR *p2, INTEGER p3);
#define WinApi_GetPixel(p0, p1, p2)	GetPixel(p0, p1, p2)
__EXTERN INTEGER __CALL_1 GetPixel(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2);
#define WinApi_GetPixelFormat(p0)	GetPixelFormat(p0)
__EXTERN INTEGER __CALL_1 GetPixelFormat(WinApi_PtrVoid p0);
#define WinApi_GetPolyFillMode(p0)	GetPolyFillMode(p0)
__EXTERN INTEGER __CALL_1 GetPolyFillMode(WinApi_PtrVoid p0);
...
__EXTERN INTEGER __CALL_1 GetPrinterA(WinApi_PtrVoid hPrinter, INTEGER Level, CHAR *pPrinter, INTEGER cbBuf, INTEGER *pcbNeeded);
...
__EXTERN INTEGER __CALL_1 GetPrinterDataA(WinApi_PtrVoid hPrinter, WinApi_PtrSTR pValueName, INTEGER *pType, CHAR *pData, INTEGER nSize, INTEGER *pcbNeeded);
...
__EXTERN INTEGER __CALL_1 GetPrinterDataW(WinApi_PtrVoid hPrinter, WinApi_PtrWSTR pValueName, INTEGER *pType, CHAR *pData, INTEGER nSize, INTEGER *pcbNeeded);
...
__EXTERN INTEGER __CALL_1 GetPrinterDriverA(WinApi_PtrVoid hPrinter, WinApi_PtrSTR pEnvironment, INTEGER Level, CHAR *pDriverInfo, INTEGER cbBuf, INTEGER *pcbNeeded);
...
__EXTERN INTEGER __CALL_1 GetPrinterDriverW(WinApi_PtrVoid hPrinter, WinApi_PtrWSTR pEnvironment, INTEGER Level, CHAR *pDriverInfo, INTEGER cbBuf, INTEGER *pcbNeeded);
#define WinApi_GetPrinterW(hPrinter, Level, pPrinter, cbBuf, pcbNeeded)	GetPrinterW(hPrinter, Level, pPrinter, cbBuf, pcbNeeded)
__EXTERN INTEGER __CALL_1 GetPrinterW(WinApi_PtrVoid hPrinter, INTEGER Level, CHAR *pPrinter, INTEGER cbBuf, INTEGER *pcbNeeded);
#define WinApi_GetPriorityClass(hProcess)	GetPriorityClass(hProcess)
__EXTERN INTEGER __CALL_1 GetPriorityClass(WinApi_PtrVoid hProcess);
...
__EXTERN INTEGER __CALL_1 GetPrivateObjectSecurity(WinApi_PtrVoid ObjectDescriptor, SET SecurityInformation, WinApi_PtrVoid ResultantDescriptor, INTEGER DescriptorLength, INTEGER *ReturnLength);
...
__EXTERN INTEGER __CALL_1 GetPrivateProfileStructA(WinApi_PtrSTR lpszSection, WinApi_PtrSTR lpszKey, WinApi_PtrVoid lpStruct, INTEGER uSizeStruct, WinApi_PtrSTR szFile);
...
__EXTERN INTEGER __CALL_1 GetPrivateProfileStructW(WinApi_PtrWSTR lpszSection, WinApi_PtrWSTR lpszKey, WinApi_PtrVoid lpStruct, INTEGER uSizeStruct, WinApi_PtrWSTR szFile);
#define WinApi_GetProcAddress(hModule, lpProcName)	GetProcAddress(hModule, lpProcName)
__EXTERN WinApi_FARPROC __CALL_1 GetProcAddress(WinApi_PtrVoid hModule, WinApi_PtrSTR lpProcName);
...
__EXTERN INTEGER __CALL_1 GetProcessAffinityMask(WinApi_PtrVoid hProcess, INTEGER *lpProcessAffinityMask, INTEGER *lpSystemAffinityMask);
#define WinApi_GetProcessHeap()	GetProcessHeap()
__EXTERN WinApi_PtrVoid __CALL_1 GetProcessHeap(void);
#define WinApi_GetProcessHeaps(NumberOfHeaps, ProcessHeaps)	GetProcessHeaps(NumberOfHeaps, ProcessHeaps)
__EXTERN INTEGER __CALL_1 GetProcessHeaps(INTEGER NumberOfHeaps, WinApi_PtrVoid *ProcessHeaps);
...
__EXTERN INTEGER __CALL_1 GetProcessTimes(WinApi_PtrVoid hProcess, WinApi_FILETIME *lpCreationTime, WinApi_FILETIME *lpExitTime, WinApi_FILETIME *lpKernelTime, WinApi_FILETIME *lpUserTime);
...
__EXTERN WinApi_PtrVoid __CALL_1 GetProcessWindowStation(void);
...
__EXTERN INTEGER __CALL_1 GetProcessWorkingSetSize(WinApi_PtrVoid hProcess, INTEGER *lpMinimumWorkingSetSize, INTEGER *lpMaximumWorkingSetSize);
...
__EXTERN WinApi_PtrVoid __CALL_1 GetPropA(WinApi_PtrVoid hWnd, WinApi_PtrSTR lpString);
#define WinApi_GetPropW(hWnd, lpString)	GetPropW(hWnd, lpString)
__EXTERN WinApi_PtrVoid __CALL_1 GetPropW(WinApi_PtrVoid hWnd, WinApi_PtrWSTR lpString);
...
__EXTERN INTEGER __CALL_1 GetQueuedCompletionStatus(WinApi_PtrVoid CompletionPort, INTEGER *lpNumberOfBytesTransferred, INTEGER *lpCompletionKey, WinApi_PtrOVERLAPPED *lpOverlapped, INTEGER dwMilliseconds);
#define WinApi_GetROP2(p0)	GetROP2(p0)
__EXTERN INTEGER __CALL_1 GetROP2(WinApi_PtrVoid p0);
...
__EXTERN INTEGER __CALL_1 GetRegionData(WinApi_PtrVoid p0, INTEGER p1, WinApi_RGNDATA *p2);
#define WinApi_GetRgnBox(p0, p1, p1__typ)	GetRgnBox(p0, p1)
__EXTERN INTEGER __CALL_1 GetRgnBox(WinApi_PtrVoid p0, WinApi_RECT *p1);
#define WinApi_GetScrollInfo(p0, p1, p2, p2__typ)	GetScrollInfo(p0, p1, p2)
__EXTERN INTEGER __CALL_1 GetScrollInfo(WinApi_PtrVoid p0, INTEGER p1, WinApi_SCROLLINFO *p2);
#define WinApi_GetScrollPos(hWnd, nBar)	GetScrollPos(hWnd, nBar)
__EXTERN INTEGER __CALL_1 GetScrollPos(WinApi_PtrVoid hWnd, INTEGER nBar);
#define WinApi_GetScrollRange(hWnd, nBar, lpMinPos, lpMaxPos)	GetScrollRange(hWnd, nBar, lpMinPos, lpMaxPos)
__EXTERN INTEGER __CALL_1 GetScrollRange(WinApi_PtrVoid hWnd, INTEGER nBar, INTEGER *lpMinPos, INTEGER *lpMaxPos);
...
__EXTERN INTEGER __CALL_1 GetSecurityDescriptorControl(WinApi_PtrVoid pSecurityDescriptor, SHORTINT *pControl, INTEGER *lpdwRevision);
...
__EXTERN INTEGER __CALL_1 GetSecurityDescriptorDacl(WinApi_PtrVoid pSecurityDescriptor, INTEGER *lpbDaclPresent, WinApi_PtrACL *pDacl, INTEGER *lpbDaclDefaulted);
...
__EXTERN INTEGER __CALL_1 GetSecurityDescriptorGroup(WinApi_PtrVoid pSecurityDescriptor, WinApi_PtrVoid *pGroup, INTEGER *lpbGroupDefaulted);
#define WinApi_GetSecurityDescriptorLength(pSecurityDescriptor)	GetSecurityDescriptorLength(pSecurityDescriptor)
__EXTERN INTEGER __CALL_1 GetSecurityDescriptorLength(WinApi_PtrVoid pSecurityDescriptor);
...
__EXTERN INTEGER __CALL_1 GetSecurityDescriptorOwner(WinApi_PtrVoid pSecurityDescriptor, WinApi_PtrVoid *pOwner, INTEGER *lpbOwnerDefaulted);
...
__EXTERN INTEGER __CALL_1 GetSecurityDescriptorSacl(WinApi_PtrVoid pSecurityDescriptor, INTEGER *lpbSaclPresent, WinApi_PtrACL *pSacl, INTEGER *lpbSaclDefaulted);
...
__EXTERN INTEGER __CALL_1 GetServiceDisplayNameA(WinApi_PtrVoid hSCManager, WinApi_PtrSTR lpServiceName, WinApi_PtrSTR lpDisplayName, INTEGER *lpcchBuffer);
...
__EXTERN INTEGER __CALL_1 GetServiceDisplayNameW(WinApi_PtrVoid hSCManager, WinApi_PtrWSTR lpServiceName, WinApi_PtrWSTR lpDisplayName, INTEGER *lpcchBuffer);
...
__EXTERN INTEGER __CALL_1 GetServiceKeyNameA(WinApi_PtrVoid hSCManager, WinApi_PtrSTR lpDisplayName, WinApi_PtrSTR lpServiceName, INTEGER *lpcchBuffer);
...
__EXTERN INTEGER __CALL_1 GetServiceKeyNameW(WinApi_PtrVoid hSCManager, WinApi_PtrWSTR lpDisplayName, WinApi_PtrWSTR lpServiceName, INTEGER *lpcchBuffer);
...
__EXTERN WinApi_PtrSID_IDENTIFIER_AUTHORITY __CALL_1 GetSidIdentifierAuthority(WinApi_PtrVoid pSid);
...
__EXTERN WinApi_RetGetSidSubAuthority __CALL_1 GetSidSubAuthority(WinApi_PtrVoid pSid, INTEGER nSubAuthority);
#define WinApi_GetSidSubAuthorityCount(pSid)	GetSidSubAuthorityCount(pSid)
__EXTERN WinApi_PtrSTR __CALL_1 GetSidSubAuthorityCount(WinApi_PtrVoid pSid);
...
__EXTERN WinApi_PtrVoid __CALL_1 GetStdHandle(INTEGER nStdHandle);
#define WinApi_GetStockObject(p0)	GetStockObject(p0)
__EXTERN WinApi_PtrVoid __CALL_1 GetStockObject(INTEGER p0);
#define WinApi_GetStretchBltMode(p0)	GetStretchBltMode(p0)
__EXTERN INTEGER __CALL_1 GetStretchBltMode(WinApi_PtrVoid p0);
...
__EXTERN WinApi_PtrVoid __CALL_1 GetSubMenu(WinApi_PtrVoid hMenu, INTEGER nPos);
...
__EXTERN WinApi_PtrVoid __CALL_1 GetSysColorBrush(INTEGER nIndex);
...
__EXTERN WinApi_PtrVoid __CALL_1 GetSystemMenu(WinApi_PtrVoid hWnd, INTEGER bRevert);
...
__EXTERN INTEGER __CALL_1 GetSystemPaletteEntries(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_PALETTEENTRY *p3);
#define WinApi_GetSystemPaletteUse(p0)	GetSystemPaletteUse(p0)
__EXTERN INTEGER __CALL_1 GetSystemPaletteUse(WinApi_PtrVoid p0);
...
__EXTERN INTEGER __CALL_1 GetTabbedTextExtentA(WinApi_PtrVoid hDC, WinApi_PtrSTR lpString, INTEGER nCount, INTEGER nTabPositions, INTEGER *lpnTabStopPositions);
...
__EXTERN INTEGER __CALL_1 GetTabbedTextExtentW(WinApi_PtrVoid hDC, WinApi_PtrWSTR lpString, INTEGER nCount, INTEGER nTabPositions, INTEGER *lpnTabStopPositions);
...
__EXTERN INTEGER __CALL_1 GetTapeParameters(WinApi_PtrVoid hDevice, INTEGER dwOperation, INTEGER *lpdwSize, WinApi_PtrVoid lpTapeInformation);
...
__EXTERN INTEGER __CALL_1 GetTapePosition(WinApi_PtrVoid hDevice, INTEGER dwPositionType, INTEGER *lpdwPartition, INTEGER *lpdwOffsetLow, INTEGER *lpdwOffsetHigh);
#define WinApi_GetTapeStatus(hDevice)	GetTapeStatus(hDevice)
__EXTERN INTEGER __CALL_1 GetTapeStatus(WinApi_PtrVoid hDevice);
...
__EXTERN SET __CALL_1 GetTextAlign(WinApi_PtrVoid p0);
#define WinApi_GetTextCharacterExtra(p0)	GetTextCharacterExtra(p0)
__EXTERN INTEGER __CALL_1 GetTextCharacterExtra(WinApi_PtrVoid p0);
#define WinApi_GetTextCharset(hdc)	GetTextCharset(hdc)
__EXTERN INTEGER __CALL_1 GetTextCharset(WinApi_PtrVoid hdc);
#define WinApi_GetTextCharsetInfo(hdc, lpSig, lpSig__typ, dwFlags)	GetTextCharsetInfo(hdc, lpSig, dwFlags)
__EXTERN INTEGER __CALL_1 GetTextCharsetInfo(WinApi_PtrVoid hdc, WinApi_FONTSIGNATURE *lpSig, SET dwFlags);
#define WinApi_GetTextColor(p0)	GetTextColor(p0)
__EXTERN INTEGER __CALL_1 GetTextColor(WinApi_PtrVoid p0);
...
__EXTERN INTEGER __CALL_1 GetTextExtentExPointA(WinApi_PtrVoid p0, WinApi_PtrSTR p1, INTEGER p2, INTEGER p3, INTEGER *p4, INTEGER *p5, WinApi_SIZE *p6);
#define WinApi_GetTextExtentExPointW(p0, p1, p2, p3, p4, p5, p6, p6__typ)	GetTextExtentExPointW(p0, p1, p2, p3, p4, p5, p6)
__EXTERN INTEGER __CALL_1 GetTextExtentExPointW(WinApi_PtrVoid p0, WinApi_PtrWSTR p1, INTEGER p2, INTEGER p3, INTEGER *p4, INTEGER *p5, WinApi_SIZE *p6);
...
__EXTERN INTEGER __CALL_1 GetTextExtentPoint32A(WinApi_PtrVoid p0, WinApi_PtrSTR p1, INTEGER p2, WinApi_SIZE *p3);
#define WinApi_GetTextExtentPoint32W(p0, p1, p2, p3, p3__typ)	GetTextExtentPoint32W(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 GetTextExtentPoint32W(WinApi_PtrVoid p0, WinApi_PtrWSTR p1, INTEGER p2, WinApi_SIZE *p3);
#define WinApi_GetTextExtentPointA(p0, p1, p2, p3, p3__typ)	GetTextExtentPointA(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 GetTextExtentPointA(WinApi_PtrVoid p0, WinApi_PtrSTR p1, INTEGER p2, WinApi_SIZE *p3);
#define WinApi_GetTextExtentPointW(p0, p1, p2, p3, p3__typ)	GetTextExtentPointW(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 GetTextExtentPointW(WinApi_PtrVoid p0, WinApi_PtrWSTR p1, INTEGER p2, WinApi_SIZE *p3);
#define WinApi_GetTextFace(p0, p1, p2)	GetTextFaceA(p0, p1, p2)
#define WinApi_GetTextFaceA(p0, p1, p2)	GetTextFaceA(p0, p1, p2)
__EXTERN INTEGER __CALL_1 GetTextFaceA(WinApi_PtrVoid p0, INTEGER p1, WinApi_PtrSTR p2);
#define WinApi_GetTextFaceW(p0, p1, p2)	GetTextFaceW(p0, p1, p2)
__EXTERN INTEGER __CALL_1 GetTextFaceW(WinApi_PtrVoid p0, INTEGER p1, WinApi_PtrWSTR p2);
...
__EXTERN INTEGER __CALL_1 GetTextMetricsA(WinApi_PtrVoid p0, WinApi_TEXTMETRICA *p1);
#define WinApi_GetTextMetricsW(p0, p1, p1__typ)	GetTextMetricsW(p0, p1)
__EXTERN INTEGER __CALL_1 GetTextMetricsW(WinApi_PtrVoid p0, WinApi_TEXTMETRICW *p1);
#define WinApi_GetThreadContext(hThread, lpContext, lpContext__typ)	GetThreadContext(hThread, lpContext)
__EXTERN INTEGER __CALL_1 GetThreadContext(WinApi_PtrVoid hThread, WinApi_CONTEXT *lpContext);
#define WinApi_GetThreadDesktop(dwThreadId)	GetThreadDesktop(dwThreadId)
__EXTERN WinApi_PtrVoid __CALL_1 GetThreadDesktop(INTEGER dwThreadId);
...
__EXTERN INTEGER __CALL_1 GetThreadPriority(WinApi_PtrVoid hThread);
#define WinApi_GetThreadPriorityBoost(hThread, pDisablePriorityBoost)	GetThreadPriorityBoost(hThread, pDisablePriorityBoost)
__EXTERN INTEGER __CALL_1 GetThreadPriorityBoost(WinApi_PtrVoid hThread, INTEGER *pDisablePriorityBoost);
...
__EXTERN INTEGER __CALL_1 GetThreadSelectorEntry(WinApi_PtrVoid hThread, INTEGER dwSelector, WinApi_LDT_ENTRY *lpSelectorEntry);
...
__EXTERN INTEGER __CALL_1 GetThreadTimes(WinApi_PtrVoid hThread, WinApi_FILETIME *lpCreationTime, WinApi_FILETIME *lpExitTime, WinApi_FILETIME *lpKernelTime, WinApi_FILETIME *lpUserTime);
...
__EXTERN INTEGER __CALL_1 GetTokenInformation(WinApi_PtrVoid TokenHandle, INTEGER TokenInformationClass, WinApi_PtrVoid TokenInformation, INTEGER TokenInformationLength, INTEGER *ReturnLength);
#define WinApi_GetTopWindow(hWnd)	GetTopWindow(hWnd)
__EXTERN WinApi_PtrVoid __CALL_1 GetTopWindow(WinApi_PtrVoid hWnd);
#define WinApi_GetUpdateRect(hWnd, lpRect, lpRect__typ, bErase)	GetUpdateRect(hWnd, lpRect, bErase)
__EXTERN INTEGER __CALL_1 GetUpdateRect(WinApi_PtrVoid hWnd, WinApi_RECT *lpRect, INTEGER bErase);
#define WinApi_GetUpdateRgn(hWnd, hRgn, bErase)	GetUpdateRgn(hWnd, hRgn, bErase)
__EXTERN INTEGER __CALL_1 GetUpdateRgn(WinApi_PtrVoid hWnd, WinApi_PtrVoid hRgn, INTEGER bErase);
...
__EXTERN INTEGER __CALL_1 GetUserObjectInformationA(WinApi_PtrVoid hObj, INTEGER nIndex, WinApi_PtrVoid pvInfo, INTEGER nLength, INTEGER *lpnLengthNeeded);
...
__EXTERN INTEGER __CALL_1 GetUserObjectInformationW(WinApi_PtrVoid hObj, INTEGER nIndex, WinApi_PtrVoid pvInfo, INTEGER nLength, INTEGER *lpnLengthNeeded);
...
__EXTERN INTEGER __CALL_1 GetUserObjectSecurity(WinApi_PtrVoid hObj, INTEGER *pSIRequested, WinApi_PtrVoid pSID, INTEGER nLength, INTEGER *lpnLengthNeeded);
...
__EXTERN INTEGER __CALL_1 GetViewportExtEx(WinApi_PtrVoid p0, WinApi_SIZE *p1);
#define WinApi_GetViewportOrgEx(p0, p1, p1__typ)	GetViewportOrgEx(p0, p1)
__EXTERN INTEGER __CALL_1 GetViewportOrgEx(WinApi_PtrVoid p0, WinApi_POINT *p1);
...
__EXTERN INTEGER __CALL_1 GetWinMetaFileBits(WinApi_PtrVoid p0, INTEGER p1, CHAR *p2, INTEGER p3, WinApi_PtrVoid p4);
#define WinApi_GetWindow(hWnd, uCmd)	GetWindow(hWnd, uCmd)
__EXTERN WinApi_PtrVoid __CALL_1 GetWindow(WinApi_PtrVoid hWnd, INTEGER uCmd);
#define WinApi_GetWindowContextHelpId(p0)	GetWindowContextHelpId(p0)
__EXTERN INTEGER __CALL_1 GetWindowContextHelpId(WinApi_PtrVoid p0);
#define WinApi_GetWindowDC(hWnd)	GetWindowDC(hWnd)
__EXTERN WinApi_PtrVoid __CALL_1 GetWindowDC(WinApi_PtrVoid hWnd);
#define WinApi_GetWindowExtEx(p0, p1, p1__typ)	GetWindowExtEx(p0, p1)
__EXTERN INTEGER __CALL_1 GetWindowExtEx(WinApi_PtrVoid p0, WinApi_SIZE *p1);
...
__EXTERN INTEGER __CALL_1 GetWindowLongA(WinApi_PtrVoid hWnd, INTEGER nIndex);
#define WinApi_GetWindowLongW(hWnd, nIndex)	GetWindowLongW(hWnd, nIndex)
__EXTERN INTEGER __CALL_1 GetWindowLongW(WinApi_PtrVoid hWnd, INTEGER nIndex);
#define WinApi_GetWindowOrgEx(p0, p1, p1__typ)	GetWindowOrgEx(p0, p1)
__EXTERN INTEGER __CALL_1 GetWindowOrgEx(WinApi_PtrVoid p0, WinApi_POINT *p1);
#define WinApi_GetWindowPlacement(hWnd, lpwndpl, lpwndpl__typ)	GetWindowPlacement(hWnd, lpwndpl)
__EXTERN INTEGER __CALL_1 GetWindowPlacement(WinApi_PtrVoid hWnd, WinApi_WINDOWPLACEMENT *lpwndpl);
#define WinApi_GetWindowRect(hWnd, lpRect, lpRect__typ)	GetWindowRect(hWnd, lpRect)
__EXTERN INTEGER __CALL_1 GetWindowRect(WinApi_PtrVoid hWnd, WinApi_RECT *lpRect);
#define WinApi_GetWindowRgn(hWnd, hRgn)	GetWindowRgn(hWnd, hRgn)
__EXTERN INTEGER __CALL_1 GetWindowRgn(WinApi_PtrVoid hWnd, WinApi_PtrVoid hRgn);
...
__EXTERN INTEGER __CALL_1 GetWindowTextA(WinApi_PtrVoid hWnd, WinApi_PtrSTR lpString, INTEGER nMaxCount);
...
__EXTERN INTEGER __CALL_1 GetWindowTextLengthA(WinApi_PtrVoid hWnd);
#define WinApi_GetWindowTextLengthW(hWnd)	GetWindowTextLengthW(hWnd)
__EXTERN INTEGER __CALL_1 GetWindowTextLengthW(WinApi_PtrVoid hWnd);
#define WinApi_GetWindowTextW(hWnd, lpString, nMaxCount)	GetWindowTextW(hWnd, lpString, nMaxCount)
__EXTERN INTEGER __CALL_1 GetWindowTextW(WinApi_PtrVoid hWnd, WinApi_PtrWSTR lpString, INTEGER nMaxCount);
#define WinApi_GetWindowThreadProcessId(hWnd, lpdwProcessId)	GetWindowThreadProcessId(hWnd, lpdwProcessId)
__EXTERN INTEGER __CALL_1 GetWindowThreadProcessId(WinApi_PtrVoid hWnd, INTEGER *lpdwProcessId);
#define WinApi_GetWindowWord(hWnd, nIndex)	GetWindowWord(hWnd, nIndex)
__EXTERN SHORTINT __CALL_1 GetWindowWord(WinApi_PtrVoid hWnd, INTEGER nIndex);
...
__EXTERN INTEGER __CALL_1 GetWorldTransform(WinApi_PtrVoid p0, WinApi_XFORM *p1);
...
__EXTERN WinApi_PtrVoid __CALL_1 GlobalAlloc(SET uFlags, WinApi_SIZE_T dwBytes);
#define WinApi_GlobalCompact(dwMinFree)	GlobalCompact(dwMinFree)
__EXTERN WinApi_SIZE_T __CALL_1 GlobalCompact(INTEGER dwMinFree);
...
__EXTERN void __CALL_1 GlobalFix(WinApi_PtrVoid hMem);
#define WinApi_GlobalFlags(hMem)	GlobalFlags(hMem)
__EXTERN INTEGER __CALL_1 GlobalFlags(WinApi_PtrVoid hMem);
#define WinApi_GlobalFree(hMem)	GlobalFree(hMem)
__EXTERN WinApi_PtrVoid __CALL_1 GlobalFree(WinApi_PtrVoid hMem);
...
__EXTERN WinApi_PtrVoid __CALL_1 GlobalHandle(WinApi_PtrVoid pMem);
#define WinApi_GlobalLock(hMem)	GlobalLock(hMem)
__EXTERN WinApi_PtrVoid __CALL_1 GlobalLock(WinApi_PtrVoid hMem);
...
__EXTERN WinApi_PtrVoid __CALL_1 GlobalReAlloc(WinApi_PtrVoid hMem, WinApi_SIZE_T dwBytes, SET uFlags);
#define WinApi_GlobalSize(hMem)	GlobalSize(hMem)
__EXTERN WinApi_SIZE_T __CALL_1 GlobalSize(WinApi_PtrVoid hMem);
#define WinApi_GlobalUnWire(hMem)	GlobalUnWire(hMem)
__EXTERN INTEGER __CALL_1 GlobalUnWire(WinApi_PtrVoid hMem);
#define WinApi_GlobalUnfix(hMem)	GlobalUnfix(hMem)
__EXTERN void __CALL_1 GlobalUnfix(WinApi_PtrVoid hMem);
#define WinApi_GlobalUnlock(hMem)	GlobalUnlock(hMem)
__EXTERN INTEGER __CALL_1 GlobalUnlock(WinApi_PtrVoid hMem);
#define WinApi_GlobalWire(hMem)	GlobalWire(hMem)
__EXTERN WinApi_PtrVoid __CALL_1 GlobalWire(WinApi_PtrVoid hMem);
...
__EXTERN INTEGER __CALL_1 GrayStringA(WinApi_PtrVoid hDC, WinApi_PtrVoid hBrush, WinApi_GRAYSTRINGPROC lpOutputFunc, WinApi_PtrVoid lpData, INTEGER nCount, INTEGER X, INTEGER Y, INTEGER nWidth, INTEGER nHeight);
...
__EXTERN INTEGER __CALL_1 GrayStringW(WinApi_PtrVoid hDC, WinApi_PtrVoid hBrush, WinApi_GRAYSTRINGPROC lpOutputFunc, WinApi_PtrVoid lpData, INTEGER nCount, INTEGER X, INTEGER Y, INTEGER nWidth, INTEGER nHeight);
#define WinApi_HeapAlloc(hHeap, dwFlags, dwBytes)	HeapAlloc(hHeap, dwFlags, dwBytes)
__EXTERN WinApi_PtrVoid __CALL_1 HeapAlloc(WinApi_PtrVoid hHeap, SET dwFlags, WinApi_SIZE_T dwBytes);
#define WinApi_HeapCompact(hHeap, dwFlags)	HeapCompact(hHeap, dwFlags)
__EXTERN WinApi_SIZE_T __CALL_1 HeapCompact(WinApi_PtrVoid hHeap, SET dwFlags);
#define WinApi_HeapCreate(flOptions, dwInitialSize, dwMaximumSize)	HeapCreate(flOptions, dwInitialSize, dwMaximumSize)
__EXTERN WinApi_PtrVoid __CALL_1 HeapCreate(SET flOptions, WinApi_SIZE_T dwInitialSize, WinApi_SIZE_T dwMaximumSize);
#define WinApi_HeapDestroy(hHeap)	HeapDestroy(hHeap)
__EXTERN INTEGER __CALL_1 HeapDestroy(WinApi_PtrVoid hHeap);
#define WinApi_HeapFree(hHeap, dwFlags, lpMem)	HeapFree(hHeap, dwFlags, lpMem)
__EXTERN INTEGER __CALL_1 HeapFree(WinApi_PtrVoid hHeap, SET dwFlags, WinApi_PtrVoid lpMem);
#define WinApi_HeapLock(hHeap)	HeapLock(hHeap)
__EXTERN INTEGER __CALL_1 HeapLock(WinApi_PtrVoid hHeap);
#define WinApi_HeapReAlloc(hHeap, dwFlags, lpMem, dwBytes)	HeapReAlloc(hHeap, dwFlags, lpMem, dwBytes)
__EXTERN WinApi_PtrVoid __CALL_1 HeapReAlloc(WinApi_PtrVoid hHeap, SET dwFlags, WinApi_PtrVoid lpMem, WinApi_SIZE_T dwBytes);
#define WinApi_HeapSize(hHeap, dwFlags, lpMem)	HeapSize(hHeap, dwFlags, lpMem)
__EXTERN WinApi_SIZE_T __CALL_1 HeapSize(WinApi_PtrVoid hHeap, SET dwFlags, WinApi_PtrVoid lpMem);
#define WinApi_HeapUnlock(hHeap)	HeapUnlock(hHeap)
__EXTERN INTEGER __CALL_1 HeapUnlock(WinApi_PtrVoid hHeap);
#define WinApi_HeapValidate(hHeap, dwFlags, lpMem)	HeapValidate(hHeap, dwFlags, lpMem)
__EXTERN INTEGER __CALL_1 HeapValidate(WinApi_PtrVoid hHeap, SET dwFlags, WinApi_PtrVoid lpMem);
#define WinApi_HeapWalk(hHeap, lpEntry, lpEntry__typ)	HeapWalk(hHeap, lpEntry)
__EXTERN INTEGER __CALL_1 HeapWalk(WinApi_PtrVoid hHeap, WinApi_PROCESS_HEAP_ENTRY *lpEntry);
#define WinApi_HideCaret(hWnd)	HideCaret(hWnd)
__EXTERN INTEGER __CALL_1 HideCaret(WinApi_PtrVoid hWnd);
#define WinApi_HiliteMenuItem(hWnd, hMenu, uIDHiliteItem, uHilite)	HiliteMenuItem(hWnd, hMenu, uIDHiliteItem, uHilite)
__EXTERN INTEGER __CALL_1 HiliteMenuItem(WinApi_PtrVoid hWnd, WinApi_PtrVoid hMenu, INTEGER uIDHiliteItem, INTEGER uHilite);
#define WinApi_ImpersonateDdeClientWindow(hWndClient, hWndServer)	ImpersonateDdeClientWindow(hWndClient, hWndServer)
__EXTERN INTEGER __CALL_1 ImpersonateDdeClientWindow(WinApi_PtrVoid hWndClient, WinApi_PtrVoid hWndServer);
#define WinApi_ImpersonateLoggedOnUser(hToken)	ImpersonateLoggedOnUser(hToken)
__EXTERN INTEGER __CALL_1 ImpersonateLoggedOnUser(WinApi_PtrVoid hToken);
#define WinApi_ImpersonateNamedPipeClient(hNamedPipe)	ImpersonateNamedPipeClient(hNamedPipe)
__EXTERN INTEGER __CALL_1 ImpersonateNamedPipeClient(WinApi_PtrVoid hNamedPipe);
...
__EXTERN INTEGER __CALL_1 InitializeSecurityDescriptor(WinApi_PtrVoid pSecurityDescriptor, INTEGER dwRevision);
...
__EXTERN INTEGER __CALL_1 InitializeSid(WinApi_PtrVoid Sid, WinApi_SID_IDENTIFIER_AUTHORITY *pIdentifierAuthority, CHAR nSubAuthorityCount);
...
__EXTERN INTEGER __CALL_1 InsertMenuA(WinApi_PtrVoid hMenu, INTEGER uPosition, SET uFlags, INTEGER uIDNewItem, WinApi_PtrSTR lpNewItem);
...
__EXTERN INTEGER __CALL_1 InsertMenuItemA(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_MENUITEMINFOA *p3);
#define WinApi_InsertMenuItemW(p0, p1, p2, p3, p3__typ)	InsertMenuItemW(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 InsertMenuItemW(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_MENUITEMINFOW *p3);
...
__EXTERN INTEGER __CALL_1 InsertMenuW(WinApi_PtrVoid hMenu, INTEGER uPosition, SET uFlags, INTEGER uIDNewItem, WinApi_PtrWSTR lpNewItem);
...
__EXTERN WinApi_PtrVoid __CALL_1 InterlockedCompareExchange(struct {
	LONGINT len[1];
	WinApi_PtrVoid data[1];
} *Destination, WinApi_PtrVoid Exchange, WinApi_PtrVoid Comperand);
...
__EXTERN INTEGER __CALL_1 IntersectClipRect(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4);
...
__EXTERN INTEGER __CALL_1 InvalidateRect(WinApi_PtrVoid hWnd, WinApi_RECT *lpRect, INTEGER bErase);
#define WinApi_InvalidateRgn(hWnd, hRgn, bErase)	InvalidateRgn(hWnd, hRgn, bErase)
__EXTERN INTEGER __CALL_1 InvalidateRgn(WinApi_PtrVoid hWnd, WinApi_PtrVoid hRgn, INTEGER bErase);
#define WinApi_InvertRect(hDC, lprc, lprc__typ)	InvertRect(hDC, lprc)
__EXTERN INTEGER __CALL_1 InvertRect(WinApi_PtrVoid hDC, WinApi_RECT *lprc);
#define WinApi_InvertRgn(p0, p1)	InvertRgn(p0, p1)
__EXTERN INTEGER __CALL_1 InvertRgn(WinApi_PtrVoid p0, WinApi_PtrVoid p1);
...
__EXTERN INTEGER __CALL_1 IsBadHugeReadPtr(WinApi_PtrVoid lp, INTEGER ucb);
#define WinApi_IsBadHugeWritePtr(lp, ucb)	IsBadHugeWritePtr(lp, ucb)
__EXTERN INTEGER __CALL_1 IsBadHugeWritePtr(WinApi_PtrVoid lp, INTEGER ucb);
#define WinApi_IsBadReadPtr(lp, ucb)	IsBadReadPtr(lp, ucb)
__EXTERN INTEGER __CALL_1 IsBadReadPtr(WinApi_PtrVoid lp, INTEGER ucb);
...
__EXTERN INTEGER __CALL_1 IsBadWritePtr(WinApi_PtrVoid lp, INTEGER ucb);
...
__EXTERN INTEGER __CALL_1 IsChild(WinApi_PtrVoid hWndParent, WinApi_PtrVoid hWnd);
...
__EXTERN INTEGER __CALL_1 IsDialogMessageA(WinApi_PtrVoid hDlg, WinApi_MSG *lpMsg);
#define WinApi_IsDialogMessageW(hDlg, lpMsg, lpMsg__typ)	IsDialogMessageW(hDlg, lpMsg)
__EXTERN INTEGER __CALL_1 IsDialogMessageW(WinApi_PtrVoid hDlg, WinApi_MSG *lpMsg);
#define WinApi_IsDlgButtonChecked(hDlg, nIDButton)	IsDlgButtonChecked(hDlg, nIDButton)
__EXTERN INTEGER __CALL_1 IsDlgButtonChecked(WinApi_PtrVoid hDlg, INTEGER nIDButton);
#define WinApi_IsIconic(hWnd)	IsIconic(hWnd)
__EXTERN INTEGER __CALL_1 IsIconic(WinApi_PtrVoid hWnd);
#define WinApi_IsMenu(hMenu)	IsMenu(hMenu)
__EXTERN INTEGER __CALL_1 IsMenu(WinApi_PtrVoid hMenu);
...
__EXTERN INTEGER __CALL_1 IsTextUnicode(WinApi_PtrVoid lpBuffer, INTEGER cb, SET *lpi);
...
__EXTERN INTEGER __CALL_1 IsValidSecurityDescriptor(WinApi_PtrVoid pSecurityDescriptor);
#define WinApi_IsValidSid(pSid)	IsValidSid(pSid)
__EXTERN INTEGER __CALL_1 IsValidSid(WinApi_PtrVoid pSid);
#define WinApi_IsWindow(hWnd)	IsWindow(hWnd)
__EXTERN INTEGER __CALL_1 IsWindow(WinApi_PtrVoid hWnd);
#define WinApi_IsWindowEnabled(hWnd)	IsWindowEnabled(hWnd)
__EXTERN INTEGER __CALL_1 IsWindowEnabled(WinApi_PtrVoid hWnd);
#define WinApi_IsWindowUnicode(hWnd)	IsWindowUnicode(hWnd)
__EXTERN INTEGER __CALL_1 IsWindowUnicode(WinApi_PtrVoid hWnd);
#define WinApi_IsWindowVisible(hWnd)	IsWindowVisible(hWnd)
__EXTERN INTEGER __CALL_1 IsWindowVisible(WinApi_PtrVoid hWnd);
#define WinApi_IsZoomed(hWnd)	IsZoomed(hWnd)
__EXTERN INTEGER __CALL_1 IsZoomed(WinApi_PtrVoid hWnd);
#define WinApi_KillTimer(hWnd, uIDEvent)	KillTimer(hWnd, uIDEvent)
__EXTERN INTEGER __CALL_1 KillTimer(WinApi_PtrVoid hWnd, INTEGER uIDEvent);
...
__EXTERN INTEGER __CALL_1 LPtoDP(WinApi_PtrVoid p0, WinApi_POINT *p1, INTEGER p2);
...
__EXTERN INTEGER __CALL_1 LineDDA(INTEGER p0, INTEGER p1, INTEGER p2, INTEGER p3, WinApi_LINEDDAPROC p4, WinApi_PtrVoid p5);
#define WinApi_LineTo(p0, p1, p2)	LineTo(p0, p1, p2)
__EXTERN INTEGER __CALL_1 LineTo(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2);
...
__EXTERN WinApi_PtrVoid __CALL_1 LoadAcceleratorsA(WinApi_PtrVoid hInstance, WinApi_PtrSTR lpTableName);
#define WinApi_LoadAcceleratorsW(hInstance, lpTableName)	LoadAcceleratorsW(hInstance, lpTableName)
__EXTERN WinApi_PtrVoid __CALL_1 LoadAcceleratorsW(WinApi_PtrVoid hInstance, WinApi_PtrWSTR lpTableName);
...
__EXTERN WinApi_PtrVoid __CALL_1 LoadBitmapA(WinApi_PtrVoid hInstance, WinApi_PtrSTR lpBitmapName);
#define WinApi_LoadBitmapW(hInstance, lpBitmapName)	LoadBitmapW(hInstance, lpBitmapName)
__EXTERN WinApi_PtrVoid __CALL_1 LoadBitmapW(WinApi_PtrVoid hInstance, WinApi_PtrWSTR lpBitmapName);
...
__EXTERN WinApi_PtrVoid __CALL_1 LoadCursorA(WinApi_PtrVoid hInstance, WinApi_PtrSTR lpCursorName);
...
__EXTERN WinApi_PtrVoid __CALL_1 LoadCursorFromFileA(WinApi_PtrSTR lpFileName);
#define WinApi_LoadCursorFromFileW(lpFileName)	LoadCursorFromFileW(lpFileName)
__EXTERN WinApi_PtrVoid __CALL_1 LoadCursorFromFileW(WinApi_PtrWSTR lpFileName);
#define WinApi_LoadCursorW(hInstance, lpCursorName)	LoadCursorW(hInstance, lpCursorName)
__EXTERN WinApi_PtrVoid __CALL_1 LoadCursorW(WinApi_PtrVoid hInstance, WinApi_PtrWSTR lpCursorName);
...
__EXTERN WinApi_PtrVoid __CALL_1 LoadIconA(WinApi_PtrVoid hInstance, WinApi_PtrSTR lpIconName);
#define WinApi_LoadIconW(hInstance, lpIconName)	LoadIconW(hInstance, lpIconName)
__EXTERN WinApi_PtrVoid __CALL_1 LoadIconW(WinApi_PtrVoid hInstance, WinApi_PtrWSTR lpIconName);
...
__EXTERN WinApi_PtrVoid __CALL_1 LoadImageA(WinApi_PtrVoid p0, WinApi_PtrSTR p1, INTEGER p2, INTEGER p3, INTEGER p4, INTEGER p5);
#define WinApi_LoadImageW(p0, p1, p2, p3, p4, p5)	LoadImageW(p0, p1, p2, p3, p4, p5)
__EXTERN WinApi_PtrVoid __CALL_1 LoadImageW(WinApi_PtrVoid p0, WinApi_PtrWSTR p1, INTEGER p2, INTEGER p3, INTEGER p4, INTEGER p5);
...
__EXTERN WinApi_PtrVoid __CALL_1 LoadKeyboardLayoutA(WinApi_PtrSTR pwszKLID, SET Flags);
#define WinApi_LoadKeyboardLayoutW(pwszKLID, Flags)	LoadKeyboardLayoutW(pwszKLID, Flags)
__EXTERN WinApi_PtrVoid __CALL_1 LoadKeyboardLayoutW(WinApi_PtrWSTR pwszKLID, SET Flags);
...
__EXTERN WinApi_PtrVoid __CALL_1 LoadLibraryA(WinApi_PtrSTR lpLibFileName);
...
__EXTERN WinApi_PtrVoid __CALL_1 LoadLibraryExA(WinApi_PtrSTR lpLibFileName, WinApi_PtrVoid hFile, SET dwFlags);
#define WinApi_LoadLibraryExW(lpLibFileName, hFile, dwFlags)	LoadLibraryExW(lpLibFileName, hFile, dwFlags)
__EXTERN WinApi_PtrVoid __CALL_1 LoadLibraryExW(WinApi_PtrWSTR lpLibFileName, WinApi_PtrVoid hFile, SET dwFlags);
#define WinApi_LoadLibraryW(lpLibFileName)	LoadLibraryW(lpLibFileName)
__EXTERN WinApi_PtrVoid __CALL_1 LoadLibraryW(WinApi_PtrWSTR lpLibFileName);
...
__EXTERN WinApi_PtrVoid __CALL_1 LoadMenuA(WinApi_PtrVoid hInstance, WinApi_PtrSTR lpMenuName);
...
__EXTERN WinApi_PtrVoid __CALL_1 LoadMenuIndirectA(WinApi_PtrMENUTEMPLATEA lpMenuTemplate);
#define WinApi_LoadMenuIndirectW(lpMenuTemplate)	LoadMenuIndirectW(lpMenuTemplate)
__EXTERN WinApi_PtrVoid __CALL_1 LoadMenuIndirectW(WinApi_PtrMENUTEMPLATEW lpMenuTemplate);
#define WinApi_LoadMenuW(hInstance, lpMenuName)	LoadMenuW(hInstance, lpMenuName)
__EXTERN WinApi_PtrVoid __CALL_1 LoadMenuW(WinApi_PtrVoid hInstance, WinApi_PtrWSTR lpMenuName);
#define WinApi_LoadModule(lpModuleName, lpParameterBlock)	LoadModule(lpModuleName, lpParameterBlock)
__EXTERN INTEGER __CALL_1 LoadModule(WinApi_PtrSTR lpModuleName, WinApi_PtrVoid lpParameterBlock);
#define WinApi_LoadResource(hModule, hResInfo)	LoadResource(hModule, hResInfo)
__EXTERN WinApi_PtrVoid __CALL_1 LoadResource(WinApi_PtrVoid hModule, WinApi_PtrVoid hResInfo);
...
__EXTERN INTEGER __CALL_1 LoadStringA(WinApi_PtrVoid hInstance, INTEGER uID, WinApi_PtrSTR lpBuffer, INTEGER nBufferMax);
#define WinApi_LoadStringW(hInstance, uID, lpBuffer, nBufferMax)	LoadStringW(hInstance, uID, lpBuffer, nBufferMax)
__EXTERN INTEGER __CALL_1 LoadStringW(WinApi_PtrVoid hInstance, INTEGER uID, WinApi_PtrWSTR lpBuffer, INTEGER nBufferMax);
#define WinApi_LocalAlloc(uFlags, uBytes)	LocalAlloc(uFlags, uBytes)
__EXTERN WinApi_PtrVoid __CALL_1 LocalAlloc(SET uFlags, WinApi_SIZE_T uBytes);
#define WinApi_LocalCompact(uMinFree)	LocalCompact(uMinFree)
__EXTERN WinApi_SIZE_T __CALL_1 LocalCompact(INTEGER uMinFree);
...
__EXTERN INTEGER __CALL_1 LocalFlags(WinApi_PtrVoid hMem);
#define WinApi_LocalFree(hMem)	LocalFree(hMem)
__EXTERN WinApi_PtrVoid __CALL_1 LocalFree(WinApi_PtrVoid hMem);
#define WinApi_LocalHandle(pMem)	LocalHandle(pMem)
__EXTERN WinApi_PtrVoid __CALL_1 LocalHandle(WinApi_PtrVoid pMem);
#define WinApi_LocalLock(hMem)	LocalLock(hMem)
__EXTERN WinApi_PtrVoid __CALL_1 LocalLock(WinApi_PtrVoid hMem);
#define WinApi_LocalReAlloc(hMem, uBytes, uFlags)	LocalReAlloc(hMem, uBytes, uFlags)
__EXTERN WinApi_PtrVoid __CALL_1 LocalReAlloc(WinApi_PtrVoid hMem, WinApi_SIZE_T uBytes, SET uFlags);
#define WinApi_LocalShrink(hMem, cbNewSize)	LocalShrink(hMem, cbNewSize)
__EXTERN WinApi_SIZE_T __CALL_1 LocalShrink(WinApi_PtrVoid hMem, INTEGER cbNewSize);
#define WinApi_LocalSize(hMem)	LocalSize(hMem)
__EXTERN INTEGER __CALL_1 LocalSize(WinApi_PtrVoid hMem);
#define WinApi_LocalUnlock(hMem)	LocalUnlock(hMem)
__EXTERN INTEGER __CALL_1 LocalUnlock(WinApi_PtrVoid hMem);
...
__EXTERN INTEGER __CALL_1 LockFile(WinApi_PtrVoid hFile, INTEGER dwFileOffsetLow, INTEGER dwFileOffsetHigh, INTEGER nNumberOfBytesToLockLow, INTEGER nNumberOfBytesToLockHigh);
...
__EXTERN INTEGER __CALL_1 LockFileEx(WinApi_PtrVoid hFile, SET dwFlags, INTEGER dwReserved, INTEGER nNumberOfBytesToLockLow, INTEGER nNumberOfBytesToLockHigh, WinApi_OVERLAPPED *lpOverlapped);
#define WinApi_LockResource(hResData)	LockResource(hResData)
__EXTERN WinApi_PtrVoid __CALL_1 LockResource(WinApi_PtrVoid hResData);
#define WinApi_LockServiceDatabase(hSCManager)	LockServiceDatabase(hSCManager)
__EXTERN WinApi_PtrVoid __CALL_1 LockServiceDatabase(WinApi_PtrVoid hSCManager);
#define WinApi_LockWindowUpdate(hWndLock)	LockWindowUpdate(hWndLock)
__EXTERN INTEGER __CALL_1 LockWindowUpdate(WinApi_PtrVoid hWndLock);
...
__EXTERN INTEGER __CALL_1 LogonUserA(WinApi_PtrSTR lpszUsername, WinApi_PtrSTR lpszDomain, WinApi_PtrSTR lpszPassword, INTEGER dwLogonType, INTEGER dwLogonProvider, WinApi_PtrVoid *phToken);
...
__EXTERN INTEGER __CALL_1 LogonUserW(WinApi_PtrWSTR lpszUsername, WinApi_PtrWSTR lpszDomain, WinApi_PtrWSTR lpszPassword, INTEGER dwLogonType, INTEGER dwLogonProvider, WinApi_PtrVoid *phToken);
...
__EXTERN INTEGER __CALL_1 LookupAccountNameA(WinApi_PtrSTR lpSystemName, WinApi_PtrSTR lpAccountName, WinApi_PtrVoid Sid, INTEGER *cbSid, WinApi_PtrSTR ReferencedDomainName, INTEGER *cbReferencedDomainName, INTEGER *peUse);
...
__EXTERN INTEGER __CALL_1 LookupAccountNameW(WinApi_PtrWSTR lpSystemName, WinApi_PtrWSTR lpAccountName, WinApi_PtrVoid Sid, INTEGER *cbSid, WinApi_PtrWSTR ReferencedDomainName, INTEGER *cbReferencedDomainName, INTEGER *peUse);
...
__EXTERN INTEGER __CALL_1 LookupAccountSidA(WinApi_PtrSTR lpSystemName, WinApi_PtrVoid Sid, WinApi_PtrSTR Name, INTEGER *cbName, WinApi_PtrSTR ReferencedDomainName, INTEGER *cbReferencedDomainName, INTEGER *peUse);
...
__EXTERN INTEGER __CALL_1 LookupAccountSidW(WinApi_PtrWSTR lpSystemName, WinApi_PtrVoid Sid, WinApi_PtrWSTR Name, INTEGER *cbName, WinApi_PtrWSTR ReferencedDomainName, INTEGER *cbReferencedDomainName, INTEGER *peUse);
...
__EXTERN INTEGER __CALL_1 MakeAbsoluteSD(WinApi_PtrVoid pSelfRelativeSecurityDescriptor, WinApi_PtrVoid pAbsoluteSecurityDescriptor, INTEGER *lpdwAbsoluteSecurityDescriptorSize, WinApi_ACL *pDacl, INTEGER *lpdwDaclSize, WinApi_ACL *pSacl, INTEGER *lpdwSaclSize, WinApi_PtrVoid pOwner, INTEGER *lpdwOwnerSize, WinApi_PtrVoid pPrimaryGroup, INTEGER *lpdwPrimaryGroupSize);
...
__EXTERN INTEGER __CALL_1 MakeSelfRelativeSD(WinApi_PtrVoid pAbsoluteSecurityDescriptor, WinApi_PtrVoid pSelfRelativeSecurityDescriptor, INTEGER *lpdwBufferLength);
#define WinApi_MapDialogRect(hDlg, lpRect, lpRect__typ)	MapDialogRect(hDlg, lpRect)
__EXTERN INTEGER __CALL_1 MapDialogRect(WinApi_PtrVoid hDlg, WinApi_RECT *lpRect);
...
__EXTERN WinApi_PtrVoid __CALL_1 MapViewOfFile(WinApi_PtrVoid hFileMappingObject, SET dwDesiredAccess, INTEGER dwFileOffsetHigh, INTEGER dwFileOffsetLow, INTEGER dwNumberOfBytesToMap);
...
__EXTERN WinApi_PtrVoid __CALL_1 MapViewOfFileEx(WinApi_PtrVoid hFileMappingObject, SET dwDesiredAccess, INTEGER dwFileOffsetHigh, INTEGER dwFileOffsetLow, INTEGER dwNumberOfBytesToMap, WinApi_PtrVoid lpBaseAddress);
...
__EXTERN INTEGER __CALL_1 MapVirtualKeyExA(INTEGER uCode, INTEGER uMapType, WinApi_PtrVoid dwhkl);
#define WinApi_MapVirtualKeyExW(uCode, uMapType, dwhkl)	MapVirtualKeyExW(uCode, uMapType, dwhkl)
__EXTERN INTEGER __CALL_1 MapVirtualKeyExW(INTEGER uCode, INTEGER uMapType, WinApi_PtrVoid dwhkl);
...
__EXTERN INTEGER __CALL_1 MapWindowPoints(WinApi_PtrVoid hWndFrom, WinApi_PtrVoid hWndTo, WinApi_POINT *lpPoints, INTEGER cPoints);
#define WinApi_MaskBlt(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11)	MaskBlt(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11)
__EXTERN INTEGER __CALL_1 MaskBlt(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4, WinApi_PtrVoid p5, INTEGER p6, INTEGER p7, WinApi_PtrVoid p8, INTEGER p9, INTEGER p10, INTEGER p11);
#define WinApi_MenuItemFromPoint(hWnd, hMenu, ptScreen)	MenuItemFromPoint(hWnd, hMenu, ptScreen)
__EXTERN INTEGER __CALL_1 MenuItemFromPoint(WinApi_PtrVoid hWnd, WinApi_PtrVoid hMenu, WinApi_POINT ptScreen);
...
__EXTERN INTEGER __CALL_1 MessageBoxA(WinApi_PtrVoid hWnd, WinApi_PtrSTR lpText, WinApi_PtrSTR lpCaption, SET uType);
...
__EXTERN INTEGER __CALL_1 MessageBoxExA(WinApi_PtrVoid hWnd, WinApi_PtrSTR lpText, WinApi_PtrSTR lpCaption, SET uType, SHORTINT wLanguageId);
...
__EXTERN INTEGER __CALL_1 MessageBoxExW(WinApi_PtrVoid hWnd, WinApi_PtrWSTR lpText, WinApi_PtrWSTR lpCaption, SET uType, SHORTINT wLanguageId);
...
__EXTERN INTEGER __CALL_1 MessageBoxW(WinApi_PtrVoid hWnd, WinApi_PtrWSTR lpText, WinApi_PtrWSTR lpCaption, SET uType);
...
__EXTERN INTEGER __CALL_1 ModifyMenuA(WinApi_PtrVoid hMnu, INTEGER uPosition, SET uFlags, INTEGER uIDNewItem, WinApi_PtrSTR lpNewItem);
...
__EXTERN INTEGER __CALL_1 ModifyMenuW(WinApi_PtrVoid hMnu, INTEGER uPosition, SET uFlags, INTEGER uIDNewItem, WinApi_PtrWSTR lpNewItem);
#define WinApi_ModifyWorldTransform(p0, p1, p1__typ, p2)	ModifyWorldTransform(p0, p1, p2)
__EXTERN INTEGER __CALL_1 ModifyWorldTransform(WinApi_PtrVoid p0, WinApi_XFORM *p1, INTEGER p2);
...
__EXTERN INTEGER __CALL_1 MoveToEx(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_POINT *p3);
#define WinApi_MoveWindow(hWnd, X, Y, nWidth, nHeight, bRepaint)	MoveWindow(hWnd, X, Y, nWidth, nHeight, bRepaint)
__EXTERN INTEGER __CALL_1 MoveWindow(WinApi_PtrVoid hWnd, INTEGER X, INTEGER Y, INTEGER nWidth, INTEGER nHeight, INTEGER bRepaint);
...
__EXTERN INTEGER __CALL_1 MsgWaitForMultipleObjects(INTEGER nCount, WinApi_PtrVoid *pHandles, INTEGER fWaitAll, INTEGER dwMilliseconds, INTEGER dwWakeMask);
...
__EXTERN INTEGER __CALL_1 MsgWaitForMultipleObjectsEx(INTEGER nCount, WinApi_PtrVoid *pHandles, INTEGER dwMilliseconds, INTEGER dwWakeMask, SET dwFlags);
...
__EXTERN INTEGER __CALL_1 NotifyChangeEventLog(WinApi_PtrVoid hEventLog, WinApi_PtrVoid hEvent);
...
__EXTERN INTEGER __CALL_1 ObjectCloseAuditAlarmA(WinApi_PtrSTR SubsystemName, WinApi_PtrVoid HandleId, INTEGER GenerateOnClose);
...
__EXTERN INTEGER __CALL_1 ObjectCloseAuditAlarmW(WinApi_PtrWSTR SubsystemName, WinApi_PtrVoid HandleId, INTEGER GenerateOnClose);
...
__EXTERN INTEGER __CALL_1 ObjectOpenAuditAlarmA(WinApi_PtrSTR SubsystemName, WinApi_PtrVoid HandleId, WinApi_PtrSTR ObjectTypeName, WinApi_PtrSTR ObjectName, WinApi_PtrVoid pSecurityDescriptor, WinApi_PtrVoid ClientToken, SET DesiredAccess, INTEGER GrantedAccess, WinApi_PRIVILEGE_SET *Privileges, INTEGER ObjectCreation, INTEGER AccessGranted, INTEGER *GenerateOnClose);
...
__EXTERN INTEGER __CALL_1 ObjectOpenAuditAlarmW(WinApi_PtrWSTR SubsystemName, WinApi_PtrVoid HandleId, WinApi_PtrWSTR ObjectTypeName, WinApi_PtrWSTR ObjectName, WinApi_PtrVoid pSecurityDescriptor, WinApi_PtrVoid ClientToken, SET DesiredAccess, INTEGER GrantedAccess, WinApi_PRIVILEGE_SET *Privileges, INTEGER ObjectCreation, INTEGER AccessGranted, INTEGER *GenerateOnClose);
...
__EXTERN INTEGER __CALL_1 ObjectPrivilegeAuditAlarmA(WinApi_PtrSTR SubsystemName, WinApi_PtrVoid HandleId, WinApi_PtrVoid ClientToken, SET DesiredAccess, WinApi_PRIVILEGE_SET *Privileges, INTEGER AccessGranted);
...
__EXTERN INTEGER __CALL_1 ObjectPrivilegeAuditAlarmW(WinApi_PtrWSTR SubsystemName, WinApi_PtrVoid HandleId, WinApi_PtrVoid ClientToken, SET DesiredAccess, WinApi_PRIVILEGE_SET *Privileges, INTEGER AccessGranted);
...
__EXTERN INTEGER __CALL_1 OffsetClipRgn(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2);
...
__EXTERN INTEGER __CALL_1 OffsetRgn(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2);
#define WinApi_OffsetViewportOrgEx(p0, p1, p2, p3, p3__typ)	OffsetViewportOrgEx(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 OffsetViewportOrgEx(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_POINT *p3);
#define WinApi_OffsetWindowOrgEx(p0, p1, p2, p3, p3__typ)	OffsetWindowOrgEx(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 OffsetWindowOrgEx(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_POINT *p3);
...
__EXTERN WinApi_PtrVoid __CALL_1 OpenBackupEventLogA(WinApi_PtrSTR lpUNCServerName, WinApi_PtrSTR lpFileName);
#define WinApi_OpenBackupEventLogW(lpUNCServerName, lpFileName)	OpenBackupEventLogW(lpUNCServerName, lpFileName)
__EXTERN WinApi_PtrVoid __CALL_1 OpenBackupEventLogW(WinApi_PtrWSTR lpUNCServerName, WinApi_PtrWSTR lpFileName);
#define WinApi_OpenClipboard(hWndNewOwner)	OpenClipboard(hWndNewOwner)
__EXTERN INTEGER __CALL_1 OpenClipboard(WinApi_PtrVoid hWndNewOwner);
...
__EXTERN WinApi_PtrVoid __CALL_1 OpenDesktopA(WinApi_PtrSTR lpszDesktop, SET dwFlags, INTEGER fInherit, SET dwDesiredAccess);
...
__EXTERN WinApi_PtrVoid __CALL_1 OpenDesktopW(WinApi_PtrWSTR lpszDesktop, SET dwFlags, INTEGER fInherit, SET dwDesiredAccess);
...
__EXTERN WinApi_PtrVoid __CALL_1 OpenEventA(SET dwDesiredAccess, INTEGER bInheritHandle, WinApi_PtrSTR lpName);
...
__EXTERN WinApi_PtrVoid __CALL_1 OpenEventLogA(WinApi_PtrSTR lpUNCServerName, WinApi_PtrSTR lpSourceName);
#define WinApi_OpenEventLogW(lpUNCServerName, lpSourceName)	OpenEventLogW(lpUNCServerName, lpSourceName)
__EXTERN WinApi_PtrVoid __CALL_1 OpenEventLogW(WinApi_PtrWSTR lpUNCServerName, WinApi_PtrWSTR lpSourceName);
#define WinApi_OpenEventW(dwDesiredAccess, bInheritHandle, lpName)	OpenEventW(dwDesiredAccess, bInheritHandle, lpName)
__EXTERN WinApi_PtrVoid __CALL_1 OpenEventW(SET dwDesiredAccess, INTEGER bInheritHandle, WinApi_PtrWSTR lpName);
...
__EXTERN WinApi_PtrVoid __CALL_1 OpenFileMappingA(SET dwDesiredAccess, INTEGER bInheritHandle, WinApi_PtrSTR lpName);
...
__EXTERN WinApi_PtrVoid __CALL_1 OpenFileMappingW(SET dwDesiredAccess, INTEGER bInheritHandle, WinApi_PtrWSTR lpName);
#define WinApi_OpenIcon(hWnd)	OpenIcon(hWnd)
__EXTERN INTEGER __CALL_1 OpenIcon(WinApi_PtrVoid hWnd);
#define WinApi_OpenInputDesktop(dwFlags, fInherit, dwDesiredAccess)	OpenInputDesktop(dwFlags, fInherit, dwDesiredAccess)
__EXTERN WinApi_PtrVoid __CALL_1 OpenInputDesktop(SET dwFlags, INTEGER fInherit, SET dwDesiredAccess);
...
__EXTERN WinApi_PtrVoid __CALL_1 OpenMutexA(SET dwDesiredAccess, INTEGER bInheritHandle, WinApi_PtrSTR lpName);
#define WinApi_OpenMutexW(dwDesiredAccess, bInheritHandle, lpName)	OpenMutexW(dwDesiredAccess, bInheritHandle, lpName)
__EXTERN WinApi_PtrVoid __CALL_1 OpenMutexW(SET dwDesiredAccess, INTEGER bInheritHandle, WinApi_PtrWSTR lpName);
...
__EXTERN INTEGER __CALL_1 OpenPrinterA(WinApi_PtrSTR pPrinterName, WinApi_PtrVoid *phPrinter, WinApi_PRINTER_DEFAULTSA *pDefault);
#define WinApi_OpenPrinterW(pPrinterName, phPrinter, pDefault, pDefault__typ)	OpenPrinterW(pPrinterName, phPrinter, pDefault)
__EXTERN INTEGER __CALL_1 OpenPrinterW(WinApi_PtrWSTR pPrinterName, WinApi_PtrVoid *phPrinter, WinApi_PRINTER_DEFAULTSW *pDefault);
...
__EXTERN WinApi_PtrVoid __CALL_1 OpenProcess(SET dwDesiredAccess, INTEGER bInheritHandle, INTEGER dwProcessId);
...
__EXTERN INTEGER __CALL_1 OpenProcessToken(WinApi_PtrVoid ProcessHandle, SET DesiredAccess, WinApi_PtrVoid *TokenHandle);
...
__EXTERN WinApi_PtrVoid __CALL_1 OpenSCManagerA(WinApi_PtrSTR lpMachineName, WinApi_PtrSTR lpDatabaseName, SET dwDesiredAccess);
...
__EXTERN WinApi_PtrVoid __CALL_1 OpenSCManagerW(WinApi_PtrWSTR lpMachineName, WinApi_PtrWSTR lpDatabaseName, SET dwDesiredAccess);
...
__EXTERN WinApi_PtrVoid __CALL_1 OpenSemaphoreA(SET dwDesiredAccess, INTEGER bInheritHandle, WinApi_PtrSTR lpName);
#define WinApi_OpenSemaphoreW(dwDesiredAccess, bInheritHandle, lpName)	OpenSemaphoreW(dwDesiredAccess, bInheritHandle, lpName)
__EXTERN WinApi_PtrVoid __CALL_1 OpenSemaphoreW(SET dwDesiredAccess, INTEGER bInheritHandle, WinApi_PtrWSTR lpName);
...
__EXTERN WinApi_PtrVoid __CALL_1 OpenServiceA(WinApi_PtrVoid hSCManager, WinApi_PtrSTR lpServiceName, SET dwDesiredAccess);
...
__EXTERN WinApi_PtrVoid __CALL_1 OpenServiceW(WinApi_PtrVoid hSCManager, WinApi_PtrWSTR lpServiceName, SET dwDesiredAccess);
...
__EXTERN INTEGER __CALL_1 OpenThreadToken(WinApi_PtrVoid ThreadHandle, SET DesiredAccess, INTEGER OpenAsSelf, WinApi_PtrVoid *TokenHandle);
...
__EXTERN WinApi_PtrVoid __CALL_1 OpenWaitableTimerA(SET dwDesiredAccess, INTEGER bInheritHandle, WinApi_PtrSTR lpTimerName);
...
__EXTERN WinApi_PtrVoid __CALL_1 OpenWaitableTimerW(SET dwDesiredAccess, INTEGER bInheritHandle, WinApi_PtrWSTR lpTimerName);
...
__EXTERN WinApi_PtrVoid __CALL_1 OpenWindowStationA(WinApi_PtrSTR lpszWinSta, INTEGER fInherit, SET dwDesiredAccess);
...
__EXTERN WinApi_PtrVoid __CALL_1 OpenWindowStationW(WinApi_PtrWSTR lpszWinSta, INTEGER fInherit, SET dwDesiredAccess);
...
__EXTERN INTEGER __CALL_1 PaintDesktop(WinApi_PtrVoid hdc);
#define WinApi_PaintRgn(p0, p1)	PaintRgn(p0, p1)
__EXTERN INTEGER __CALL_1 PaintRgn(WinApi_PtrVoid p0, WinApi_PtrVoid p1);
#define WinApi_PatBlt(p0, p1, p2, p3, p4, p5)	PatBlt(p0, p1, p2, p3, p4, p5)
__EXTERN INTEGER __CALL_1 PatBlt(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4, INTEGER p5);
#define WinApi_PathToRegion(p0)	PathToRegion(p0)
__EXTERN WinApi_PtrVoid __CALL_1 PathToRegion(WinApi_PtrVoid p0);
...
__EXTERN INTEGER __CALL_1 PeekConsoleInputA(WinApi_PtrVoid hConsoleInput, WinApi_INPUT_RECORD *lpBuffer, INTEGER nLength, INTEGER *lpNumberOfEventsRead);
...
__EXTERN INTEGER __CALL_1 PeekConsoleInputW(WinApi_PtrVoid hConsoleInput, WinApi_INPUT_RECORD *lpBuffer, INTEGER nLength, INTEGER *lpNumberOfEventsRead);
...
__EXTERN INTEGER __CALL_1 PeekMessageA(WinApi_MSG *lpMsg, WinApi_PtrVoid hWnd, INTEGER wMsgFilterMin, INTEGER wMsgFilterMax, INTEGER wRemoveMsg);
...
__EXTERN INTEGER __CALL_1 PeekMessageW(WinApi_MSG *lpMsg, WinApi_PtrVoid hWnd, INTEGER wMsgFilterMin, INTEGER wMsgFilterMax, INTEGER wRemoveMsg);
...
__EXTERN INTEGER __CALL_1 PeekNamedPipe(WinApi_PtrVoid hNamedPipe, WinApi_PtrVoid lpBuffer, INTEGER nBufferSize, INTEGER *lpBytesRead, INTEGER *lpTotalBytesAvail, INTEGER *lpBytesLeftThisMessage);
#define WinApi_Pie(p0, p1, p2, p3, p4, p5, p6, p7, p8)	Pie(p0, p1, p2, p3, p4, p5, p6, p7, p8)
__EXTERN INTEGER __CALL_1 Pie(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4, INTEGER p5, INTEGER p6, INTEGER p7, INTEGER p8);
#define WinApi_PlayEnhMetaFile(p0, p1, p2, p2__typ)	PlayEnhMetaFile(p0, p1, p2)
__EXTERN INTEGER __CALL_1 PlayEnhMetaFile(WinApi_PtrVoid p0, WinApi_PtrVoid p1, WinApi_RECT *p2);
#define WinApi_PlayEnhMetaFileRecord(p0, p1, p1__typ, p2, p2__typ, p3)	PlayEnhMetaFileRecord(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 PlayEnhMetaFileRecord(WinApi_PtrVoid p0, WinApi_HANDLETABLE *p1, WinApi_ENHMETARECORD *p2, INTEGER p3);
#define WinApi_PlayMetaFile(p0, p1)	PlayMetaFile(p0, p1)
__EXTERN INTEGER __CALL_1 PlayMetaFile(WinApi_PtrVoid p0, WinApi_PtrVoid p1);
#define WinApi_PlayMetaFileRecord(p0, p1, p1__typ, p2, p2__typ, p3)	PlayMetaFileRecord(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 PlayMetaFileRecord(WinApi_PtrVoid p0, WinApi_HANDLETABLE *p1, WinApi_METARECORD *p2, INTEGER p3);
#define WinApi_PlgBlt(p0, p1, p1__typ, p2, p3, p4, p5, p6, p7, p8, p9)	PlgBlt(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9)
__EXTERN INTEGER __CALL_1 PlgBlt(WinApi_PtrVoid p0, WinApi_POINT *p1, WinApi_PtrVoid p2, INTEGER p3, INTEGER p4, INTEGER p5, INTEGER p6, WinApi_PtrVoid p7, INTEGER p8, INTEGER p9);
#define WinApi_PolyBezier(p0, p1, p1__typ, p2)	PolyBezier(p0, p1, p2)
__EXTERN INTEGER __CALL_1 PolyBezier(WinApi_PtrVoid p0, WinApi_POINT *p1, INTEGER p2);
#define WinApi_PolyBezierTo(p0, p1, p1__typ, p2)	PolyBezierTo(p0, p1, p2)
__EXTERN INTEGER __CALL_1 PolyBezierTo(WinApi_PtrVoid p0, WinApi_POINT *p1, INTEGER p2);
#define WinApi_PolyDraw(p0, p1, p1__typ, p2, p3)	PolyDraw(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 PolyDraw(WinApi_PtrVoid p0, WinApi_POINT *p1, CHAR *p2, INTEGER p3);
#define WinApi_PolyPolygon(p0, p1, p1__typ, p2, p3)	PolyPolygon(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 PolyPolygon(WinApi_PtrVoid p0, WinApi_POINT *p1, INTEGER *p2, INTEGER p3);
#define WinApi_PolyPolyline(p0, p1, p1__typ, p2, p3)	PolyPolyline(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 PolyPolyline(WinApi_PtrVoid p0, WinApi_POINT *p1, INTEGER *p2, INTEGER p3);
...
__EXTERN INTEGER __CALL_1 PolyTextOutA(WinApi_PtrVoid p0, WinApi_POLYTEXTA *p1, INTEGER p2);
#define WinApi_PolyTextOutW(p0, p1, p1__typ, p2)	PolyTextOutW(p0, p1, p2)
__EXTERN INTEGER __CALL_1 PolyTextOutW(WinApi_PtrVoid p0, WinApi_POLYTEXTW *p1, INTEGER p2);
#define WinApi_Polygon(p0, p1, p1__typ, p2)	Polygon(p0, p1, p2)
__EXTERN INTEGER __CALL_1 Polygon(WinApi_PtrVoid p0, WinApi_POINT *p1, INTEGER p2);
#define WinApi_Polyline(p0, p1, p1__typ, p2)	Polyline(p0, p1, p2)
__EXTERN INTEGER __CALL_1 Polyline(WinApi_PtrVoid p0, WinApi_POINT *p1, INTEGER p2);
#define WinApi_PolylineTo(p0, p1, p1__typ, p2)	PolylineTo(p0, p1, p2)
__EXTERN INTEGER __CALL_1 PolylineTo(WinApi_PtrVoid p0, WinApi_POINT *p1, INTEGER p2);
...
__EXTERN INTEGER __CALL_1 PostMessageA(WinApi_PtrVoid hWnd, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
#define WinApi_PostMessageW(hWnd, Msg, wParam, lParam)	PostMessageW(hWnd, Msg, wParam, lParam)
__EXTERN INTEGER __CALL_1 PostMessageW(WinApi_PtrVoid hWnd, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
...
__EXTERN INTEGER __CALL_1 PostQueuedCompletionStatus(WinApi_PtrVoid CompletionPort, INTEGER dwNumberOfBytesTransferred, INTEGER dwCompletionKey, WinApi_OVERLAPPED *lpOverlapped);
...
__EXTERN INTEGER __CALL_1 PostThreadMessageA(INTEGER idThread, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
#define WinApi_PostThreadMessageW(idThread, Msg, wParam, lParam)	PostThreadMessageW(idThread, Msg, wParam, lParam)
__EXTERN INTEGER __CALL_1 PostThreadMessageW(INTEGER idThread, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
#define WinApi_PrepareTape(hDevice, dwOperation, bImmediate)	PrepareTape(hDevice, dwOperation, bImmediate)
__EXTERN INTEGER __CALL_1 PrepareTape(WinApi_PtrVoid hDevice, INTEGER dwOperation, INTEGER bImmediate);
...
__EXTERN INTEGER __CALL_1 PrinterMessageBoxA(WinApi_PtrVoid hPrinter, INTEGER Error, WinApi_PtrVoid hWnd, WinApi_PtrSTR pText, WinApi_PtrSTR pCaption, INTEGER dwType);
...
__EXTERN INTEGER __CALL_1 PrinterMessageBoxW(WinApi_PtrVoid hPrinter, INTEGER Error, WinApi_PtrVoid hWnd, WinApi_PtrWSTR pText, WinApi_PtrWSTR pCaption, INTEGER dwType);
#define WinApi_PrinterProperties(hWnd, hPrinter)	PrinterProperties(hWnd, hPrinter)
__EXTERN INTEGER __CALL_1 PrinterProperties(WinApi_PtrVoid hWnd, WinApi_PtrVoid hPrinter);
...
__EXTERN INTEGER __CALL_1 PrivilegeCheck(WinApi_PtrVoid ClientToken, WinApi_PRIVILEGE_SET *RequiredPrivileges, INTEGER *pfResult);
...
__EXTERN INTEGER __CALL_1 PrivilegedServiceAuditAlarmA(WinApi_PtrSTR SubsystemName, WinApi_PtrSTR ServiceName, WinApi_PtrVoid ClientToken, WinApi_PRIVILEGE_SET *Privileges, INTEGER AccessGranted);
...
__EXTERN INTEGER __CALL_1 PrivilegedServiceAuditAlarmW(WinApi_PtrWSTR SubsystemName, WinApi_PtrWSTR ServiceName, WinApi_PtrVoid ClientToken, WinApi_PRIVILEGE_SET *Privileges, INTEGER AccessGranted);
...
__EXTERN INTEGER __CALL_1 PtInRegion(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2);
#define WinApi_PtVisible(p0, p1, p2)	PtVisible(p0, p1, p2)
__EXTERN INTEGER __CALL_1 PtVisible(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2);
#define WinApi_PulseEvent(hEvent)	PulseEvent(hEvent)
__EXTERN INTEGER __CALL_1 PulseEvent(WinApi_PtrVoid hEvent);
#define WinApi_PurgeComm(hFile, dwFlags)	PurgeComm(hFile, dwFlags)
__EXTERN INTEGER __CALL_1 PurgeComm(WinApi_PtrVoid hFile, SET dwFlags);
...
__EXTERN INTEGER __CALL_1 QueryServiceConfigA(WinApi_PtrVoid hService, WinApi_QUERY_SERVICE_CONFIGA *lpServiceConfig, INTEGER cbBufSize, INTEGER *pcbBytesNeeded);
...
__EXTERN INTEGER __CALL_1 QueryServiceConfigW(WinApi_PtrVoid hService, WinApi_QUERY_SERVICE_CONFIGW *lpServiceConfig, INTEGER cbBufSize, INTEGER *pcbBytesNeeded);
...
__EXTERN INTEGER __CALL_1 QueryServiceLockStatusA(WinApi_PtrVoid hSCManager, WinApi_QUERY_SERVICE_LOCK_STATUSA *lpLockStatus, INTEGER cbBufSize, INTEGER *pcbBytesNeeded);
...
__EXTERN INTEGER __CALL_1 QueryServiceLockStatusW(WinApi_PtrVoid hSCManager, WinApi_QUERY_SERVICE_LOCK_STATUSW *lpLockStatus, INTEGER cbBufSize, INTEGER *pcbBytesNeeded);
...
__EXTERN INTEGER __CALL_1 QueryServiceObjectSecurity(WinApi_PtrVoid hService, SET dwSecurityInformation, WinApi_PtrVoid lpSecurityDescriptor, INTEGER cbBufSize, INTEGER *pcbBytesNeeded);
...
__EXTERN INTEGER __CALL_1 QueryServiceStatus(WinApi_PtrVoid hService, WinApi_SERVICE_STATUS *lpServiceStatus);
#define WinApi_QueueUserAPC(pfnAPC, hThread, dwData)	QueueUserAPC(pfnAPC, hThread, dwData)
__EXTERN INTEGER __CALL_1 QueueUserAPC(WinApi_APCFUNC pfnAPC, WinApi_PtrVoid hThread, INTEGER dwData);
...
__EXTERN INTEGER __CALL_1 ReadConsoleA(WinApi_PtrVoid hConsoleInput, WinApi_PtrVoid lpBuffer, INTEGER nNumberOfCharsToRead, INTEGER *lpNumberOfCharsRead, WinApi_PtrVoid lpReserved);
...
__EXTERN INTEGER __CALL_1 ReadConsoleInputA(WinApi_PtrVoid hConsoleInput, WinApi_INPUT_RECORD *lpBuffer, INTEGER nLength, INTEGER *lpNumberOfEventsRead);
...
__EXTERN INTEGER __CALL_1 ReadConsoleInputW(WinApi_PtrVoid hConsoleInput, WinApi_INPUT_RECORD *lpBuffer, INTEGER nLength, INTEGER *lpNumberOfEventsRead);
...
__EXTERN INTEGER __CALL_1 ReadConsoleOutputA(WinApi_PtrVoid hConsoleOutput, WinApi_CHAR_INFO *lpBuffer, WinApi_COORD dwBufferSize, WinApi_COORD dwBufferCoord, WinApi_SMALL_RECT *lpReadRegion);
...
__EXTERN INTEGER __CALL_1 ReadConsoleOutputAttribute(WinApi_PtrVoid hConsoleOutput, SHORTINT *lpAttribute, INTEGER nLength, WinApi_COORD dwReadCoord, INTEGER *lpNumberOfAttrsRead);
...
__EXTERN INTEGER __CALL_1 ReadConsoleOutputCharacterA(WinApi_PtrVoid hConsoleOutput, WinApi_PtrSTR lpCharacter, INTEGER nLength, WinApi_COORD dwReadCoord, INTEGER *lpNumberOfCharsRead);
...
__EXTERN INTEGER __CALL_1 ReadConsoleOutputCharacterW(WinApi_PtrVoid hConsoleOutput, WinApi_PtrWSTR lpCharacter, INTEGER nLength, WinApi_COORD dwReadCoord, INTEGER *lpNumberOfCharsRead);
...
__EXTERN INTEGER __CALL_1 ReadConsoleOutputW(WinApi_PtrVoid hConsoleOutput, WinApi_CHAR_INFO *lpBuffer, WinApi_COORD dwBufferSize, WinApi_COORD dwBufferCoord, WinApi_SMALL_RECT *lpReadRegion);
...
__EXTERN INTEGER __CALL_1 ReadConsoleW(WinApi_PtrVoid hConsoleInput, WinApi_PtrVoid lpBuffer, INTEGER nNumberOfCharsToRead, INTEGER *lpNumberOfCharsRead, WinApi_PtrVoid lpReserved);
...
__EXTERN INTEGER __CALL_1 ReadDirectoryChangesW(WinApi_PtrVoid hDirectory, WinApi_PtrVoid lpBuffer, INTEGER nBufferLength, INTEGER bWatchSubtree, SET dwNotifyFilter, INTEGER *lpBytesReturned, WinApi_OVERLAPPED *lpOverlapped, WinApi_OVERLAPPED_COMPLETION_ROUTINE lpCompletionRoutine);
...
__EXTERN INTEGER __CALL_1 ReadEventLogA(WinApi_PtrVoid hEventLog, SET dwReadFlags, INTEGER dwRecordOffset, WinApi_PtrVoid lpBuffer, INTEGER nNumberOfBytesToRead, INTEGER *pnBytesRead, INTEGER *pnMinNumberOfBytesNeeded);
...
__EXTERN INTEGER __CALL_1 ReadEventLogW(WinApi_PtrVoid hEventLog, SET dwReadFlags, INTEGER dwRecordOffset, WinApi_PtrVoid lpBuffer, INTEGER nNumberOfBytesToRead, INTEGER *pnBytesRead, INTEGER *pnMinNumberOfBytesNeeded);
...
__EXTERN INTEGER __CALL_1 ReadFile(WinApi_PtrVoid hFile, WinApi_PtrVoid lpBuffer, INTEGER nNumberOfBytesToRead, INTEGER *lpNumberOfBytesRead, WinApi_OVERLAPPED *lpOverlapped);
...
__EXTERN INTEGER __CALL_1 ReadFileEx(WinApi_PtrVoid hFile, WinApi_PtrVoid lpBuffer, INTEGER nNumberOfBytesToRead, WinApi_OVERLAPPED *lpOverlapped, WinApi_OVERLAPPED_COMPLETION_ROUTINE lpCompletionRoutine);
#define WinApi_ReadPrinter(hPrinter, pBuf, cbBuf, pNoBytesRead)	ReadPrinter(hPrinter, pBuf, cbBuf, pNoBytesRead)
__EXTERN INTEGER __CALL_1 ReadPrinter(WinApi_PtrVoid hPrinter, WinApi_PtrVoid pBuf, INTEGER cbBuf, INTEGER *pNoBytesRead);
...
__EXTERN INTEGER __CALL_1 ReadProcessMemory(WinApi_PtrVoid hProcess, WinApi_PtrVoid lpBaseAddress, WinApi_PtrVoid lpBuffer, INTEGER nSize, INTEGER *lpNumberOfBytesRead);
#define WinApi_RealizePalette(p0)	RealizePalette(p0)
__EXTERN INTEGER __CALL_1 RealizePalette(WinApi_PtrVoid p0);
#define WinApi_RectInRegion(p0, p1, p1__typ)	RectInRegion(p0, p1)
__EXTERN INTEGER __CALL_1 RectInRegion(WinApi_PtrVoid p0, WinApi_RECT *p1);
#define WinApi_RectVisible(p0, p1, p1__typ)	RectVisible(p0, p1)
__EXTERN INTEGER __CALL_1 RectVisible(WinApi_PtrVoid p0, WinApi_RECT *p1);
#define WinApi_Rectangle(p0, p1, p2, p3, p4)	Rectangle(p0, p1, p2, p3, p4)
__EXTERN INTEGER __CALL_1 Rectangle(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4);
...
__EXTERN INTEGER __CALL_1 RedrawWindow(WinApi_PtrVoid hWnd, WinApi_RECT *lprcUpdate, WinApi_PtrVoid hrgnUpdate, SET flags);
#define WinApi_RegCloseKey(hKey)	RegCloseKey(hKey)
__EXTERN INTEGER __CALL_1 RegCloseKey(WinApi_PtrVoid hKey);
...
__EXTERN INTEGER __CALL_1 RegConnectRegistryA(WinApi_PtrSTR lpMachineName, WinApi_PtrVoid hKey, WinApi_PtrVoid *phkResult);
#define WinApi_RegConnectRegistryW(lpMachineName, hKey, phkResult)	RegConnectRegistryW(lpMachineName, hKey, phkResult)
__EXTERN INTEGER __CALL_1 RegConnectRegistryW(WinApi_PtrWSTR lpMachineName, WinApi_PtrVoid hKey, WinApi_PtrVoid *phkResult);
...
__EXTERN INTEGER __CALL_1 RegCreateKeyA(WinApi_PtrVoid hKey, WinApi_PtrSTR lpSubKey, WinApi_PtrVoid *phkResult);
...
__EXTERN INTEGER __CALL_1 RegCreateKeyExA(WinApi_PtrVoid hKey, WinApi_PtrSTR lpSubKey, INTEGER Reserved, WinApi_PtrSTR lpClass, SET dwOptions, SET samDesired, WinApi_SECURITY_ATTRIBUTES *lpSecurityAttributes, WinApi_PtrVoid *phkResult, INTEGER *lpdwDisposition);
...
__EXTERN INTEGER __CALL_1 RegCreateKeyExW(WinApi_PtrVoid hKey, WinApi_PtrWSTR lpSubKey, INTEGER Reserved, WinApi_PtrWSTR lpClass, SET dwOptions, SET samDesired, WinApi_SECURITY_ATTRIBUTES *lpSecurityAttributes, WinApi_PtrVoid *phkResult, INTEGER *lpdwDisposition);
#define WinApi_RegCreateKeyW(hKey, lpSubKey, phkResult)	RegCreateKeyW(hKey, lpSubKey, phkResult)
__EXTERN INTEGER __CALL_1 RegCreateKeyW(WinApi_PtrVoid hKey, WinApi_PtrWSTR lpSubKey, WinApi_PtrVoid *phkResult);
...
__EXTERN INTEGER __CALL_1 RegDeleteKeyA(WinApi_PtrVoid hKey, WinApi_PtrSTR lpSubKey);
#define WinApi_RegDeleteKeyW(hKey, lpSubKey)	RegDeleteKeyW(hKey, lpSubKey)
__EXTERN INTEGER __CALL_1 RegDeleteKeyW(WinApi_PtrVoid hKey, WinApi_PtrWSTR lpSubKey);
...
__EXTERN INTEGER __CALL_1 RegDeleteValueA(WinApi_PtrVoid hKey, WinApi_PtrSTR lpValueName);
#define WinApi_RegDeleteValueW(hKey, lpValueName)	RegDeleteValueW(hKey, lpValueName)
__EXTERN INTEGER __CALL_1 RegDeleteValueW(WinApi_PtrVoid hKey, WinApi_PtrWSTR lpValueName);
...
__EXTERN INTEGER __CALL_1 RegEnumKeyA(WinApi_PtrVoid hKey, INTEGER dwIndex, WinApi_PtrSTR lpName, INTEGER cbName);
...
__EXTERN INTEGER __CALL_1 RegEnumKeyExA(WinApi_PtrVoid hKey, INTEGER dwIndex, WinApi_PtrSTR lpName, INTEGER *lpcbName, INTEGER *lpReserved, WinApi_PtrSTR lpClass, INTEGER *lpcbClass, WinApi_FILETIME *lpftLastWriteTime);
...
__EXTERN INTEGER __CALL_1 RegEnumKeyExW(WinApi_PtrVoid hKey, INTEGER dwIndex, WinApi_PtrWSTR lpName, INTEGER *lpcbName, INTEGER *lpReserved, WinApi_PtrWSTR lpClass, INTEGER *lpcbClass, WinApi_FILETIME *lpftLastWriteTime);
#define WinApi_RegEnumKeyW(hKey, dwIndex, lpName, cbName)	RegEnumKeyW(hKey, dwIndex, lpName, cbName)
__EXTERN INTEGER __CALL_1 RegEnumKeyW(WinApi_PtrVoid hKey, INTEGER dwIndex, WinApi_PtrWSTR lpName, INTEGER cbName);
...
__EXTERN INTEGER __CALL_1 RegEnumValueA(WinApi_PtrVoid hKey, INTEGER dwIndex, WinApi_PtrSTR lpValueName, INTEGER *lpcbValueName, INTEGER *lpReserved, INTEGER *lpType, WinApi_PtrVoid lpData, INTEGER *lpcbData);
...
__EXTERN INTEGER __CALL_1 RegEnumValueW(WinApi_PtrVoid hKey, INTEGER dwIndex, WinApi_PtrWSTR lpValueName, INTEGER *lpcbValueName, INTEGER *lpReserved, INTEGER *lpType, WinApi_PtrVoid lpData, INTEGER *lpcbData);
#define WinApi_RegFlushKey(hKey)	RegFlushKey(hKey)
__EXTERN INTEGER __CALL_1 RegFlushKey(WinApi_PtrVoid hKey);
...
__EXTERN INTEGER __CALL_1 RegGetKeySecurity(WinApi_PtrVoid hKey, SET SecurityInformation, WinApi_PtrVoid pSecurityDescriptor, INTEGER *lpcbSecurityDescriptor);
...
__EXTERN INTEGER __CALL_1 RegLoadKeyA(WinApi_PtrVoid hKey, WinApi_PtrSTR lpSubKey, WinApi_PtrSTR lpFile);
#define WinApi_RegLoadKeyW(hKey, lpSubKey, lpFile)	RegLoadKeyW(hKey, lpSubKey, lpFile)
__EXTERN INTEGER __CALL_1 RegLoadKeyW(WinApi_PtrVoid hKey, WinApi_PtrWSTR lpSubKey, WinApi_PtrWSTR lpFile);
...
__EXTERN INTEGER __CALL_1 RegNotifyChangeKeyValue(WinApi_PtrVoid hKey, INTEGER bWatchSubtree, SET dwNotifyFilter, WinApi_PtrVoid hEvent, INTEGER fAsynchronus);
...
__EXTERN INTEGER __CALL_1 RegOpenKeyA(WinApi_PtrVoid hKey, WinApi_PtrSTR lpSubKey, WinApi_PtrVoid *phkResult);
...
__EXTERN INTEGER __CALL_1 RegOpenKeyExA(WinApi_PtrVoid hKey, WinApi_PtrSTR lpSubKey, INTEGER ulOptions, SET samDesired, WinApi_PtrVoid *phkResult);
...
__EXTERN INTEGER __CALL_1 RegOpenKeyExW(WinApi_PtrVoid hKey, WinApi_PtrWSTR lpSubKey, INTEGER ulOptions, SET samDesired, WinApi_PtrVoid *phkResult);
#define WinApi_RegOpenKeyW(hKey, lpSubKey, phkResult)	RegOpenKeyW(hKey, lpSubKey, phkResult)
__EXTERN INTEGER __CALL_1 RegOpenKeyW(WinApi_PtrVoid hKey, WinApi_PtrWSTR lpSubKey, WinApi_PtrVoid *phkResult);
...
__EXTERN INTEGER __CALL_1 RegQueryInfoKeyW(WinApi_PtrVoid hKey, WinApi_PtrWSTR lpClass, INTEGER *lpcbClass, INTEGER *lpReserved, INTEGER *lpcSubKeys, INTEGER *lpcbMaxSubKeyLen, INTEGER *lpcbMaxClassLen, INTEGER *lpcValues, INTEGER *lpcbMaxValueNameLen, INTEGER *lpcbMaxValueLen, INTEGER *lpcbSecurityDescriptor, WinApi_FILETIME *lpftLastWriteTime);
...
__EXTERN INTEGER __CALL_1 RegQueryMultipleValuesA(WinApi_PtrVoid hKey, WinApi_VALENTA *val_list, INTEGER num_vals, WinApi_PtrSTR lpValueBuf, INTEGER *ldwTotsize);
...
__EXTERN INTEGER __CALL_1 RegQueryMultipleValuesW(WinApi_PtrVoid hKey, WinApi_VALENTW *val_list, INTEGER num_vals, WinApi_PtrWSTR lpValueBuf, INTEGER *ldwTotsize);
...
__EXTERN INTEGER __CALL_1 RegQueryValueA(WinApi_PtrVoid hKey, WinApi_PtrSTR lpSubKey, WinApi_PtrSTR lpValue, INTEGER *lpcbValue);
...
__EXTERN INTEGER __CALL_1 RegQueryValueExA(WinApi_PtrVoid hKey, WinApi_PtrSTR lpValueName, INTEGER *lpReserved, INTEGER *lpType, WinApi_PtrVoid lpData, INTEGER *lpcbData);
...
__EXTERN INTEGER __CALL_1 RegQueryValueExW(WinApi_PtrVoid hKey, WinApi_PtrWSTR lpValueName, INTEGER *lpReserved, INTEGER *lpType, WinApi_PtrVoid lpData, INTEGER *lpcbData);
#define WinApi_RegQueryValueW(hKey, lpSubKey, lpValue, lpcbValue)	RegQueryValueW(hKey, lpSubKey, lpValue, lpcbValue)
__EXTERN INTEGER __CALL_1 RegQueryValueW(WinApi_PtrVoid hKey, WinApi_PtrWSTR lpSubKey, WinApi_PtrWSTR lpValue, INTEGER *lpcbValue);
...
__EXTERN INTEGER __CALL_1 RegReplaceKeyA(WinApi_PtrVoid hKey, WinApi_PtrSTR lpSubKey, WinApi_PtrSTR lpNewFile, WinApi_PtrSTR lpOldFile);
#define WinApi_RegReplaceKeyW(hKey, lpSubKey, lpNewFile, lpOldFile)	RegReplaceKeyW(hKey, lpSubKey, lpNewFile, lpOldFile)
__EXTERN INTEGER __CALL_1 RegReplaceKeyW(WinApi_PtrVoid hKey, WinApi_PtrWSTR lpSubKey, WinApi_PtrWSTR lpNewFile, WinApi_PtrWSTR lpOldFile);
...
__EXTERN INTEGER __CALL_1 RegRestoreKeyA(WinApi_PtrVoid hKey, WinApi_PtrSTR lpFile, SET dwFlags);
#define WinApi_RegRestoreKeyW(hKey, lpFile, dwFlags)	RegRestoreKeyW(hKey, lpFile, dwFlags)
__EXTERN INTEGER __CALL_1 RegRestoreKeyW(WinApi_PtrVoid hKey, WinApi_PtrWSTR lpFile, SET dwFlags);
...
__EXTERN INTEGER __CALL_1 RegSaveKeyA(WinApi_PtrVoid hKey, WinApi_PtrSTR lpFile, WinApi_SECURITY_ATTRIBUTES *lpSecurityAttributes);
...
__EXTERN INTEGER __CALL_1 RegSaveKeyW(WinApi_PtrVoid hKey, WinApi_PtrWSTR lpFile, WinApi_SECURITY_ATTRIBUTES *lpSecurityAttributes);
...
__EXTERN INTEGER __CALL_1 RegSetKeySecurity(WinApi_PtrVoid hKey, SET SecurityInformation, WinApi_PtrVoid pSecurityDescriptor);
...
__EXTERN INTEGER __CALL_1 RegSetValueA(WinApi_PtrVoid hKey, WinApi_PtrSTR lpSubKey, INTEGER dwType, WinApi_PtrSTR lpData, INTEGER cbData);
...
__EXTERN INTEGER __CALL_1 RegSetValueExA(WinApi_PtrVoid hKey, WinApi_PtrSTR lpValueName, INTEGER Reserved, INTEGER dwType, WinApi_PtrVoid lpData, INTEGER cbData);
...
__EXTERN INTEGER __CALL_1 RegSetValueExW(WinApi_PtrVoid hKey, WinApi_PtrWSTR lpValueName, INTEGER Reserved, INTEGER dwType, WinApi_PtrVoid lpData, INTEGER cbData);
#define WinApi_RegSetValueW(hKey, lpSubKey, dwType, lpData, cbData)	RegSetValueW(hKey, lpSubKey, dwType, lpData, cbData)
__EXTERN INTEGER __CALL_1 RegSetValueW(WinApi_PtrVoid hKey, WinApi_PtrWSTR lpSubKey, INTEGER dwType, WinApi_PtrWSTR lpData, INTEGER cbData);
...
__EXTERN INTEGER __CALL_1 RegUnLoadKeyA(WinApi_PtrVoid hKey, WinApi_PtrSTR lpSubKey);
#define WinApi_RegUnLoadKeyW(hKey, lpSubKey)	RegUnLoadKeyW(hKey, lpSubKey)
__EXTERN INTEGER __CALL_1 RegUnLoadKeyW(WinApi_PtrVoid hKey, WinApi_PtrWSTR lpSubKey);
...
__EXTERN WinApi_PtrVoid __CALL_1 RegisterEventSourceA(WinApi_PtrSTR lpUNCServerName, WinApi_PtrSTR lpSourceName);
#define WinApi_RegisterEventSourceW(lpUNCServerName, lpSourceName)	RegisterEventSourceW(lpUNCServerName, lpSourceName)
__EXTERN WinApi_PtrVoid __CALL_1 RegisterEventSourceW(WinApi_PtrWSTR lpUNCServerName, WinApi_PtrWSTR lpSourceName);
#define WinApi_RegisterHotKey(hWnd, id, fsModifiers, vk)	RegisterHotKey(hWnd, id, fsModifiers, vk)
__EXTERN INTEGER __CALL_1 RegisterHotKey(WinApi_PtrVoid hWnd, INTEGER id, INTEGER fsModifiers, INTEGER vk);
...
__EXTERN INTEGER __CALL_1 ReleaseDC(WinApi_PtrVoid hWnd, WinApi_PtrVoid hDC);
#define WinApi_ReleaseMutex(hMutex)	ReleaseMutex(hMutex)
__EXTERN INTEGER __CALL_1 ReleaseMutex(WinApi_PtrVoid hMutex);
...
__EXTERN INTEGER __CALL_1 ReleaseSemaphore(WinApi_PtrVoid hSemaphore, INTEGER lReleaseCount, INTEGER *lpPreviousCount);
...
__EXTERN INTEGER __CALL_1 RemoveMenu(WinApi_PtrVoid hMenu, INTEGER uPosition, SET uFlags);
...
__EXTERN WinApi_PtrVoid __CALL_1 RemovePropA(WinApi_PtrVoid hWnd, WinApi_PtrSTR lpString);
#define WinApi_RemovePropW(hWnd, lpString)	RemovePropW(hWnd, lpString)
__EXTERN WinApi_PtrVoid __CALL_1 RemovePropW(WinApi_PtrVoid hWnd, WinApi_PtrWSTR lpString);
#define WinApi_ReplyMessage(lResult)	ReplyMessage(lResult)
__EXTERN INTEGER __CALL_1 ReplyMessage(WinApi_PtrVoid lResult);
...
__EXTERN INTEGER __CALL_1 ReportEventA(WinApi_PtrVoid hEventLog, SHORTINT wType, SHORTINT wCategory, INTEGER dwEventID, WinApi_PtrVoid lpUserSid, SHORTINT wNumStrings, INTEGER dwDataSize, WinApi_PtrSTR *lpStrings, WinApi_PtrVoid lpRawData);
...
__EXTERN INTEGER __CALL_1 ReportEventW(WinApi_PtrVoid hEventLog, SHORTINT wType, SHORTINT wCategory, INTEGER dwEventID, WinApi_PtrVoid lpUserSid, SHORTINT wNumStrings, INTEGER dwDataSize, struct {
	LONGINT len[1];
	WinApi_PtrWSTR data[1];
} *lpStrings, WinApi_PtrVoid lpRawData);
#define WinApi_ResetDC(p0, p1, p1__typ)	ResetDCA(p0, p1)
#define WinApi_ResetDCA(p0, p1, p1__typ)	ResetDCA(p0, p1)
__EXTERN WinApi_PtrVoid __CALL_1 ResetDCA(WinApi_PtrVoid p0, WinApi_DEVMODEA *p1);
#define WinApi_ResetDCW(p0, p1, p1__typ)	ResetDCW(p0, p1)
__EXTERN WinApi_PtrVoid __CALL_1 ResetDCW(WinApi_PtrVoid p0, WinApi_DEVMODEW *p1);
#define WinApi_ResetEvent(hEvent)	ResetEvent(hEvent)
__EXTERN INTEGER __CALL_1 ResetEvent(WinApi_PtrVoid hEvent);
...
__EXTERN INTEGER __CALL_1 ResetPrinterA(WinApi_PtrVoid hPrinter, WinApi_PRINTER_DEFAULTSA *pDefault);
#define WinApi_ResetPrinterW(hPrinter, pDefault, pDefault__typ)	ResetPrinterW(hPrinter, pDefault)
__EXTERN INTEGER __CALL_1 ResetPrinterW(WinApi_PtrVoid hPrinter, WinApi_PRINTER_DEFAULTSW *pDefault);
#define WinApi_ResizePalette(p0, p1)	ResizePalette(p0, p1)
__EXTERN INTEGER __CALL_1 ResizePalette(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_RestoreDC(p0, p1)	RestoreDC(p0, p1)
__EXTERN INTEGER __CALL_1 RestoreDC(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_ResumeThread(hThread)	ResumeThread(hThread)
__EXTERN INTEGER __CALL_1 ResumeThread(WinApi_PtrVoid hThread);
...
__EXTERN INTEGER __CALL_1 RoundRect(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4, INTEGER p5, INTEGER p6);
#define WinApi_RtlUnwind(targetFrame, targetIp, excpRec, retVal)	RtlUnwind(targetFrame, targetIp, excpRec, retVal)
__EXTERN void __CALL_1 RtlUnwind(WinApi_PtrVoid targetFrame, INTEGER targetIp, WinApi_PtrEXCEPTION_RECORD excpRec, INTEGER retVal);
...
__EXTERN void __CALL_1 SHFreeNameMappings(WinApi_PtrVoid hNameMappings);
...
__EXTERN INTEGER __CALL_1 SaveDC(WinApi_PtrVoid p0);
#define WinApi_ScaleViewportExtEx(p0, p1, p2, p3, p4, p5, p5__typ)	ScaleViewportExtEx(p0, p1, p2, p3, p4, p5)
__EXTERN INTEGER __CALL_1 ScaleViewportExtEx(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4, WinApi_SIZE *p5);
#define WinApi_ScaleWindowExtEx(p0, p1, p2, p3, p4, p5, p5__typ)	ScaleWindowExtEx(p0, p1, p2, p3, p4, p5)
__EXTERN INTEGER __CALL_1 ScaleWindowExtEx(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4, WinApi_SIZE *p5);
#define WinApi_ScheduleJob(hPrinter, JobId)	ScheduleJob(hPrinter, JobId)
__EXTERN INTEGER __CALL_1 ScheduleJob(WinApi_PtrVoid hPrinter, INTEGER JobId);
#define WinApi_ScreenToClient(hWnd, lpPoint, lpPoint__typ)	ScreenToClient(hWnd, lpPoint)
__EXTERN INTEGER __CALL_1 ScreenToClient(WinApi_PtrVoid hWnd, WinApi_POINT *lpPoint);
...
__EXTERN INTEGER __CALL_1 ScrollConsoleScreenBufferA(WinApi_PtrVoid hConsoleOutput, WinApi_SMALL_RECT *lpScrollRectangle, WinApi_SMALL_RECT *lpClipRectangle, WinApi_COORD dwDestinationOrigin, WinApi_CHAR_INFO *lpFill);
...
__EXTERN INTEGER __CALL_1 ScrollConsoleScreenBufferW(WinApi_PtrVoid hConsoleOutput, WinApi_SMALL_RECT *lpScrollRectangle, WinApi_SMALL_RECT *lpClipRectangle, WinApi_COORD dwDestinationOrigin, WinApi_CHAR_INFO *lpFill);
...
__EXTERN INTEGER __CALL_1 ScrollDC(WinApi_PtrVoid hDC, INTEGER dx, INTEGER dy, WinApi_RECT *lprcScroll, WinApi_RECT *lprcClip, WinApi_PtrVoid hrgnUpdate, WinApi_RECT *lprcUpdate);
...
__EXTERN INTEGER __CALL_1 ScrollWindow(WinApi_PtrVoid hWnd, INTEGER XAmount, INTEGER YAmount, WinApi_RECT *lpRect, WinApi_RECT *lpClipRect);
...
__EXTERN INTEGER __CALL_1 ScrollWindowEx(WinApi_PtrVoid hWnd, INTEGER dx, INTEGER dy, WinApi_RECT *prcScroll, WinApi_RECT *prcClip, WinApi_PtrVoid hrgnUpdate, WinApi_RECT *prcUpdate, SET flags);
...
__EXTERN INTEGER __CALL_1 SelectClipPath(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_SelectClipRgn(p0, p1)	SelectClipRgn(p0, p1)
__EXTERN INTEGER __CALL_1 SelectClipRgn(WinApi_PtrVoid p0, WinApi_PtrVoid p1);
#define WinApi_SelectObject(p0, p1)	SelectObject(p0, p1)
__EXTERN WinApi_PtrVoid __CALL_1 SelectObject(WinApi_PtrVoid p0, WinApi_PtrVoid p1);
#define WinApi_SelectPalette(p0, p1, p2)	SelectPalette(p0, p1, p2)
__EXTERN WinApi_PtrVoid __CALL_1 SelectPalette(WinApi_PtrVoid p0, WinApi_PtrVoid p1, INTEGER p2);
...
__EXTERN INTEGER __CALL_1 SendDlgItemMessageA(WinApi_PtrVoid hDlg, INTEGER nIDDlgItem, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
...
__EXTERN INTEGER __CALL_1 SendDlgItemMessageW(WinApi_PtrVoid hDlg, INTEGER nIDDlgItem, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
...
__EXTERN WinApi_PtrVoid __CALL_1 SendMessageA(WinApi_PtrVoid hWnd, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
...
__EXTERN INTEGER __CALL_1 SendMessageCallbackA(WinApi_PtrVoid hWnd, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam, WinApi_SENDASYNCPROC lpResultCallBack, INTEGER dwData);
...
__EXTERN INTEGER __CALL_1 SendMessageCallbackW(WinApi_PtrVoid hWnd, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam, WinApi_SENDASYNCPROC lpResultCallBack, INTEGER dwData);
...
__EXTERN WinApi_PtrVoid __CALL_1 SendMessageTimeoutA(WinApi_PtrVoid hWnd, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam, SET fuFlags, INTEGER uTimeout, INTEGER *lpdwResult);
...
__EXTERN WinApi_PtrVoid __CALL_1 SendMessageTimeoutW(WinApi_PtrVoid hWnd, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam, SET fuFlags, INTEGER uTimeout, INTEGER *lpdwResult);
#define WinApi_SendMessageW(hWnd, Msg, wParam, lParam)	SendMessageW(hWnd, Msg, wParam, lParam)
__EXTERN WinApi_PtrVoid __CALL_1 SendMessageW(WinApi_PtrVoid hWnd, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
...
__EXTERN INTEGER __CALL_1 SendNotifyMessageA(WinApi_PtrVoid hWnd, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
#define WinApi_SendNotifyMessageW(hWnd, Msg, wParam, lParam)	SendNotifyMessageW(hWnd, Msg, wParam, lParam)
__EXTERN INTEGER __CALL_1 SendNotifyMessageW(WinApi_PtrVoid hWnd, INTEGER Msg, WinApi_PtrVoid wParam, WinApi_PtrVoid lParam);
#define WinApi_SetAbortProc(p0, p1)	SetAbortProc(p0, p1)
__EXTERN INTEGER __CALL_1 SetAbortProc(WinApi_PtrVoid p0, WinApi_ABORTPROC p1);
...
__EXTERN INTEGER __CALL_1 SetAclInformation(WinApi_ACL *pAcl, WinApi_PtrVoid pAclInformation, INTEGER nAclInformationLength, INTEGER dwAclInformationClass);
#define WinApi_SetActiveWindow(hWnd)	SetActiveWindow(hWnd)
__EXTERN WinApi_PtrVoid __CALL_1 SetActiveWindow(WinApi_PtrVoid hWnd);
#define WinApi_SetArcDirection(p0, p1)	SetArcDirection(p0, p1)
__EXTERN INTEGER __CALL_1 SetArcDirection(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_SetBitmapBits(p0, p1, p2)	SetBitmapBits(p0, p1, p2)
__EXTERN INTEGER __CALL_1 SetBitmapBits(WinApi_PtrVoid p0, INTEGER p1, WinApi_PtrVoid p2);
#define WinApi_SetBitmapDimensionEx(p0, p1, p2, p3, p3__typ)	SetBitmapDimensionEx(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 SetBitmapDimensionEx(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_SIZE *p3);
#define WinApi_SetBkColor(p0, p1)	SetBkColor(p0, p1)
__EXTERN INTEGER __CALL_1 SetBkColor(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_SetBkMode(p0, p1)	SetBkMode(p0, p1)
__EXTERN INTEGER __CALL_1 SetBkMode(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_SetBoundsRect(p0, p1, p1__typ, p2)	SetBoundsRect(p0, p1, p2)
__EXTERN SET __CALL_1 SetBoundsRect(WinApi_PtrVoid p0, WinApi_RECT *p1, SET p2);
#define WinApi_SetBrushOrgEx(p0, p1, p2, p3, p3__typ)	SetBrushOrgEx(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 SetBrushOrgEx(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_POINT *p3);
#define WinApi_SetCapture(hWnd)	SetCapture(hWnd)
__EXTERN WinApi_PtrVoid __CALL_1 SetCapture(WinApi_PtrVoid hWnd);
...
__EXTERN INTEGER __CALL_1 SetClassLongA(WinApi_PtrVoid hWnd, INTEGER nIndex, INTEGER dwNewLong);
#define WinApi_SetClassLongW(hWnd, nIndex, dwNewLong)	SetClassLongW(hWnd, nIndex, dwNewLong)
__EXTERN INTEGER __CALL_1 SetClassLongW(WinApi_PtrVoid hWnd, INTEGER nIndex, INTEGER dwNewLong);
#define WinApi_SetClassWord(hWnd, nIndex, wNewWord)	SetClassWord(hWnd, nIndex, wNewWord)
__EXTERN SHORTINT __CALL_1 SetClassWord(WinApi_PtrVoid hWnd, INTEGER nIndex, SHORTINT wNewWord);
#define WinApi_SetClipboardData(uFormat, hMem)	SetClipboardData(uFormat, hMem)
__EXTERN WinApi_PtrVoid __CALL_1 SetClipboardData(INTEGER uFormat, WinApi_PtrVoid hMem);
#define WinApi_SetClipboardViewer(hWndNewViewer)	SetClipboardViewer(hWndNewViewer)
__EXTERN WinApi_PtrVoid __CALL_1 SetClipboardViewer(WinApi_PtrVoid hWndNewViewer);
#define WinApi_SetColorAdjustment(p0, p1, p1__typ)	SetColorAdjustment(p0, p1)
__EXTERN INTEGER __CALL_1 SetColorAdjustment(WinApi_PtrVoid p0, WinApi_COLORADJUSTMENT *p1);
#define WinApi_SetColorSpace(p0, p1)	SetColorSpace(p0, p1)
__EXTERN INTEGER __CALL_1 SetColorSpace(WinApi_PtrVoid p0, WinApi_PtrVoid p1);
#define WinApi_SetCommBreak(hFile)	SetCommBreak(hFile)
__EXTERN INTEGER __CALL_1 SetCommBreak(WinApi_PtrVoid hFile);
#define WinApi_SetCommConfig(hCommDev, lpCC, lpCC__typ, dwSize)	SetCommConfig(hCommDev, lpCC, dwSize)
__EXTERN INTEGER __CALL_1 SetCommConfig(WinApi_PtrVoid hCommDev, WinApi_COMMCONFIG *lpCC, INTEGER dwSize);
#define WinApi_SetCommMask(hFile, dwEvtMask)	SetCommMask(hFile, dwEvtMask)
__EXTERN INTEGER __CALL_1 SetCommMask(WinApi_PtrVoid hFile, SET dwEvtMask);
#define WinApi_SetCommState(hFile, lpDCB, lpDCB__typ)	SetCommState(hFile, lpDCB)
__EXTERN INTEGER __CALL_1 SetCommState(WinApi_PtrVoid hFile, WinApi_DCB *lpDCB);
#define WinApi_SetCommTimeouts(hFile, lpCommTimeouts, lpCommTimeouts__typ)	SetCommTimeouts(hFile, lpCommTimeouts)
__EXTERN INTEGER __CALL_1 SetCommTimeouts(WinApi_PtrVoid hFile, WinApi_COMMTIMEOUTS *lpCommTimeouts);
...
__EXTERN INTEGER __CALL_1 SetConsoleActiveScreenBuffer(WinApi_PtrVoid hConsoleOutput);
...
__EXTERN INTEGER __CALL_1 SetConsoleCursorInfo(WinApi_PtrVoid hConsoleOutput, WinApi_CONSOLE_CURSOR_INFO *lpConsoleCursorInfo);
...
__EXTERN INTEGER __CALL_1 SetConsoleCursorPosition(WinApi_PtrVoid hConsoleOutput, WinApi_COORD dwCursorPosition);
#define WinApi_SetConsoleMode(hConsoleHandle, dwMode)	SetConsoleMode(hConsoleHandle, dwMode)
__EXTERN INTEGER __CALL_1 SetConsoleMode(WinApi_PtrVoid hConsoleHandle, SET dwMode);
...
__EXTERN INTEGER __CALL_1 SetConsoleScreenBufferSize(WinApi_PtrVoid hConsoleOutput, WinApi_COORD dwSize);
#define WinApi_SetConsoleTextAttribute(hConsoleOutput, wAttributes)	SetConsoleTextAttribute(hConsoleOutput, wAttributes)
__EXTERN INTEGER __CALL_1 SetConsoleTextAttribute(WinApi_PtrVoid hConsoleOutput, SHORTINT wAttributes);
...
__EXTERN INTEGER __CALL_1 SetConsoleWindowInfo(WinApi_PtrVoid hConsoleOutput, INTEGER bAbsolute, WinApi_SMALL_RECT *lpConsoleWindow);
...
__EXTERN WinApi_PtrVoid __CALL_1 SetCursor(WinApi_PtrVoid hCursor);
...
__EXTERN INTEGER __CALL_1 SetDIBColorTable(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_RGBQUAD *p3);
#define WinApi_SetDIBits(p0, p1, p2, p3, p4, p5, p5__typ, p6)	SetDIBits(p0, p1, p2, p3, p4, p5, p6)
__EXTERN INTEGER __CALL_1 SetDIBits(WinApi_PtrVoid p0, WinApi_PtrVoid p1, INTEGER p2, INTEGER p3, WinApi_PtrVoid p4, WinApi_BITMAPINFO *p5, INTEGER p6);
...
__EXTERN INTEGER __CALL_1 SetDIBitsToDevice(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4, INTEGER p5, INTEGER p6, INTEGER p7, INTEGER p8, WinApi_PtrVoid p9, WinApi_BITMAPINFO *p10, INTEGER p11);
...
__EXTERN INTEGER __CALL_1 SetDeviceGammaRamp(WinApi_PtrVoid p0, WinApi_PtrVoid p1);
#define WinApi_SetDlgItemInt(hDlg, nIDDlgItem, uValue, bSigned)	SetDlgItemInt(hDlg, nIDDlgItem, uValue, bSigned)
__EXTERN INTEGER __CALL_1 SetDlgItemInt(WinApi_PtrVoid hDlg, INTEGER nIDDlgItem, INTEGER uValue, INTEGER bSigned);
...
__EXTERN INTEGER __CALL_1 SetDlgItemTextA(WinApi_PtrVoid hDlg, INTEGER nIDDlgItem, WinApi_PtrSTR lpString);
#define WinApi_SetDlgItemTextW(hDlg, nIDDlgItem, lpString)	SetDlgItemTextW(hDlg, nIDDlgItem, lpString)
__EXTERN INTEGER __CALL_1 SetDlgItemTextW(WinApi_PtrVoid hDlg, INTEGER nIDDlgItem, WinApi_PtrWSTR lpString);
...
__EXTERN INTEGER __CALL_1 SetEndOfFile(WinApi_PtrVoid hFile);
#define WinApi_SetEnhMetaFileBits(p0, p1)	SetEnhMetaFileBits(p0, p1)
__EXTERN WinApi_PtrVoid __CALL_1 SetEnhMetaFileBits(INTEGER p0, CHAR *p1);
...
__EXTERN INTEGER __CALL_1 SetEvent(WinApi_PtrVoid hEvent);
...
__EXTERN INTEGER __CALL_1 SetFilePointer(WinApi_PtrVoid hFile, INTEGER lDistanceToMove, INTEGER *lpDistanceToMoveHigh, INTEGER dwMoveMethod);
...
__EXTERN INTEGER __CALL_1 SetFileSecurityA(WinApi_PtrSTR lpFileName, SET SecurityInformation, WinApi_PtrVoid pSecurityDescriptor);
...
__EXTERN INTEGER __CALL_1 SetFileSecurityW(WinApi_PtrWSTR lpFileName, SET SecurityInformation, WinApi_PtrVoid pSecurityDescriptor);
...
__EXTERN INTEGER __CALL_1 SetFileTime(WinApi_PtrVoid hFile, WinApi_FILETIME *lpCreationTime, WinApi_FILETIME *lpLastAccessTime, WinApi_FILETIME *lpLastWriteTime);
#define WinApi_SetFocus(hWnd)	SetFocus(hWnd)
__EXTERN WinApi_PtrVoid __CALL_1 SetFocus(WinApi_PtrVoid hWnd);
#define WinApi_SetForegroundWindow(hWnd)	SetForegroundWindow(hWnd)
__EXTERN INTEGER __CALL_1 SetForegroundWindow(WinApi_PtrVoid hWnd);
...
__EXTERN INTEGER __CALL_1 SetFormA(WinApi_PtrVoid hPrinter, WinApi_PtrSTR pFormName, INTEGER Level, CHAR *pForm);
#define WinApi_SetFormW(hPrinter, pFormName, Level, pForm)	SetFormW(hPrinter, pFormName, Level, pForm)
__EXTERN INTEGER __CALL_1 SetFormW(WinApi_PtrVoid hPrinter, WinApi_PtrWSTR pFormName, INTEGER Level, CHAR *pForm);
#define WinApi_SetGraphicsMode(hdc, iMode)	SetGraphicsMode(hdc, iMode)
__EXTERN INTEGER __CALL_1 SetGraphicsMode(WinApi_PtrVoid hdc, INTEGER iMode);
...
__EXTERN INTEGER __CALL_1 SetHandleInformation(WinApi_PtrVoid hObject, INTEGER dwMask, SET dwFlags);
#define WinApi_SetICMMode(p0, p1)	SetICMMode(p0, p1)
__EXTERN INTEGER __CALL_1 SetICMMode(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_SetICMProfile(p0, p1)	SetICMProfileA(p0, p1)
#define WinApi_SetICMProfileA(p0, p1)	SetICMProfileA(p0, p1)
__EXTERN INTEGER __CALL_1 SetICMProfileA(WinApi_PtrVoid p0, WinApi_PtrSTR p1);
#define WinApi_SetICMProfileW(p0, p1)	SetICMProfileW(p0, p1)
__EXTERN INTEGER __CALL_1 SetICMProfileW(WinApi_PtrVoid p0, WinApi_PtrWSTR p1);
...
__EXTERN INTEGER __CALL_1 SetJobA(WinApi_PtrVoid hPrinter, INTEGER JobId, INTEGER Level, CHAR *pJob, INTEGER Command);
#define WinApi_SetJobW(hPrinter, JobId, Level, pJob, Command)	SetJobW(hPrinter, JobId, Level, pJob, Command)
__EXTERN INTEGER __CALL_1 SetJobW(WinApi_PtrVoid hPrinter, INTEGER JobId, INTEGER Level, CHAR *pJob, INTEGER Command);
...
__EXTERN INTEGER __CALL_1 SetKernelObjectSecurity(WinApi_PtrVoid Handle, SET SecurityInformation, WinApi_PtrVoid SecurityDescriptor);
...
__EXTERN INTEGER __CALL_1 SetMailslotInfo(WinApi_PtrVoid hMailslot, INTEGER lReadTimeout);
#define WinApi_SetMapMode(p0, p1)	SetMapMode(p0, p1)
__EXTERN INTEGER __CALL_1 SetMapMode(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_SetMapperFlags(p0, p1)	SetMapperFlags(p0, p1)
__EXTERN INTEGER __CALL_1 SetMapperFlags(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_SetMenu(hWnd, hMenu)	SetMenu(hWnd, hMenu)
__EXTERN INTEGER __CALL_1 SetMenu(WinApi_PtrVoid hWnd, WinApi_PtrVoid hMenu);
#define WinApi_SetMenuContextHelpId(p0, p1)	SetMenuContextHelpId(p0, p1)
__EXTERN INTEGER __CALL_1 SetMenuContextHelpId(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_SetMenuDefaultItem(hMenu, uItem, fByPos)	SetMenuDefaultItem(hMenu, uItem, fByPos)
__EXTERN INTEGER __CALL_1 SetMenuDefaultItem(WinApi_PtrVoid hMenu, INTEGER uItem, INTEGER fByPos);
...
__EXTERN INTEGER __CALL_1 SetMenuItemBitmaps(WinApi_PtrVoid hMenu, INTEGER uPosition, SET uFlags, WinApi_PtrVoid hBitmapUnchecked, WinApi_PtrVoid hBitmapChecked);
...
__EXTERN INTEGER __CALL_1 SetMenuItemInfoA(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_MENUITEMINFOA *p3);
#define WinApi_SetMenuItemInfoW(p0, p1, p2, p3, p3__typ)	SetMenuItemInfoW(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 SetMenuItemInfoW(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_MENUITEMINFOW *p3);
#define WinApi_SetMessageExtraInfo(lParam)	SetMessageExtraInfo(lParam)
__EXTERN WinApi_PtrVoid __CALL_1 SetMessageExtraInfo(WinApi_PtrVoid lParam);
...
__EXTERN WinApi_PtrVoid __CALL_1 SetMetaFileBitsEx(INTEGER p0, BYTE *p1);
#define WinApi_SetMetaRgn(p0)	SetMetaRgn(p0)
__EXTERN INTEGER __CALL_1 SetMetaRgn(WinApi_PtrVoid p0);
#define WinApi_SetMiterLimit(p0, p1, p2)	SetMiterLimit(p0, p1, p2)
__EXTERN INTEGER __CALL_1 SetMiterLimit(WinApi_PtrVoid p0, REAL p1, REAL *p2);
...
__EXTERN INTEGER __CALL_1 SetNamedPipeHandleState(WinApi_PtrVoid hNamedPipe, INTEGER *lpMode, INTEGER *lpMaxCollectionCount, INTEGER *lpCollectDataTimeout);
#define WinApi_SetPaletteEntries(p0, p1, p2, p3, p3__typ)	SetPaletteEntries(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 SetPaletteEntries(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_PALETTEENTRY *p3);
#define WinApi_SetParent(hWndChild, hWndNewParent)	SetParent(hWndChild, hWndNewParent)
__EXTERN WinApi_PtrVoid __CALL_1 SetParent(WinApi_PtrVoid hWndChild, WinApi_PtrVoid hWndNewParent);
#define WinApi_SetPixel(p0, p1, p2, p3)	SetPixel(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 SetPixel(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3);
#define WinApi_SetPixelFormat(p0, p1, p2, p2__typ)	SetPixelFormat(p0, p1, p2)
__EXTERN INTEGER __CALL_1 SetPixelFormat(WinApi_PtrVoid p0, INTEGER p1, WinApi_PIXELFORMATDESCRIPTOR *p2);
#define WinApi_SetPixelV(p0, p1, p2, p3)	SetPixelV(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 SetPixelV(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3);
#define WinApi_SetPolyFillMode(p0, p1)	SetPolyFillMode(p0, p1)
__EXTERN INTEGER __CALL_1 SetPolyFillMode(WinApi_PtrVoid p0, INTEGER p1);
...
__EXTERN INTEGER __CALL_1 SetPrinterA(WinApi_PtrVoid hPrinter, INTEGER Level, CHAR *pPrinter, INTEGER Command);
...
__EXTERN INTEGER __CALL_1 SetPrinterDataA(WinApi_PtrVoid hPrinter, WinApi_PtrSTR pValueName, INTEGER Type, CHAR *pData, INTEGER cbData);
...
__EXTERN INTEGER __CALL_1 SetPrinterDataW(WinApi_PtrVoid hPrinter, WinApi_PtrWSTR pValueName, INTEGER Type, CHAR *pData, INTEGER cbData);
#define WinApi_SetPrinterW(hPrinter, Level, pPrinter, Command)	SetPrinterW(hPrinter, Level, pPrinter, Command)
__EXTERN INTEGER __CALL_1 SetPrinterW(WinApi_PtrVoid hPrinter, INTEGER Level, CHAR *pPrinter, INTEGER Command);
#define WinApi_SetPriorityClass(hProcess, dwPriorityClass)	SetPriorityClass(hProcess, dwPriorityClass)
__EXTERN INTEGER __CALL_1 SetPriorityClass(WinApi_PtrVoid hProcess, INTEGER dwPriorityClass);
...
__EXTERN INTEGER __CALL_1 SetPrivateObjectSecurity(SET SecurityInformation, WinApi_PtrVoid ModificationDescriptor, WinApi_PtrVoid *ObjectsSecurityDescriptor, WinApi_GENERIC_MAPPING *GenericMapping, WinApi_PtrVoid Token);
...
__EXTERN INTEGER __CALL_1 SetProcessAffinityMask(WinApi_PtrVoid hProcess, INTEGER dwProcessAffinityMask);
...
__EXTERN INTEGER __CALL_1 SetProcessWindowStation(WinApi_PtrVoid hWinSta);
...
__EXTERN INTEGER __CALL_1 SetProcessWorkingSetSize(WinApi_PtrVoid hProcess, INTEGER dwMinimumWorkingSetSize, INTEGER dwMaximumWorkingSetSize);
...
__EXTERN INTEGER __CALL_1 SetPropA(WinApi_PtrVoid hWnd, WinApi_PtrSTR lpString, WinApi_PtrVoid hData);
#define WinApi_SetPropW(hWnd, lpString, hData)	SetPropW(hWnd, lpString, hData)
__EXTERN INTEGER __CALL_1 SetPropW(WinApi_PtrVoid hWnd, WinApi_PtrWSTR lpString, WinApi_PtrVoid hData);
#define WinApi_SetROP2(p0, p1)	SetROP2(p0, p1)
__EXTERN INTEGER __CALL_1 SetROP2(WinApi_PtrVoid p0, INTEGER p1);
...
__EXTERN INTEGER __CALL_1 SetRectRgn(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4);
#define WinApi_SetScrollInfo(p0, p1, p2, p2__typ, p3)	SetScrollInfo(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 SetScrollInfo(WinApi_PtrVoid p0, INTEGER p1, WinApi_SCROLLINFO *p2, INTEGER p3);
#define WinApi_SetScrollPos(hWnd, nBar, nPos, bRedraw)	SetScrollPos(hWnd, nBar, nPos, bRedraw)
__EXTERN INTEGER __CALL_1 SetScrollPos(WinApi_PtrVoid hWnd, INTEGER nBar, INTEGER nPos, INTEGER bRedraw);
#define WinApi_SetScrollRange(hWnd, nBar, nMinPos, nMaxPos, bRedraw)	SetScrollRange(hWnd, nBar, nMinPos, nMaxPos, bRedraw)
__EXTERN INTEGER __CALL_1 SetScrollRange(WinApi_PtrVoid hWnd, INTEGER nBar, INTEGER nMinPos, INTEGER nMaxPos, INTEGER bRedraw);
...
__EXTERN INTEGER __CALL_1 SetSecurityDescriptorDacl(WinApi_PtrVoid pSecurityDescriptor, INTEGER bDaclPresent, WinApi_ACL *pDacl, INTEGER bDaclDefaulted);
...
__EXTERN INTEGER __CALL_1 SetSecurityDescriptorGroup(WinApi_PtrVoid pSecurityDescriptor, WinApi_PtrVoid pGroup, INTEGER bGroupDefaulted);
...
__EXTERN INTEGER __CALL_1 SetSecurityDescriptorOwner(WinApi_PtrVoid pSecurityDescriptor, WinApi_PtrVoid pOwner, INTEGER bOwnerDefaulted);
...
__EXTERN INTEGER __CALL_1 SetSecurityDescriptorSacl(WinApi_PtrVoid pSecurityDescriptor, INTEGER bSaclPresent, WinApi_ACL *pSacl, INTEGER bSaclDefaulted);
...
__EXTERN INTEGER __CALL_1 SetServiceObjectSecurity(WinApi_PtrVoid hService, SET dwSecurityInformation, WinApi_PtrVoid lpSecurityDescriptor);
...
__EXTERN INTEGER __CALL_1 SetStdHandle(INTEGER nStdHandle, WinApi_PtrVoid hHandle);
#define WinApi_SetStretchBltMode(p0, p1)	SetStretchBltMode(p0, p1)
__EXTERN INTEGER __CALL_1 SetStretchBltMode(WinApi_PtrVoid p0, INTEGER p1);
...
__EXTERN INTEGER __CALL_1 SetSystemCursor(WinApi_PtrVoid hcur, INTEGER id);
#define WinApi_SetSystemPaletteUse(p0, p1)	SetSystemPaletteUse(p0, p1)
__EXTERN INTEGER __CALL_1 SetSystemPaletteUse(WinApi_PtrVoid p0, INTEGER p1);
...
__EXTERN INTEGER __CALL_1 SetTapeParameters(WinApi_PtrVoid hDevice, INTEGER dwOperation, WinApi_PtrVoid lpTapeInformation);
...
__EXTERN INTEGER __CALL_1 SetTapePosition(WinApi_PtrVoid hDevice, INTEGER dwPositionMethod, INTEGER dwPartition, INTEGER dwOffsetLow, INTEGER dwOffsetHigh, INTEGER bImmediate);
#define WinApi_SetTextAlign(p0, p1)	SetTextAlign(p0, p1)
__EXTERN SET __CALL_1 SetTextAlign(WinApi_PtrVoid p0, SET p1);
#define WinApi_SetTextCharacterExtra(p0, p1)	SetTextCharacterExtra(p0, p1)
__EXTERN INTEGER __CALL_1 SetTextCharacterExtra(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_SetTextColor(p0, p1)	SetTextColor(p0, p1)
__EXTERN INTEGER __CALL_1 SetTextColor(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_SetTextJustification(p0, p1, p2)	SetTextJustification(p0, p1, p2)
__EXTERN INTEGER __CALL_1 SetTextJustification(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2);
#define WinApi_SetThreadAffinityMask(hThread, dwThreadAffinityMask)	SetThreadAffinityMask(hThread, dwThreadAffinityMask)
__EXTERN INTEGER __CALL_1 SetThreadAffinityMask(WinApi_PtrVoid hThread, INTEGER dwThreadAffinityMask);
#define WinApi_SetThreadContext(hThread, lpContext, lpContext__typ)	SetThreadContext(hThread, lpContext)
__EXTERN INTEGER __CALL_1 SetThreadContext(WinApi_PtrVoid hThread, WinApi_CONTEXT *lpContext);
#define WinApi_SetThreadDesktop(hDesktop)	SetThreadDesktop(hDesktop)
__EXTERN INTEGER __CALL_1 SetThreadDesktop(WinApi_PtrVoid hDesktop);
#define WinApi_SetThreadIdealProcessor(hThread, dwIdealProcessor)	SetThreadIdealProcessor(hThread, dwIdealProcessor)
__EXTERN INTEGER __CALL_1 SetThreadIdealProcessor(WinApi_PtrVoid hThread, INTEGER dwIdealProcessor);
...
__EXTERN INTEGER __CALL_1 SetThreadPriority(WinApi_PtrVoid hThread, INTEGER nPriority);
#define WinApi_SetThreadPriorityBoost(hThread, bDisablePriorityBoost)	SetThreadPriorityBoost(hThread, bDisablePriorityBoost)
__EXTERN INTEGER __CALL_1 SetThreadPriorityBoost(WinApi_PtrVoid hThread, INTEGER bDisablePriorityBoost);
#define WinApi_SetThreadToken(Thread, Token)	SetThreadToken(Thread, Token)
__EXTERN INTEGER __CALL_1 SetThreadToken(WinApi_PtrVoid *Thread, WinApi_PtrVoid Token);
...
__EXTERN INTEGER __CALL_1 SetTimer(WinApi_PtrVoid hWnd, INTEGER nIDEvent, INTEGER uElapse, WinApi_TIMERPROC lpTimerFunc);
...
__EXTERN INTEGER __CALL_1 SetTokenInformation(WinApi_PtrVoid TokenHandle, INTEGER TokenInformationClass, WinApi_PtrVoid TokenInformation, INTEGER TokenInformationLength);
...
__EXTERN INTEGER __CALL_1 SetUserObjectInformationA(WinApi_PtrVoid hObj, INTEGER nIndex, WinApi_PtrVoid pvInfo, INTEGER nLength);
#define WinApi_SetUserObjectInformationW(hObj, nIndex, pvInfo, nLength)	SetUserObjectInformationW(hObj, nIndex, pvInfo, nLength)
__EXTERN INTEGER __CALL_1 SetUserObjectInformationW(WinApi_PtrVoid hObj, INTEGER nIndex, WinApi_PtrVoid pvInfo, INTEGER nLength);
#define WinApi_SetUserObjectSecurity(hObj, pSIRequested, pSID)	SetUserObjectSecurity(hObj, pSIRequested, pSID)
__EXTERN INTEGER __CALL_1 SetUserObjectSecurity(WinApi_PtrVoid hObj, INTEGER *pSIRequested, WinApi_PtrVoid pSID);
#define WinApi_SetViewportExtEx(p0, p1, p2, p3, p3__typ)	SetViewportExtEx(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 SetViewportExtEx(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_SIZE *p3);
#define WinApi_SetViewportOrgEx(p0, p1, p2, p3, p3__typ)	SetViewportOrgEx(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 SetViewportOrgEx(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_POINT *p3);
...
__EXTERN INTEGER __CALL_1 SetWaitableTimer(WinApi_PtrVoid hTimer, LONGINT *lpDueTime, INTEGER lPeriod, WinApi_TIMERAPCROUTINE pfnCompletionRoutine, WinApi_PtrVoid lpArgToCompletionRoutine, INTEGER fResume);
#define WinApi_SetWinMetaFileBits(p0, p1, p2, p3, p3__typ)	SetWinMetaFileBits(p0, p1, p2, p3)
__EXTERN WinApi_PtrVoid __CALL_1 SetWinMetaFileBits(INTEGER p0, CHAR *p1, WinApi_PtrVoid p2, WinApi_METAFILEPICT *p3);
#define WinApi_SetWindowContextHelpId(p0, p1)	SetWindowContextHelpId(p0, p1)
__EXTERN INTEGER __CALL_1 SetWindowContextHelpId(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_SetWindowExtEx(p0, p1, p2, p3, p3__typ)	SetWindowExtEx(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 SetWindowExtEx(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_SIZE *p3);
...
__EXTERN INTEGER __CALL_1 SetWindowLongA(WinApi_PtrVoid hWnd, INTEGER nIndex, INTEGER dwNewLong);
#define WinApi_SetWindowLongW(hWnd, nIndex, dwNewLong)	SetWindowLongW(hWnd, nIndex, dwNewLong)
__EXTERN INTEGER __CALL_1 SetWindowLongW(WinApi_PtrVoid hWnd, INTEGER nIndex, INTEGER dwNewLong);
#define WinApi_SetWindowOrgEx(p0, p1, p2, p3, p3__typ)	SetWindowOrgEx(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 SetWindowOrgEx(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_POINT *p3);
#define WinApi_SetWindowPlacement(hWnd, lpwndpl, lpwndpl__typ)	SetWindowPlacement(hWnd, lpwndpl)
__EXTERN INTEGER __CALL_1 SetWindowPlacement(WinApi_PtrVoid hWnd, WinApi_WINDOWPLACEMENT *lpwndpl);
#define WinApi_SetWindowPos(hWnd, hWndInsertAfter, X, Y, cx, cy, uFlags)	SetWindowPos(hWnd, hWndInsertAfter, X, Y, cx, cy, uFlags)
__EXTERN INTEGER __CALL_1 SetWindowPos(WinApi_PtrVoid hWnd, WinApi_PtrVoid hWndInsertAfter, INTEGER X, INTEGER Y, INTEGER cx, INTEGER cy, SET uFlags);
#define WinApi_SetWindowRgn(hWnd, hRgn, bRedraw)	SetWindowRgn(hWnd, hRgn, bRedraw)
__EXTERN INTEGER __CALL_1 SetWindowRgn(WinApi_PtrVoid hWnd, WinApi_PtrVoid hRgn, INTEGER bRedraw);
...
__EXTERN INTEGER __CALL_1 SetWindowTextA(WinApi_PtrVoid hWnd, WinApi_PtrSTR lpString);
#define WinApi_SetWindowTextW(hWnd, lpString)	SetWindowTextW(hWnd, lpString)
__EXTERN INTEGER __CALL_1 SetWindowTextW(WinApi_PtrVoid hWnd, WinApi_PtrWSTR lpString);
#define WinApi_SetWindowWord(hWnd, nIndex, wNewWord)	SetWindowWord(hWnd, nIndex, wNewWord)
__EXTERN SHORTINT __CALL_1 SetWindowWord(WinApi_PtrVoid hWnd, INTEGER nIndex, SHORTINT wNewWord);
...
__EXTERN WinApi_PtrVoid __CALL_1 SetWindowsHookExA(INTEGER idHook, WinApi_HOOKPROC lpfn, WinApi_PtrVoid hmod, INTEGER dwThreadId);
#define WinApi_SetWindowsHookExW(idHook, lpfn, hmod, dwThreadId)	SetWindowsHookExW(idHook, lpfn, hmod, dwThreadId)
__EXTERN WinApi_PtrVoid __CALL_1 SetWindowsHookExW(INTEGER idHook, WinApi_HOOKPROC lpfn, WinApi_PtrVoid hmod, INTEGER dwThreadId);
...
__EXTERN INTEGER __CALL_1 SetWorldTransform(WinApi_PtrVoid p0, WinApi_XFORM *p1);
#define WinApi_SetupComm(hFile, dwInQueue, dwOutQueue)	SetupComm(hFile, dwInQueue, dwOutQueue)
__EXTERN INTEGER __CALL_1 SetupComm(WinApi_PtrVoid hFile, INTEGER dwInQueue, INTEGER dwOutQueue);
...
__EXTERN INTEGER __CALL_1 ShellAboutA(WinApi_PtrVoid hWnd, WinApi_PtrSTR szApp, WinApi_PtrSTR szOtherStuff, WinApi_PtrVoid hIcon);
#define WinApi_ShellAboutW(hWnd, szApp, szOtherStuff, hIcon)	ShellAboutW(hWnd, szApp, szOtherStuff, hIcon)
__EXTERN INTEGER __CALL_1 ShellAboutW(WinApi_PtrVoid hWnd, WinApi_PtrWSTR szApp, WinApi_PtrWSTR szOtherStuff, WinApi_PtrVoid hIcon);
...
__EXTERN WinApi_PtrVoid __CALL_1 ShellExecuteA(WinApi_PtrVoid hwnd, WinApi_PtrSTR lpOperation, WinApi_PtrSTR lpFile, WinApi_PtrSTR lpParameters, WinApi_PtrSTR lpDirectory, INTEGER nShowCmd);
...
__EXTERN WinApi_PtrVoid __CALL_1 ShellExecuteW(WinApi_PtrVoid hwnd, WinApi_PtrWSTR lpOperation, WinApi_PtrWSTR lpFile, WinApi_PtrWSTR lpParameters, WinApi_PtrWSTR lpDirectory, INTEGER nShowCmd);
...
__EXTERN INTEGER __CALL_1 ShowCaret(WinApi_PtrVoid hWnd);
...
__EXTERN INTEGER __CALL_1 ShowOwnedPopups(WinApi_PtrVoid hWnd, INTEGER fShow);
#define WinApi_ShowScrollBar(hWnd, wBar, bShow)	ShowScrollBar(hWnd, wBar, bShow)
__EXTERN INTEGER __CALL_1 ShowScrollBar(WinApi_PtrVoid hWnd, INTEGER wBar, INTEGER bShow);
#define WinApi_ShowWindow(hWnd, nCmdShow)	ShowWindow(hWnd, nCmdShow)
__EXTERN INTEGER __CALL_1 ShowWindow(WinApi_PtrVoid hWnd, INTEGER nCmdShow);
#define WinApi_ShowWindowAsync(hWnd, nCmdShow)	ShowWindowAsync(hWnd, nCmdShow)
__EXTERN INTEGER __CALL_1 ShowWindowAsync(WinApi_PtrVoid hWnd, INTEGER nCmdShow);
...
__EXTERN INTEGER __CALL_1 SignalObjectAndWait(WinApi_PtrVoid hObjectToSignal, WinApi_PtrVoid hObjectToWaitOn, INTEGER dwMilliseconds, INTEGER bAlertable);
#define WinApi_SizeofResource(hModule, hResInfo)	SizeofResource(hModule, hResInfo)
__EXTERN INTEGER __CALL_1 SizeofResource(WinApi_PtrVoid hModule, WinApi_PtrVoid hResInfo);
...
__EXTERN INTEGER __CALL_1 StartDocA(WinApi_PtrVoid p0, WinApi_DOCINFOA *p1);
...
__EXTERN INTEGER __CALL_1 StartDocPrinterA(WinApi_PtrVoid hPrinter, INTEGER Level, CHAR *pDocInfo);
#define WinApi_StartDocPrinterW(hPrinter, Level, pDocInfo)	StartDocPrinterW(hPrinter, Level, pDocInfo)
__EXTERN INTEGER __CALL_1 StartDocPrinterW(WinApi_PtrVoid hPrinter, INTEGER Level, CHAR *pDocInfo);
#define WinApi_StartDocW(p0, p1, p1__typ)	StartDocW(p0, p1)
__EXTERN INTEGER __CALL_1 StartDocW(WinApi_PtrVoid p0, WinApi_DOCINFOW *p1);
#define WinApi_StartPage(p0)	StartPage(p0)
__EXTERN INTEGER __CALL_1 StartPage(WinApi_PtrVoid p0);
#define WinApi_StartPagePrinter(hPrinter)	StartPagePrinter(hPrinter)
__EXTERN INTEGER __CALL_1 StartPagePrinter(WinApi_PtrVoid hPrinter);
...
__EXTERN INTEGER __CALL_1 StartServiceA(WinApi_PtrVoid hService, INTEGER dwNumServiceArgs, WinApi_PtrSTR *lpServiceArgVectors);
...
__EXTERN INTEGER __CALL_1 StartServiceW(WinApi_PtrVoid hService, INTEGER dwNumServiceArgs, struct {
	LONGINT len[1];
	WinApi_PtrWSTR data[1];
} *lpServiceArgVectors);
#define WinApi_StretchBlt(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10)	StretchBlt(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10)
__EXTERN INTEGER __CALL_1 StretchBlt(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4, WinApi_PtrVoid p5, INTEGER p6, INTEGER p7, INTEGER p8, INTEGER p9, INTEGER p10);
...
__EXTERN INTEGER __CALL_1 StretchDIBits(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER p4, INTEGER p5, INTEGER p6, INTEGER p7, INTEGER p8, WinApi_PtrVoid p9, WinApi_BITMAPINFO *p10, INTEGER p11, INTEGER p12);
#define WinApi_StrokeAndFillPath(p0)	StrokeAndFillPath(p0)
__EXTERN INTEGER __CALL_1 StrokeAndFillPath(WinApi_PtrVoid p0);
#define WinApi_StrokePath(p0)	StrokePath(p0)
__EXTERN INTEGER __CALL_1 StrokePath(WinApi_PtrVoid p0);
...
__EXTERN INTEGER __CALL_1 SuspendThread(WinApi_PtrVoid hThread);
#define WinApi_SwapBuffers(p0)	SwapBuffers(p0)
__EXTERN INTEGER __CALL_1 SwapBuffers(WinApi_PtrVoid p0);
...
__EXTERN INTEGER __CALL_1 SwitchDesktop(WinApi_PtrVoid hDesktop);
#define WinApi_SwitchToFiber(lpFiber)	SwitchToFiber(lpFiber)
__EXTERN void __CALL_1 SwitchToFiber(WinApi_PtrVoid lpFiber);
...
__EXTERN INTEGER __CALL_1 SystemParametersInfoA(INTEGER uiAction, INTEGER uiParam, WinApi_PtrVoid pvParam, INTEGER fWinIni);
...
__EXTERN INTEGER __CALL_1 SystemParametersInfoW(INTEGER uiAction, INTEGER uiParam, WinApi_PtrVoid pvParam, INTEGER fWinIni);
...
__EXTERN INTEGER __CALL_1 TabbedTextOutA(WinApi_PtrVoid hDC, INTEGER X, INTEGER Y, WinApi_PtrSTR lpString, INTEGER nCount, INTEGER nTabPositions, INTEGER *lpnTabStopPositions, INTEGER nTabOrigin);
...
__EXTERN INTEGER __CALL_1 TabbedTextOutW(WinApi_PtrVoid hDC, INTEGER X, INTEGER Y, WinApi_PtrWSTR lpString, INTEGER nCount, INTEGER nTabPositions, INTEGER *lpnTabStopPositions, INTEGER nTabOrigin);
#define WinApi_TerminateProcess(hProcess, uExitCode)	TerminateProcess(hProcess, uExitCode)
__EXTERN INTEGER __CALL_1 TerminateProcess(WinApi_PtrVoid hProcess, INTEGER uExitCode);
#define WinApi_TerminateThread(hThread, dwExitCode)	TerminateThread(hThread, dwExitCode)
__EXTERN INTEGER __CALL_1 TerminateThread(WinApi_PtrVoid hThread, INTEGER dwExitCode);
...
__EXTERN INTEGER __CALL_1 TextOutA(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_PtrSTR p3, INTEGER p4);
#define WinApi_TextOutW(p0, p1, p2, p3, p4)	TextOutW(p0, p1, p2, p3, p4)
__EXTERN INTEGER __CALL_1 TextOutW(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, WinApi_PtrWSTR p3, INTEGER p4);
...
__EXTERN SHORTINT __CALL_1 TileWindows(WinApi_PtrVoid hwndParent, INTEGER wHow, WinApi_RECT *lpRect, INTEGER cKids, WinApi_PtrVoid *lpKids);
...
__EXTERN WinApi_PtrVoid __CALL_1 TlsGetValue(INTEGER dwTlsIndex);
#define WinApi_TlsSetValue(dwTlsIndex, lpTlsValue)	TlsSetValue(dwTlsIndex, lpTlsValue)
__EXTERN INTEGER __CALL_1 TlsSetValue(INTEGER dwTlsIndex, WinApi_PtrVoid lpTlsValue);
...
__EXTERN INTEGER __CALL_1 ToAsciiEx(INTEGER uVirtKey, INTEGER uScanCode, CHAR *lpKeyState, SHORTINT *lpChar, SET uFlags, WinApi_PtrVoid dwhkl);
...
__EXTERN INTEGER __CALL_1 ToUnicodeEx(INTEGER wVirtKey, INTEGER wScanCode, CHAR *lpKeyState, WinApi_PtrWSTR pwszBuff, INTEGER cchBuff, INTEGER wFlags, WinApi_PtrVoid dwhkl);
...
__EXTERN INTEGER __CALL_1 TrackPopupMenu(WinApi_PtrVoid hMenu, SET uFlags, INTEGER x, INTEGER y, INTEGER nReserved, WinApi_PtrVoid hWnd, WinApi_RECT *prcRect);
#define WinApi_TrackPopupMenuEx(p0, p1, p2, p3, p4, p5, p5__typ)	TrackPopupMenuEx(p0, p1, p2, p3, p4, p5)
__EXTERN INTEGER __CALL_1 TrackPopupMenuEx(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, WinApi_PtrVoid p4, WinApi_TPMPARAMS *p5);
...
__EXTERN INTEGER __CALL_1 TransactNamedPipe(WinApi_PtrVoid hNamedPipe, WinApi_PtrVoid lpInBuffer, INTEGER nInBufferSize, WinApi_PtrVoid lpOutBuffer, INTEGER nOutBufferSize, INTEGER *lpBytesRead, WinApi_OVERLAPPED *lpOverlapped);
...
__EXTERN INTEGER __CALL_1 TranslateAcceleratorA(WinApi_PtrVoid hWnd, WinApi_PtrVoid hAccTable, WinApi_MSG *lpMsg);
#define WinApi_TranslateAcceleratorW(hWnd, hAccTable, lpMsg, lpMsg__typ)	TranslateAcceleratorW(hWnd, hAccTable, lpMsg)
__EXTERN INTEGER __CALL_1 TranslateAcceleratorW(WinApi_PtrVoid hWnd, WinApi_PtrVoid hAccTable, WinApi_MSG *lpMsg);
...
__EXTERN INTEGER __CALL_1 TranslateMDISysAccel(WinApi_PtrVoid hWndClient, WinApi_MSG *lpMsg);
...
__EXTERN INTEGER __CALL_1 TransmitCommChar(WinApi_PtrVoid hFile, CHAR cChar);
...
__EXTERN INTEGER __CALL_1 UnhookWindowsHookEx(WinApi_PtrVoid hhk);
...
__EXTERN INTEGER __CALL_1 UnloadKeyboardLayout(WinApi_PtrVoid hkl);
...
__EXTERN INTEGER __CALL_1 UnlockFile(WinApi_PtrVoid hFile, INTEGER dwFileOffsetLow, INTEGER dwFileOffsetHigh, INTEGER nNumberOfBytesToUnlockLow, INTEGER nNumberOfBytesToUnlockHigh);
...
__EXTERN INTEGER __CALL_1 UnlockFileEx(WinApi_PtrVoid hFile, INTEGER dwReserved, INTEGER nNumberOfBytesToUnlockLow, INTEGER nNumberOfBytesToUnlockHigh, WinApi_OVERLAPPED *lpOverlapped);
#define WinApi_UnlockServiceDatabase(ScLock)	UnlockServiceDatabase(ScLock)
__EXTERN INTEGER __CALL_1 UnlockServiceDatabase(WinApi_PtrVoid ScLock);
#define WinApi_UnmapViewOfFile(lpBaseAddress)	UnmapViewOfFile(lpBaseAddress)
__EXTERN INTEGER __CALL_1 UnmapViewOfFile(WinApi_PtrVoid lpBaseAddress);
...
__EXTERN INTEGER __CALL_1 UnrealizeObject(WinApi_PtrVoid p0);
...
__EXTERN INTEGER __CALL_1 UnregisterClassA(WinApi_PtrSTR lpClassName, WinApi_PtrVoid hInstance);
#define WinApi_UnregisterClassW(lpClassName, hInstance)	UnregisterClassW(lpClassName, hInstance)
__EXTERN INTEGER __CALL_1 UnregisterClassW(WinApi_PtrWSTR lpClassName, WinApi_PtrVoid hInstance);
#define WinApi_UnregisterHotKey(hWnd, id)	UnregisterHotKey(hWnd, id)
__EXTERN INTEGER __CALL_1 UnregisterHotKey(WinApi_PtrVoid hWnd, INTEGER id);
#define WinApi_UpdateColors(p0)	UpdateColors(p0)
__EXTERN INTEGER __CALL_1 UpdateColors(WinApi_PtrVoid p0);
...
__EXTERN INTEGER __CALL_1 UpdateResourceA(WinApi_PtrVoid hUpdate, WinApi_PtrSTR lpType, WinApi_PtrSTR lpName, SHORTINT wLanguage, WinApi_PtrVoid lpData, INTEGER cbData);
...
__EXTERN INTEGER __CALL_1 UpdateResourceW(WinApi_PtrVoid hUpdate, WinApi_PtrWSTR lpType, WinApi_PtrWSTR lpName, SHORTINT wLanguage, WinApi_PtrVoid lpData, INTEGER cbData);
#define WinApi_UpdateWindow(hWnd)	UpdateWindow(hWnd)
__EXTERN INTEGER __CALL_1 UpdateWindow(WinApi_PtrVoid hWnd);
#define WinApi_ValidateRect(hWnd, lpRect, lpRect__typ)	ValidateRect(hWnd, lpRect)
__EXTERN INTEGER __CALL_1 ValidateRect(WinApi_PtrVoid hWnd, WinApi_RECT *lpRect);
#define WinApi_ValidateRgn(hWnd, hRgn)	ValidateRgn(hWnd, hRgn)
__EXTERN INTEGER __CALL_1 ValidateRgn(WinApi_PtrVoid hWnd, WinApi_PtrVoid hRgn);
...
__EXTERN INTEGER __CALL_1 VerQueryValueA(WinApi_PtrVoid pBlock, WinApi_PtrSTR lpSubBlock, struct {
	LONGINT len[1];
	WinApi_PtrVoid data[1];
...
__EXTERN INTEGER __CALL_1 VerQueryValueW(WinApi_PtrVoid pBlock, WinApi_PtrWSTR lpSubBlock, struct {
	LONGINT len[1];
	WinApi_PtrVoid data[1];
} *lplpBuffer, INTEGER *puLen);
...
__EXTERN WinApi_PtrVoid __CALL_1 VirtualAlloc(WinApi_PtrVoid lpAddress, WinApi_SIZE_T dwSize, SET flAllocationType, SET flProtect);
...
__EXTERN WinApi_PtrVoid __CALL_1 VirtualAllocEx(WinApi_PtrVoid hProcess, WinApi_PtrVoid lpAddress, WinApi_SIZE_T dwSize, SET flAllocationType, SET flProtect);
#define WinApi_VirtualFree(lpAddress, dwSize, dwFreeType)	VirtualFree(lpAddress, dwSize, dwFreeType)
__EXTERN INTEGER __CALL_1 VirtualFree(WinApi_PtrVoid lpAddress, WinApi_SIZE_T dwSize, SET dwFreeType);
#define WinApi_VirtualLock(lpAddress, dwSize)	VirtualLock(lpAddress, dwSize)
__EXTERN INTEGER __CALL_1 VirtualLock(WinApi_PtrVoid lpAddress, WinApi_SIZE_T dwSize);
...
__EXTERN INTEGER __CALL_1 VirtualProtect(WinApi_PtrVoid lpAddress, WinApi_SIZE_T dwSize, SET flNewProtect, INTEGER *lpflOldProtect);
...
__EXTERN INTEGER __CALL_1 VirtualProtectEx(WinApi_PtrVoid hProcess, WinApi_PtrVoid lpAddress, WinApi_SIZE_T dwSize, SET flNewProtect, INTEGER *lpflOldProtect);
#define WinApi_VirtualQuery(lpAddress, lpBuffer, lpBuffer__typ, dwLength)	VirtualQuery(lpAddress, lpBuffer, dwLength)
__EXTERN WinApi_SIZE_T __CALL_1 VirtualQuery(WinApi_PtrVoid lpAddress, WinApi_MEMORY_BASIC_INFORMATION *lpBuffer, WinApi_SIZE_T dwLength);
...
__EXTERN WinApi_SIZE_T __CALL_1 VirtualQueryEx(WinApi_PtrVoid hProcess, WinApi_PtrVoid lpAddress, WinApi_MEMORY_BASIC_INFORMATION *lpBuffer, WinApi_SIZE_T dwLength);
#define WinApi_VirtualUnlock(lpAddress, dwSize)	VirtualUnlock(lpAddress, dwSize)
__EXTERN INTEGER __CALL_1 VirtualUnlock(WinApi_PtrVoid lpAddress, WinApi_SIZE_T dwSize);
...
__EXTERN SHORTINT __CALL_1 VkKeyScanExA(CHAR ch, WinApi_PtrVoid dwhkl);
#define WinApi_VkKeyScanExW(ch, dwhkl)	VkKeyScanExW(ch, dwhkl)
__EXTERN SHORTINT __CALL_1 VkKeyScanExW(SHORTINT ch, WinApi_PtrVoid dwhkl);
...
__EXTERN INTEGER __CALL_1 WaitCommEvent(WinApi_PtrVoid hFile, SET *lpEvtMask, WinApi_OVERLAPPED *lpOverlapped);
...
__EXTERN INTEGER __CALL_1 WaitForInputIdle(WinApi_PtrVoid hProcess, INTEGER dwMilliseconds);
...
__EXTERN INTEGER __CALL_1 WaitForMultipleObjects(INTEGER nCount, WinApi_PtrVoid *lpHandles, INTEGER bWaitAll, INTEGER dwMilliseconds);
...
__EXTERN INTEGER __CALL_1 WaitForMultipleObjectsEx(INTEGER nCount, WinApi_PtrVoid *lpHandles, INTEGER bWaitAll, INTEGER dwMilliseconds, INTEGER bAlertable);
#define WinApi_WaitForPrinterChange(hPrinter, Flags)	WaitForPrinterChange(hPrinter, Flags)
__EXTERN INTEGER __CALL_1 WaitForPrinterChange(WinApi_PtrVoid hPrinter, SET Flags);
#define WinApi_WaitForSingleObject(hHandle, dwMilliseconds)	WaitForSingleObject(hHandle, dwMilliseconds)
__EXTERN INTEGER __CALL_1 WaitForSingleObject(WinApi_PtrVoid hHandle, INTEGER dwMilliseconds);
...
__EXTERN INTEGER __CALL_1 WaitForSingleObjectEx(WinApi_PtrVoid hHandle, INTEGER dwMilliseconds, INTEGER bAlertable);
...
__EXTERN INTEGER __CALL_1 WidenPath(WinApi_PtrVoid p0);
...
__EXTERN INTEGER __CALL_1 WinHelpA(WinApi_PtrVoid hWndMain, WinApi_PtrSTR lpszHelp, INTEGER uCommand, INTEGER dwData);
#define WinApi_WinHelpW(hWndMain, lpszHelp, uCommand, dwData)	WinHelpW(hWndMain, lpszHelp, uCommand, dwData)
__EXTERN INTEGER __CALL_1 WinHelpW(WinApi_PtrVoid hWndMain, WinApi_PtrWSTR lpszHelp, INTEGER uCommand, INTEGER dwData);
#define WinApi_WindowFromDC(hDC)	WindowFromDC(hDC)
__EXTERN WinApi_PtrVoid __CALL_1 WindowFromDC(WinApi_PtrVoid hDC);
#define WinApi_WindowFromPoint(Point)	WindowFromPoint(Point)
__EXTERN WinApi_PtrVoid __CALL_1 WindowFromPoint(WinApi_POINT Point);
...
__EXTERN INTEGER __CALL_1 WriteConsoleA(WinApi_PtrVoid hConsoleOutput, WinApi_PtrVoid lpBuffer, INTEGER nNumberOfCharsToWrite, INTEGER *lpNumberOfCharsWritten, WinApi_PtrVoid lpReserved);
...
__EXTERN INTEGER __CALL_1 WriteConsoleInputA(WinApi_PtrVoid hConsoleInput, WinApi_INPUT_RECORD *lpBuffer, INTEGER nLength, INTEGER *lpNumberOfEventsWritten);
...
__EXTERN INTEGER __CALL_1 WriteConsoleInputW(WinApi_PtrVoid hConsoleInput, WinApi_INPUT_RECORD *lpBuffer, INTEGER nLength, INTEGER *lpNumberOfEventsWritten);
...
__EXTERN INTEGER __CALL_1 WriteConsoleOutputA(WinApi_PtrVoid hConsoleOutput, WinApi_CHAR_INFO *lpBuffer, WinApi_COORD dwBufferSize, WinApi_COORD dwBufferCoord, WinApi_SMALL_RECT *lpWriteRegion);
...
__EXTERN INTEGER __CALL_1 WriteConsoleOutputAttribute(WinApi_PtrVoid hConsoleOutput, SHORTINT *lpAttribute, INTEGER nLength, WinApi_COORD dwWriteCoord, INTEGER *lpNumberOfAttrsWritten);
...
__EXTERN INTEGER __CALL_1 WriteConsoleOutputCharacterA(WinApi_PtrVoid hConsoleOutput, WinApi_PtrSTR lpCharacter, INTEGER nLength, WinApi_COORD dwWriteCoord, INTEGER *lpNumberOfCharsWritten);
...
__EXTERN INTEGER __CALL_1 WriteConsoleOutputCharacterW(WinApi_PtrVoid hConsoleOutput, WinApi_PtrWSTR lpCharacter, INTEGER nLength, WinApi_COORD dwWriteCoord, INTEGER *lpNumberOfCharsWritten);
...
__EXTERN INTEGER __CALL_1 WriteConsoleOutputW(WinApi_PtrVoid hConsoleOutput, WinApi_CHAR_INFO *lpBuffer, WinApi_COORD dwBufferSize, WinApi_COORD dwBufferCoord, WinApi_SMALL_RECT *lpWriteRegion);
...
__EXTERN INTEGER __CALL_1 WriteConsoleW(WinApi_PtrVoid hConsoleOutput, WinApi_PtrVoid lpBuffer, INTEGER nNumberOfCharsToWrite, INTEGER *lpNumberOfCharsWritten, WinApi_PtrVoid lpReserved);
...
__EXTERN INTEGER __CALL_1 WriteFile(WinApi_PtrVoid hFile, WinApi_PtrVoid lpBuffer, INTEGER nNumberOfBytesToWrite, INTEGER *lpNumberOfBytesWritten, WinApi_OVERLAPPED *lpOverlapped);
...
__EXTERN INTEGER __CALL_1 WriteFileEx(WinApi_PtrVoid hFile, WinApi_PtrVoid lpBuffer, INTEGER nNumberOfBytesToWrite, WinApi_OVERLAPPED *lpOverlapped, WinApi_OVERLAPPED_COMPLETION_ROUTINE lpCompletionRoutine);
#define WinApi_WritePrinter(hPrinter, pBuf, cbBuf, pcWritten)	WritePrinter(hPrinter, pBuf, cbBuf, pcWritten)
__EXTERN INTEGER __CALL_1 WritePrinter(WinApi_PtrVoid hPrinter, WinApi_PtrVoid pBuf, INTEGER cbBuf, INTEGER *pcWritten);
...
__EXTERN INTEGER __CALL_1 WritePrivateProfileStructA(WinApi_PtrSTR lpszSection, WinApi_PtrSTR lpszKey, WinApi_PtrVoid lpStruct, INTEGER uSizeStruct, WinApi_PtrSTR szFile);
...
__EXTERN INTEGER __CALL_1 WritePrivateProfileStructW(WinApi_PtrWSTR lpszSection, WinApi_PtrWSTR lpszKey, WinApi_PtrVoid lpStruct, INTEGER uSizeStruct, WinApi_PtrWSTR szFile);
...
__EXTERN INTEGER __CALL_1 WriteProcessMemory(WinApi_PtrVoid hProcess, WinApi_PtrVoid lpBaseAddress, WinApi_PtrVoid lpBuffer, INTEGER nSize, INTEGER *lpNumberOfBytesWritten);
...
__EXTERN INTEGER __CALL_1 WriteTapemark(WinApi_PtrVoid hDevice, INTEGER dwTapemarkType, INTEGER dwTapemarkCount, INTEGER bImmediate);
...
__EXTERN INTEGER __CALL_1 _hread(INTEGER hFile, WinApi_PtrVoid lpBuffer, INTEGER lBytes);
...
__EXTERN INTEGER __CALL_1 _lread(INTEGER hFile, WinApi_PtrVoid lpBuffer, INTEGER uBytes);
...
__EXTERN INTEGER __CALL_1 wglCopyContext(WinApi_PtrVoid p0, WinApi_PtrVoid p1, INTEGER p2);
#define WinApi_wglCreateContext(p0)	wglCreateContext(p0)
__EXTERN WinApi_PtrVoid __CALL_1 wglCreateContext(WinApi_PtrVoid p0);
#define WinApi_wglCreateLayerContext(p0, p1)	wglCreateLayerContext(p0, p1)
__EXTERN WinApi_PtrVoid __CALL_1 wglCreateLayerContext(WinApi_PtrVoid p0, INTEGER p1);
#define WinApi_wglDeleteContext(p0)	wglDeleteContext(p0)
__EXTERN INTEGER __CALL_1 wglDeleteContext(WinApi_PtrVoid p0);
#define WinApi_wglDescribeLayerPlane(p0, p1, p2, p3, p4, p4__typ)	wglDescribeLayerPlane(p0, p1, p2, p3, p4)
__EXTERN INTEGER __CALL_1 wglDescribeLayerPlane(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, WinApi_LAYERPLANEDESCRIPTOR *p4);
#define WinApi_wglGetCurrentContext()	wglGetCurrentContext()
__EXTERN WinApi_PtrVoid __CALL_1 wglGetCurrentContext(void);
#define WinApi_wglGetCurrentDC()	wglGetCurrentDC()
__EXTERN WinApi_PtrVoid __CALL_1 wglGetCurrentDC(void);
#define WinApi_wglGetLayerPaletteEntries(p0, p1, p2, p3, p4)	wglGetLayerPaletteEntries(p0, p1, p2, p3, p4)
__EXTERN INTEGER __CALL_1 wglGetLayerPaletteEntries(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER *p4);
...
__EXTERN INTEGER __CALL_1 wglMakeCurrent(WinApi_PtrVoid p0, WinApi_PtrVoid p1);
#define WinApi_wglRealizeLayerPalette(p0, p1, p2)	wglRealizeLayerPalette(p0, p1, p2)
__EXTERN INTEGER __CALL_1 wglRealizeLayerPalette(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2);
#define WinApi_wglSetLayerPaletteEntries(p0, p1, p2, p3, p4)	wglSetLayerPaletteEntries(p0, p1, p2, p3, p4)
__EXTERN INTEGER __CALL_1 wglSetLayerPaletteEntries(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, INTEGER *p4);
#define WinApi_wglShareLists(p0, p1)	wglShareLists(p0, p1)
__EXTERN INTEGER __CALL_1 wglShareLists(WinApi_PtrVoid p0, WinApi_PtrVoid p1);
#define WinApi_wglSwapLayerBuffers(p0, p1)	wglSwapLayerBuffers(p0, p1)
__EXTERN INTEGER __CALL_1 wglSwapLayerBuffers(WinApi_PtrVoid p0, INTEGER p1);
...
__EXTERN INTEGER __CALL_1 wglUseFontBitmapsA(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3);
#define WinApi_wglUseFontBitmapsW(p0, p1, p2, p3)	wglUseFontBitmapsW(p0, p1, p2, p3)
__EXTERN INTEGER __CALL_1 wglUseFontBitmapsW(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3);
...
__EXTERN INTEGER __CALL_1 wglUseFontOutlinesA(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, REAL p4, REAL p5, INTEGER p6, WinApi_GLYPHMETRICSFLOAT *p7);
#define WinApi_wglUseFontOutlinesW(p0, p1, p2, p3, p4, p5, p6, p7, p7__typ)	wglUseFontOutlinesW(p0, p1, p2, p3, p4, p5, p6, p7)
__EXTERN INTEGER __CALL_1 wglUseFontOutlinesW(WinApi_PtrVoid p0, INTEGER p1, INTEGER p2, INTEGER p3, REAL p4, REAL p5, INTEGER p6, WinApi_GLYPHMETRICSFLOAT *p7);
