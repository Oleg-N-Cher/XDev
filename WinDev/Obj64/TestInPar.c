...
export void TestInPar_Struct2 (TestInPar_Struct1 str);
export void TestInPar_StructCopy (TestInPar_Struct str);
...
void TestInPar_StructCopy (TestInPar_Struct str)
{
}
...
void TestInPar_Struct2 (TestInPar_Struct1 str)
{
}
...
__TDESC(TestInPar_Struct__desc, 1, 0) = {__TDFLDS("Struct", 8), {-8}};
__TDESC(TestInPar_Struct1__desc, 1, 0) = {__TDFLDS("Struct1", 8), {-8}};
...
/* BEGIN */
	...
	Platform_DISPOSE((void*)&TestInPar_ptr);
	__FINI;
}
