...
/* BEGIN */
	...
	GrTiles_SetColors(GrScr_Blue, GrScr_Olive);
	DemoTiles_i = 0;
	...
	GrTiles_SetColors(GrScr_White, GrScr_Black);
	DemoTiles_i = 8;
	...
	GrTiles_SetColors(GrScr_Cyan, GrScr_Blue);
	DemoTiles_i = 10;
	...
	GrTiles_SetColors(GrScr_Black, GrScr_White);
	DemoTiles_i = 12;
	...
	GrTiles_SetColors(GrScr_Green, GrScr_Magenta);
	DemoTiles_i = 14;
