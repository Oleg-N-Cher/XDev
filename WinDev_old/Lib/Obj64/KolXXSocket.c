...
/*----------------------------------------------------------------------------*/
__TDESC(KolXXSocket_TBaseSocket__desc, 7, 4) = {__TDFLDS("TBaseSocket", 48), {8, 16, 24, 40, -40}};
__TDESC(KolXXSocket_TReceive__desc, 6, 2) = {__TDFLDS("TReceive", 32), {8, 16, -24}};
__TDESC(KolXXSocket_TClient__desc, 7, 4) = {__TDFLDS("TClient", 48), {8, 16, 24, 40, -40}};
...
__TDESC(KolXXSocket_TServerClient__desc, 7, 4) = {__TDFLDS("TServerClient", 48), {8, 16, 24, 40, -40}};
