...
SYSTEM_PTR AclUtils_FileOpen (CHAR *fileName, LONGINT fileName__len, INTEGER mode)
{
	...
	OpenMode[0] = 3;
	OpenMode[1] = 5;
	return WinApi_CreateFile((SYSTEM_PTR)((LONGINT)fileName), AccessMode[__X((INTEGER)((SET)mode & 0x03), 3)], ShareMode[__X(__ASHR((INTEGER)((SET)mode & 0xf0), 4, INTEGER), 5)], NIL, NIL, OpenMode[__X(__ASHR((INTEGER)((SET)mode & 0x04), 2, INTEGER), 2)], 0x80, NIL);
}
