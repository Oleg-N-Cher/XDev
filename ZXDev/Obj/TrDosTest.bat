...
%bin%\sdcc TrDosTest.c -mz80 --reserve-regs-iy --code-loc 26000 --data-loc 0xF800 --opt-code-size --funsigned-char --disable-warning 126 -I "." -I %Lib% -L %Lib%/z80 Basic.lib XDev.lib trdos.lib
