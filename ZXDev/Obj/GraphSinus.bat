...
%bin%\sdcc GraphSinus.c -mz80 --code-loc 40000 --data-loc 45000 --opt-code-size --disable-warning 126 -I %lib% -I %lib%\C -I %lib%\Obj -L %lib% --disable-warning 59 --disable-warning 85 Graph.lib XDev.lib
