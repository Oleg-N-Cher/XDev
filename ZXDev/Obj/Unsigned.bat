...
%bin%\sdcc -mz80 --code-loc 26000 --data-loc 0xF800 --opt-code-size -I %lib% -I %lib%\C -I %lib%\Obj -L %lib% --disable-warning 59 --disable-warning 85 --disable-warning 158 Unsigned.c Basic.lib
