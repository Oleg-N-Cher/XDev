...
%bin%\sdcc MiraTest.c -mz80 --reserve-regs-iy --code-loc %CodeAddr% --data-loc %DataAddr% --opt-code-size --funsigned-char -I "." -I %lib% -L %lib%/z80 Basic.lib MiraMod2.lib --disable-warning 59 --disable-warning 85
