...
export void Best40_ASRL_DN (INTEGER attrib);
export void Best40_ASRL_LF (INTEGER attrib);
export void Best40_ASRL_RG (INTEGER attrib);
export void Best40_ASRL_UP (INTEGER attrib);
...
void Best40_ASRL_LF (INTEGER attrib)
{
}

/*----------------------------------------------------------------------------*/
void Best40_ASRL_RG (INTEGER attrib)
{
}

/*----------------------------------------------------------------------------*/
void Best40_ASRL_UP (INTEGER attrib)
{
}

/*----------------------------------------------------------------------------*/
void Best40_ASRL_DN (INTEGER attrib)
{
}
