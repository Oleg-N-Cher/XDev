...
extern void Best40_SCR_MRG (SYSTEM_ADR scr_addr);
extern void Best40_SCR_INV (void);
extern void Best40_SINV_UD (SYSTEM_ADR char_addr);
extern void Best40_SINV_LR (SYSTEM_ADR char_addr);
extern void Best40_SROTATE (SYSTEM_ADR char_addr);
