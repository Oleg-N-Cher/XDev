...
extern void SYSTEM_STRCOPY (CHAR x[], CHAR y[]) __z88dk_callee __preserves_regs(d,e,iyl,iyh);
extern void SYSTEM_STRAPND (CHAR x[], CHAR y[]) __z88dk_callee __preserves_regs(d,e,iyl,iyh);
