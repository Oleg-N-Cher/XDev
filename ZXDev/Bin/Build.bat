...
SET Libraries=%Libraries% -L%ZXDev%\Lib XDev.lib Graph.lib Basic.lib Laser.lib MegaBasic.lib Best40.lib trdos.lib libspr.lib Supercode.lib NewSupercode.lib MiraMod2.lib Pt3xPlayer.lib Wham.lib ZX7.lib CalcZX.lib Laser2.lib Mem128.lib Out6x8.lib Cursor.lib StcPlayer.lib Pt3Player.lib
